...
// is no interface between this module and the context module. The following
...
class ExprTree
{
	...
	virtual int         EvalTree(class ContextList*, class EvalResult*) {}
	virtual int         EvalTree(class Context*, EvalResult*) {}

	virtual ExprTree*   MinTree(ContextList*) { Copy(); return this; }
	virtual void        Diff(ContextList*, class VarTypeTable*) {};
	/*
...
class VariableBase : public ExprTree
{
	...
	char*		    Name();	// return a copy of "name"

	friend	class	    ExprTree;		// access name for delete op
	friend	class	    ContextElem;	// access name for name list
