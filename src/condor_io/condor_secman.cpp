...
HashTable<MyString,MyString> SecMan::command_map(209, hashFunction, updateDuplicateKeys);
HashTable<MyString,classy_counted_ptr<SecManStartCommand> > SecMan::tcp_auth_in_progress(256, hashFunction, rejectDuplicateKeys);
