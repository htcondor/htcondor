...
HashTable<MyString,MyString> SecMan::command_map(hashFunction, updateDuplicateKeys);
HashTable<MyString,classy_counted_ptr<SecManStartCommand> > SecMan::tcp_auth_in_progress(hashFunction, rejectDuplicateKeys);
