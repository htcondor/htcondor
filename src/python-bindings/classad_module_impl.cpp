...
export_classad()
{
    ...
    class_<ClassAdWrapper, boost::noncopyable>("ClassAd", "A classified advertisement.")
        ...
        .def("printOld", &ClassAdWrapper::toOldString, "Serialize this ClassAd as a string in the \"old ClassAd\" format.")
		.def("printJson", &ClassAdWrapper::toJsonString, "Serialize this ClassAd as a string in JSON format.")
