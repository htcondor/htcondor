...
*/
bool yield_job(bool done, int cluster, int proc, MyString * error_details = 0, const char * my_identity = 0, bool leave_src_untouched = true, bool *keep_trying = 0);
bool yield_job(classad::ClassAd const &ad, const char * pool_name,
	...
	bool leave_src_untouched = true, bool *keep_trying = 0);
