...
#define NOVA_COMMAND_SERVER_DELETE		"NOVA_SERVER_CREATE"
#define NOVA_COMMAND_SERVER_LIST		"NOVA_SERVER_CREATE"
#define NOVA_COMMAND_SERVER_DETAIL		"NOVA_SERVER_CREATE"
