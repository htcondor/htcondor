...
namespace AviaryHadoop
{
        ...
        private:
            ...
            wso2wsf::OMElement* property_StartNameNode;
         ...
         * @param 
         * @param StartNameNode wso2wsf::OMElement*
         * @return newly created StartNameNode object
         */
        StartNameNode(wso2wsf::OMElement* arg_StartNameNode);
         ...
         * @param arg_StartNameNode wso2wsf::OMElement*
         * @return true on success, false otherwise
         */
        WSF_EXTERN bool WSF_CALL
        setStartNameNode(wso2wsf::OMElement*  arg_StartNameNode);
