          ...
          #ifndef AviaryHadoop_HADOOPQUERYRESPONSE_H
          #define AviaryHadoop_HADOOPQUERYRESPONSE_H
        
      
       /**
        * HadoopQueryResponse.h
        *
       ...
       /**
        *  HadoopQueryResponse class
        */

        namespace AviaryHadoop{
            class HadoopQueryResponse;
        }
...
namespace AviaryHadoop
{
        ...
        private:
             std::vector<AviaryHadoop::HadoopQueryResult*>* property_Results;
        ...
        /**
         * Constructor for class HadoopQueryResponse
         */

        HadoopQueryResponse();

        /**
         * Destructor HadoopQueryResponse
         */
        ~HadoopQueryResponse();
        ...
        /**
         * Constructor for creating HadoopQueryResponse
         * @param 
         * @param Results std::vector<AviaryHadoop::HadoopQueryResult*>*
         * @param Status AviaryCommon::Status*
         * @return newly created HadoopQueryResponse object
         */
        HadoopQueryResponse(std::vector<AviaryHadoop::HadoopQueryResult*>* arg_Results,AviaryCommon::Status* arg_Status);
        

        /**
         * resetAll for HadoopQueryResponse
         */
         ...
         * @return Array of AviaryHadoop::HadoopQueryResult*s.
         */
        WSF_EXTERN std::vector<AviaryHadoop::HadoopQueryResult*>* WSF_CALL
        getResults();

        /**
         * Setter for results.Deprecated for array types, Use setResultsAt
         * or addResults instead.
         * @param arg_Results Array of AviaryHadoop::HadoopQueryResult*s.
         * @return true on success, false otherwise
         */
        WSF_EXTERN bool WSF_CALL
        setResults(std::vector<AviaryHadoop::HadoopQueryResult*>*  arg_Results);
        ...
        * @param i index of the item to be obtained
         * @return ith AviaryHadoop::HadoopQueryResult* of the array
         */
        WSF_EXTERN AviaryHadoop::HadoopQueryResult* WSF_CALL
        getResultsAt(int i);

        /**
         * Set the ith element of results. (If the ith already exist, it will be replaced)
         * @param i index of the item to return
         * @param arg_Results element to set AviaryHadoop::HadoopQueryResult* to the array
         * @return ith AviaryHadoop::HadoopQueryResult* of the array
         */
        WSF_EXTERN bool WSF_CALL
        setResultsAt(int i,
        ...
        /**
         * Add to results.
         * @param arg_Results element to add AviaryHadoop::HadoopQueryResult* to the array
         * @return true on success, false otherwise.
         */
        WSF_EXTERN bool WSF_CALL
        addResults(
       ...
       /**
         ...
         * @param HadoopQueryResponse_om_node node to serialize from
         * @param HadoopQueryResponse_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* HadoopQueryResponse_om_node, axiom_element_t *HadoopQueryResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the HadoopQueryResponse is a particle class (E.g. group, inner sequence)
         ...
         * @return Array of AviaryHadoop::HadoopQueryResults.
         */
