          ...
          #ifndef AviaryHadoop_HADOOPSTOPRESULT_H
          #define AviaryHadoop_HADOOPSTOPRESULT_H
       ...
       /**
        *  HadoopStopResult class
        */

        namespace AviaryHadoop{
            class HadoopStopResult;
        }
...
namespace AviaryHadoop
{
        ...
        /**
         * Constructor for class HadoopStopResult
         */

        HadoopStopResult();

        /**
         * Destructor HadoopStopResult
         */
        ~HadoopStopResult();
        ...
        /**
         * Constructor for creating HadoopStopResult
         * @param 
         * @param Ref AviaryHadoop::HadoopID*
         * @param Status AviaryCommon::Status*
         * @return newly created HadoopStopResult object
         */
        HadoopStopResult(AviaryHadoop::HadoopID* arg_Ref,AviaryCommon::Status* arg_Status);
        

        /**
         * resetAll for HadoopStopResult
         */
       ...
       /**
         ...
         * @param HadoopStopResult_om_node node to serialize from
         * @param HadoopStopResult_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* HadoopStopResult_om_node, axiom_element_t *HadoopStopResult_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the HadoopStopResult is a particle class (E.g. group, inner sequence)
