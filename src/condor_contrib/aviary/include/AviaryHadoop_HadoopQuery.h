          ...
          #ifndef AviaryHadoop_HADOOPQUERY_H
          #define AviaryHadoop_HADOOPQUERY_H
...
namespace AviaryHadoop
{
        ...
        /**
         * Constructor for class HadoopQuery
         */

        HadoopQuery();

        /**
         * Destructor HadoopQuery
         */
        ~HadoopQuery();
        ...
        /**
         * Constructor for creating HadoopQuery
         * @param 
         * @param Refs std::vector<AviaryHadoop::HadoopID*>*
         * @return newly created HadoopQuery object
         */
        HadoopQuery(std::vector<AviaryHadoop::HadoopID*>* arg_Refs);
        

        /**
         * resetAll for HadoopQuery
         */
       ...
       /**
         ...
         * @param HadoopQuery_om_node node to serialize from
         * @param HadoopQuery_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* HadoopQuery_om_node, axiom_element_t *HadoopQuery_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the HadoopQuery is a particle class (E.g. group, inner sequence)
