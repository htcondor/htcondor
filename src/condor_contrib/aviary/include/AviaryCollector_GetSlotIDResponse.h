          ...
          #ifndef AviaryCollector_GETSLOTIDRESPONSE_H
          #define AviaryCollector_GETSLOTIDRESPONSE_H
       ...
       /**
        *  GetSlotIDResponse class
        */

        namespace AviaryCollector{
            class GetSlotIDResponse;
        }
...
namespace AviaryCollector
{
        ...
        /**
         * Constructor for class GetSlotIDResponse
         */

        GetSlotIDResponse();

        /**
         * Destructor GetSlotIDResponse
         */
        ~GetSlotIDResponse();
        ...
        /**
         * Constructor for creating GetSlotIDResponse
         * @param 
         * @param Results std::vector<AviaryCommon::Slot*>*
         * @param Remaining int
         * @return newly created GetSlotIDResponse object
         */
        GetSlotIDResponse(std::vector<AviaryCommon::Slot*>* arg_Results,int arg_Remaining);
        

        /**
         * resetAll for GetSlotIDResponse
         */
       ...
       /**
         ...
         * @param GetSlotIDResponse_om_node node to serialize from
         * @param GetSlotIDResponse_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* GetSlotIDResponse_om_node, axiom_element_t *GetSlotIDResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the GetSlotIDResponse is a particle class (E.g. group, inner sequence)
