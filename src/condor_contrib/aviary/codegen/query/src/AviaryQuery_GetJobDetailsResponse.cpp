       ...
       AviaryQuery::GetJobDetailsResponse::GetJobDetailsResponse(std::vector<AviaryCommon::JobDetails*>* arg_Jobs,AviaryCommon::Status* arg_Status)
        {
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
           ...
           AviaryQuery::GetJobDetailsResponse::setJobsNilAt(int i)
           {
            ...
            AviaryQuery::GetJobDetailsResponse::getProperty2()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryQuery::GetJobDetailsResponse::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetJobDetailsResponse::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDetailsResponse::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDetailsResponse::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDetailsResponse::setStatusNil()
           {
               return resetStatus();
           }
