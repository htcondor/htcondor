       ...
       AviaryQuery::GetSubmissionSummary::GetSubmissionSummary(bool arg_AllowPartialMatching,std::vector<AviaryCommon::SubmissionID*>* arg_Ids)
        {
	...
	AviaryQuery::GetSubmissionSummary::serialize(axiom_node_t *parent, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetSubmissionSummary::getAllowPartialMatching()
             {
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetSubmissionSummary::setAllowPartialMatching(
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetSubmissionSummary::resetAllowPartialMatching()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetSubmissionSummary::isAllowPartialMatchingNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetSubmissionSummary::setAllowPartialMatchingNil()
           {
