       ...
       AviaryQuery::GetJobStatus::GetJobStatus(bool arg_AllowPartialMatching,std::vector<AviaryCommon::JobID*>* arg_Ids)
        {
	...
	AviaryQuery::GetJobStatus::serialize(axiom_node_t *parent, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetJobStatus::getAllowPartialMatching()
             {
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetJobStatus::setAllowPartialMatching(
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobStatus::resetAllowPartialMatching()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobStatus::isAllowPartialMatchingNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobStatus::setAllowPartialMatchingNil()
           {
