       ...
       AviaryQuery::GetJobDataResponse::GetJobDataResponse(std::vector<AviaryCommon::JobData*>* arg_Jobs,AviaryCommon::Status* arg_Status)
        {
            ...
            axutil_qname_t *element_qname = NULL; 
              ...
              {   
                return AXIS2_FAILURE;
                     ...
                     * building Jobs array
                     */
                       std::vector<AviaryCommon::JobData*>* arr_list =new std::vector<AviaryCommon::JobData*>();
	...
	AviaryQuery::GetJobDataResponse::serialize(axiom_node_t *parent, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
                ...
                int next_ns_index_value = 0;
                   ...
                   else
                   {
                     ...
                     if (property_Jobs != NULL)
                     {
                         ...
                         for(i = 0; i < count; i++)
                         {
                            AviaryCommon::JobData* element = (*property_Jobs)[i];
             ...
             */
            std::vector<AviaryCommon::JobData*>* WSF_CALL
            AviaryQuery::GetJobDataResponse::getJobs()
             {
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetJobDataResponse::setJobs(
                    std::vector<AviaryCommon::JobData*>*  arg_Jobs)
             {
            ...
            AviaryQuery::GetJobDataResponse::getJobsAt(int i)
            {
                AviaryCommon::JobData* ret_val;
                if(property_Jobs == NULL)
                {
                    return (AviaryCommon::JobData*)0;
                }
             ...
             */
           bool WSF_CALL
            AviaryQuery::GetJobDataResponse::setJobsAt(int i,
                    AviaryCommon::JobData* arg_Jobs)
            {
                 AviaryCommon::JobData* element;
                int size = 0;
                ...
                if(property_Jobs == NULL)
                {
                    property_Jobs = new std::vector<AviaryCommon::JobData*>();
                }
                else{
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetJobDataResponse::addJobs(
                    AviaryCommon::JobData* arg_Jobs)
             {
             ...
             */
            int WSF_CALL
            AviaryQuery::GetJobDataResponse::sizeofJobs()
            {
             ...
             */
            bool WSF_CALL
            AviaryQuery::GetJobDataResponse::removeJobsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDataResponse::resetJobs()
           {
               int i = 0;
               int count = 0;
                ...
                if (property_Jobs != NULL)
                {
                  std::vector<AviaryCommon::JobData*>::iterator it =  property_Jobs->begin();
                  for( ; it <  property_Jobs->end() ; ++it)
                  {
                     AviaryCommon::JobData* element = *it;
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDataResponse::isJobsNil()
           {
               return !isValidJobs;
           }
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDataResponse::setJobsNil()
           {
               return resetJobs();
           }
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDataResponse::isJobsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryQuery::GetJobDataResponse::setJobsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
