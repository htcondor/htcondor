       ...
       # endif
        ...
        using namespace AviaryCommon;
                 ...
                 */
           AviaryCommon::SubmitterID::SubmitterID()
        {
       ...
       AviaryCommon::SubmitterID::SubmitterID(std::string arg_Name,std::string arg_Machine,std::string arg_Scheduler)
        {
        ...
        bool WSF_CALL AviaryCommon::SubmitterID::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCommon::SubmitterID::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "machine", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("machine", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("machine", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      else
                                      {
                                            ...
                                            if(attrib_text && 0 == axutil_strcmp(attrib_text, "1"))
                                            {
                                                WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element machine");
                                                status = AXIS2_FAILURE;
                                            }
                                            else
                                            {
                                 ...
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for machine ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
          ...
          bool WSF_CALL
          AviaryCommon::SubmitterID::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCommon::SubmitterID::declareParentNamespaces(
	...
	AviaryCommon::SubmitterID::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            if(!parent_tag_closed)
            {
              ...
              tag_closed = 1;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (4 + axutil_strlen(p_prefix) + 
                                  axutil_strlen("machine"))); 
                                 
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("machine")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_2 = (axis2_char_t*)property_Machine.c_str();
             ...
             */
            std::string WSF_CALL
            AviaryCommon::SubmitterID::getProperty1()
            {
                return getName();
            }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::SubmitterID::getName()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::SubmitterID::setName(
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::resetName()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::isNameNil()
           {
               return !isValidName;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::setNameNil()
           {
               return resetName();
           }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::SubmitterID::getProperty2()
            {
                return getMachine();
            }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::SubmitterID::getMachine()
             {
                return property_Machine;
             }
             ...
             */
            bool WSF_CALL
            AviaryCommon::SubmitterID::setMachine(
                    const std::string  arg_Machine)
             {
                

                if(isValidMachine &&
                        arg_Machine == property_Machine)
                {
                ...
                resetMachine();
                        ...
                        property_Machine = std::string(arg_Machine.c_str());
                        isValidMachine = true;
           ...
           /**
            * resetter for machine
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::resetMachine()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::isMachineNil()
           {
               return !isValidMachine;
           }

           /**
            * Set machine to nill (currently the same as reset)
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::setMachineNil()
           {
               return resetMachine();
           }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::SubmitterID::getProperty3()
            {
                return getScheduler();
            }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::SubmitterID::getScheduler()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::SubmitterID::setScheduler(
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::resetScheduler()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::isSchedulerNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::SubmitterID::setSchedulerNil()
           {
