       ...
       # endif
        ...
        using namespace AviaryCommon;
                 ...
                 */
           AviaryCommon::Submitter::Submitter()
        {
       ...
       AviaryCommon::Submitter::Submitter(AviaryCommon::SubmitterID* arg_Id,AviaryCommon::Status* arg_Status,AviaryCommon::SubmitterSummary* arg_Summary)
        {
        ...
        bool WSF_CALL AviaryCommon::Submitter::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.

            
             resetId();//AviaryCommon::SubmitterID
             resetStatus();//AviaryCommon::Status
             resetSummary();//AviaryCommon::SubmitterSummary
            return true;
        ...
        bool WSF_CALL
        AviaryCommon::Submitter::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                                 ...
                                 AviaryCommon::SubmitterSummary* element = new AviaryCommon::SubmitterSummary();
          ...
          bool WSF_CALL
          AviaryCommon::Submitter::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCommon::Submitter::declareParentNamespaces(
	...
	AviaryCommon::Submitter::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AviaryCommon::Submitter::getProperty1()
            {
                return getId();
            }
             ...
             */
            bool WSF_CALL
            AviaryCommon::Submitter::setId(
                    AviaryCommon::SubmitterID*  arg_Id)
             {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::resetId()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::isIdNil()
           {
               return !isValidId;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::setIdNil()
           {
               return resetId();
           }
            ...
            AviaryCommon::Submitter::getProperty2()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryCommon::Submitter::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Submitter::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::setStatusNil()
           {
               return resetStatus();
           }
            ...
            AviaryCommon::Submitter::getProperty3()
            {
                return getSummary();
            }
             ...
             */
            AviaryCommon::SubmitterSummary* WSF_CALL
            AviaryCommon::Submitter::getSummary()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Submitter::setSummary(
                    AviaryCommon::SubmitterSummary*  arg_Summary)
             {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::resetSummary()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::isSummaryNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Submitter::setSummaryNil()
           {
               return resetSummary();
           }
