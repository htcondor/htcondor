       ...
       # endif
        ...
        using namespace AviaryCommon;
                 ...
                 */
           AviaryCommon::Scheduler::Scheduler()
        {
       ...
       AviaryCommon::Scheduler::Scheduler(AviaryCommon::ResourceID* arg_Id,AviaryCommon::Status* arg_Status,AviaryCommon::SchedulerSummary* arg_Summary)
        {
        ...
        bool WSF_CALL AviaryCommon::Scheduler::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.
             ...
             resetSummary();//AviaryCommon::SchedulerSummary
            return true;
        ...
        bool WSF_CALL
        AviaryCommon::Scheduler::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                                 ...
                                 AviaryCommon::SchedulerSummary* element = new AviaryCommon::SchedulerSummary();
          ...
          bool WSF_CALL
          AviaryCommon::Scheduler::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCommon::Scheduler::declareParentNamespaces(
	...
	AviaryCommon::Scheduler::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AviaryCommon::Scheduler::getProperty1()
            {
                return getId();
            }
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::resetId()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::isIdNil()
           {
               return !isValidId;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::setIdNil()
           {
               return resetId();
           }
            ...
            AviaryCommon::Scheduler::getProperty2()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryCommon::Scheduler::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Scheduler::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::setStatusNil()
           {
               return resetStatus();
           }
            ...
            AviaryCommon::Scheduler::getProperty3()
            {
                return getSummary();
            }
             ...
             */
            AviaryCommon::SchedulerSummary* WSF_CALL
            AviaryCommon::Scheduler::getSummary()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Scheduler::setSummary(
                    AviaryCommon::SchedulerSummary*  arg_Summary)
             {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::resetSummary()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::isSummaryNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Scheduler::setSummaryNil()
           {
               return resetSummary();
           }
