       ...
       AviaryCommon::Master::Master(AviaryCommon::ResourceID* arg_Id,AviaryCommon::Status* arg_Status,AviaryCommon::MasterSummary* arg_Summary)
        {
        ...
        bool WSF_CALL AviaryCommon::Master::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.
             ...
             resetSummary();//AviaryCommon::MasterSummary
            return true;
        ...
        bool WSF_CALL
        AviaryCommon::Master::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                                 ...
                                 AviaryCommon::MasterSummary* element = new AviaryCommon::MasterSummary();
          ...
          bool WSF_CALL
          AviaryCommon::Master::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCommon::Master::declareParentNamespaces(
	...
	AviaryCommon::Master::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AviaryCommon::Master::getProperty1()
            {
                return getId();
            }
           ...
           AviaryCommon::Master::setIdNil()
           {
            ...
            AviaryCommon::Master::getProperty2()
            {
                return getStatus();
            }
            ...
            */
           bool WSF_CALL
           AviaryCommon::Master::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Master::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Master::setStatusNil()
           {
               return resetStatus();
           }
            ...
            AviaryCommon::Master::getProperty3()
            {
                return getSummary();
            }
             ...
             */
            AviaryCommon::MasterSummary* WSF_CALL
            AviaryCommon::Master::getSummary()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Master::setSummary(
                    AviaryCommon::MasterSummary*  arg_Summary)
             {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Master::resetSummary()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Master::isSummaryNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Master::setSummaryNil()
           {
               return resetSummary();
           }
