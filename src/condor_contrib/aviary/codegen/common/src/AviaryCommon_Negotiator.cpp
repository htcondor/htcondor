       ...
       # endif
        ...
        using namespace AviaryCommon;
                 ...
                 */
           AviaryCommon::Negotiator::Negotiator()
        {
       ...
       AviaryCommon::Negotiator::Negotiator(AviaryCommon::ResourceID* arg_Id,AviaryCommon::Status* arg_Status,AviaryCommon::NegotiatorSummary* arg_Summary)
        {
        ...
        bool WSF_CALL AviaryCommon::Negotiator::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.
             ...
             resetSummary();//AviaryCommon::NegotiatorSummary
            return true;
        ...
        bool WSF_CALL
        AviaryCommon::Negotiator::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("summary", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                                 ...
                                 AviaryCommon::NegotiatorSummary* element = new AviaryCommon::NegotiatorSummary();
          ...
          bool WSF_CALL
          AviaryCommon::Negotiator::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCommon::Negotiator::declareParentNamespaces(
	...
	AviaryCommon::Negotiator::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AviaryCommon::Negotiator::getProperty1()
            {
                return getId();
            }
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::resetId()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::isIdNil()
           {
               return !isValidId;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::setIdNil()
           {
               return resetId();
           }
            ...
            AviaryCommon::Negotiator::getProperty2()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryCommon::Negotiator::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Negotiator::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::setStatusNil()
           {
               return resetStatus();
           }
            ...
            AviaryCommon::Negotiator::getProperty3()
            {
                return getSummary();
            }
             ...
             */
            AviaryCommon::NegotiatorSummary* WSF_CALL
            AviaryCommon::Negotiator::getSummary()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::Negotiator::setSummary(
                    AviaryCommon::NegotiatorSummary*  arg_Summary)
             {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::resetSummary()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::isSummaryNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCommon::Negotiator::setSummaryNil()
           {
               return resetSummary();
           }
