       ...
       # endif
        ...
        using namespace AviaryHadoop;
                 ...
                 */
           AviaryHadoop::HadoopID::HadoopID()
        {
       ...
       AviaryHadoop::HadoopID::HadoopID(std::string arg_Id,std::string arg_Ipc)
        {
        ...
        bool WSF_CALL AviaryHadoop::HadoopID::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryHadoop::HadoopID::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "ipc", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("ipc", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("ipc", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      else
                                      {
                                            ...
                                            if(attrib_text && 0 == axutil_strcmp(attrib_text, "1"))
                                            {
                                                WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element ipc");
                                                status = AXIS2_FAILURE;
                                            }
                                            else
                                            {
                                 ...
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for ipc ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
          ...
          bool WSF_CALL
          AviaryHadoop::HadoopID::isParticle()
          {
          ...
          void WSF_CALL
          AviaryHadoop::HadoopID::declareParentNamespaces(
	...
	AviaryHadoop::HadoopID::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
              ...
              tag_closed = 1;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 ...
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("ipc")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_2 = (axis2_char_t*)property_Ipc.c_str();
             ...
             */
            std::string WSF_CALL
            AviaryHadoop::HadoopID::getProperty1()
            {
                return getId();
            }
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopID::setIdNil()
           {
               return resetId();
           }
             ...
             */
            std::string WSF_CALL
            AviaryHadoop::HadoopID::getProperty2()
            {
                return getIpc();
            }
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopID::setIpc(
                    const std::string  arg_Ipc)
             {
                

                if(isValidIpc &&
                        arg_Ipc == property_Ipc)
                {
                ...
                resetIpc();
                        ...
                        property_Ipc = std::string(arg_Ipc.c_str());
                        isValidIpc = true;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopID::resetIpc()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopID::isIpcNil()
           {
               return !isValidIpc;
           }

           /**
            * Set ipc to nill (currently the same as reset)
            */
           bool WSF_CALL
           AviaryHadoop::HadoopID::setIpcNil()
           {
               return resetIpc();
           }
