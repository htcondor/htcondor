       ...
       # endif
        ...
        using namespace AviaryHadoop;
                 ...
                 * name = HadoopStopResponse
                 * Namespace URI = http://hadoop.aviary.grid.redhat.com
                 * Namespace Prefix = ns2
                 */
           AviaryHadoop::HadoopStopResponse::HadoopStopResponse()
        {
       ...
       AviaryHadoop::HadoopStopResponse::HadoopStopResponse(std::vector<AviaryHadoop::HadoopStopResult*>* arg_Results,AviaryCommon::Status* arg_Status)
        {
        ...
        bool WSF_CALL AviaryHadoop::HadoopStopResponse::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.

            
             resetResults();//AviaryHadoop::HadoopStopResult
        ...
        bool WSF_CALL
        AviaryHadoop::HadoopStopResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
            ...
            axutil_qname_t *element_qname = NULL; 
              ...
              {   
                return AXIS2_FAILURE;
                     ...
                     */
                       std::vector<AviaryHadoop::HadoopStopResult*>* arr_list =new std::vector<AviaryHadoop::HadoopStopResult*>();
                      ...
                      */
                                             ...
                                             
                               {
                                  ...
                                  if (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("results", axiom_element_get_localname(current_element, Environment::getEnv())))
                                  {
                                     ...
                                     AviaryHadoop::HadoopStopResult* element = new AviaryHadoop::HadoopStopResult();
          ...
          bool WSF_CALL
          AviaryHadoop::HadoopStopResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryHadoop::HadoopStopResponse::declareParentNamespaces(
	...
	AviaryHadoop::HadoopStopResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
              ...
              tag_closed = 1;
                   ...
                   else
                   {
                     ...
                     if (property_Results != NULL)
                     {
                         ...
                         for(i = 0; i < count; i++)
                         {
                            AviaryHadoop::HadoopStopResult* element = (*property_Results)[i];
            ...
            AviaryHadoop::HadoopStopResponse::getProperty1()
            {
                return getResults();
            }
             ...
             */
            std::vector<AviaryHadoop::HadoopStopResult*>* WSF_CALL
            AviaryHadoop::HadoopStopResponse::getResults()
             {
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStopResponse::setResults(
                    std::vector<AviaryHadoop::HadoopStopResult*>*  arg_Results)
             {
             ...
             */
            AviaryHadoop::HadoopStopResult* WSF_CALL
            AviaryHadoop::HadoopStopResponse::getResultsAt(int i)
            {
                AviaryHadoop::HadoopStopResult* ret_val;
                if(property_Results == NULL)
                {
                    return (AviaryHadoop::HadoopStopResult*)0;
                }
             ...
             */
           bool WSF_CALL
            AviaryHadoop::HadoopStopResponse::setResultsAt(int i,
                    AviaryHadoop::HadoopStopResult* arg_Results)
            {
                 AviaryHadoop::HadoopStopResult* element;
                int size = 0;
                ...
                if(property_Results == NULL)
                {
                    property_Results = new std::vector<AviaryHadoop::HadoopStopResult*>();
                }
                else{
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStopResponse::addResults(
                    AviaryHadoop::HadoopStopResult* arg_Results)
             {
             ...
             */
            int WSF_CALL
            AviaryHadoop::HadoopStopResponse::sizeofResults()
            {
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStopResponse::removeResultsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::resetResults()
           {
               int i = 0;
               int count = 0;
                ...
                if (property_Results != NULL)
                {
                  std::vector<AviaryHadoop::HadoopStopResult*>::iterator it =  property_Results->begin();
                  for( ; it <  property_Results->end() ; ++it)
                  {
                     AviaryHadoop::HadoopStopResult* element = *it;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::isResultsNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::setResultsNil()
           {
               return resetResults();
           }
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::isResultsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::setResultsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
            ...
            AviaryHadoop::HadoopStopResponse::getProperty2()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryHadoop::HadoopStopResponse::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStopResponse::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStopResponse::setStatusNil()
           {
               return resetStatus();
           }
