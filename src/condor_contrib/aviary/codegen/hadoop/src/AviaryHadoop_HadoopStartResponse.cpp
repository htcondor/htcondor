       ...
       # endif
        ...
        using namespace AviaryHadoop;
                 ...
                 * name = HadoopStartResponse
                 * Namespace URI = http://hadoop.aviary.grid.redhat.com
                 * Namespace Prefix = ns2
                 */
           AviaryHadoop::HadoopStartResponse::HadoopStartResponse()
        {
       ...
       AviaryHadoop::HadoopStartResponse::HadoopStartResponse(AviaryHadoop::HadoopID* arg_Ref,AviaryCommon::Status* arg_Status)
        {
        ...
        bool WSF_CALL AviaryHadoop::HadoopStartResponse::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryHadoop::HadoopStartResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
          ...
          bool WSF_CALL
          AviaryHadoop::HadoopStartResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryHadoop::HadoopStartResponse::declareParentNamespaces(
	...
	AviaryHadoop::HadoopStartResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AviaryHadoop::HadoopStartResponse::getProperty1()
            {
                return getRef();
            }
             ...
             */
            AviaryHadoop::HadoopID* WSF_CALL
            AviaryHadoop::HadoopStartResponse::getRef()
             {
                return property_Ref;
             }
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStartResponse::setRef(
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStartResponse::resetRef()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStartResponse::isRefNil()
           {
               return !isValidRef;
           }
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStartResponse::setRefNil()
           {
               return resetRef();
           }
            ...
            AviaryHadoop::HadoopStartResponse::getProperty2()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryHadoop::HadoopStartResponse::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStartResponse::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStartResponse::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStartResponse::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStartResponse::setStatusNil()
           {
               return resetStatus();
           }
