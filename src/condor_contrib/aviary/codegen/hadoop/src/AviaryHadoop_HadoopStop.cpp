       ...
       # endif
        ...
        using namespace AviaryHadoop;
                 ...
                 */
           AviaryHadoop::HadoopStop::HadoopStop()
        {
       ...
       AviaryHadoop::HadoopStop::HadoopStop(std::vector<AviaryHadoop::HadoopID*>* arg_Refs)
        {
        ...
        bool WSF_CALL AviaryHadoop::HadoopStop::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryHadoop::HadoopStop::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
          ...
          bool WSF_CALL
          AviaryHadoop::HadoopStop::isParticle()
          {
          ...
          void WSF_CALL
          AviaryHadoop::HadoopStop::declareParentNamespaces(
	...
	AviaryHadoop::HadoopStop::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AviaryHadoop::HadoopStop::getProperty1()
            {
                return getRefs();
            }
             ...
             */
            std::vector<AviaryHadoop::HadoopID*>* WSF_CALL
            AviaryHadoop::HadoopStop::getRefs()
             {
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStop::setRefs(
            ...
            AviaryHadoop::HadoopStop::getRefsAt(int i)
            {
             ...
             */
           bool WSF_CALL
            AviaryHadoop::HadoopStop::setRefsAt(int i,
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStop::addRefs(
                    AviaryHadoop::HadoopID* arg_Refs)
             {
             ...
             */
            int WSF_CALL
            AviaryHadoop::HadoopStop::sizeofRefs()
            {
             ...
             */
            bool WSF_CALL
            AviaryHadoop::HadoopStop::removeRefsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStop::resetRefs()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStop::isRefsNil()
           {
               return !isValidRefs;
           }
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStop::setRefsNil()
           {
               return resetRefs();
           }
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStop::isRefsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryHadoop::HadoopStop::setRefsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
