       ...
       # endif
        ...
        using namespace AviaryHadoop;
               ...
               /*
                * Implementation of the StartNameNode|http://hadoop.aviary.grid.redhat.com Element
                */
           AviaryHadoop::StartNameNode::StartNameNode()
        {
       ...
       AviaryHadoop::StartNameNode::StartNameNode(AviaryHadoop::HadoopNameNodeStart* arg_StartNameNode)
        {
            ...
            isValidStartNameNode  = true;
                 ...
                 qname =  axutil_qname_create (Environment::getEnv(),
                    ...
                    property_StartNameNode = arg_StartNameNode;
        ...
        bool WSF_CALL AviaryHadoop::StartNameNode::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryHadoop::StartNameNode::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for StartNameNode : "
                     ...
                     /*
                      * building StartNameNode element
                      */
				  ...
				  WSF_LOG_ERROR_MSG(Environment::getEnv()->log,WSF_LOG_SI, "non nillable or minOuccrs != 0 element StartNameNode missing");
                                  return AXIS2_FAILURE;
                              }
          ...
          bool WSF_CALL
          AviaryHadoop::StartNameNode::isParticle()
          {
          ...
          void WSF_CALL
          AviaryHadoop::StartNameNode::declareParentNamespaces(
	...
	AviaryHadoop::StartNameNode::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "StartNameNode", ns1 , &parent);
                   ...
                   if (!isValidStartNameNode)
                   {
                      
                            
                            WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"Nil value found in non-nillable property StartNameNode");
                            return NULL;
                   ...
                   else
                   {
                     start_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (4 + axutil_strlen(p_prefix) + 
                                  axutil_strlen("StartNameNode"))); 
                                 
                                 /* axutil_strlen("<:>") + 1 = 4 */
                     end_input_str = (axis2_char_t*)AXIS2_MALLOC(Environment::getEnv()->allocator, sizeof(axis2_char_t) *
                                 (5 + axutil_strlen(p_prefix) + axutil_strlen("StartNameNode")));
                                  /* axutil_strlen("</:>") + 1 = 5 */
            ...
            AviaryHadoop::StartNameNode::setStartNameNode(
                    AviaryHadoop::HadoopNameNodeStart*  arg_StartNameNode)
             {
                ...
                if(isValidStartNameNode &&
                        arg_StartNameNode == property_StartNameNode)
                {
                  ...
                  if(NULL == arg_StartNameNode)
                       
                  {
                      WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"StartNameNode is being set to NULL, but it is not a nullable element");
                      return AXIS2_FAILURE;
                  }
           ...
           /**
            * resetter for StartNameNode
            */
           bool WSF_CALL
           AviaryHadoop::StartNameNode::resetStartNameNode()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryHadoop::StartNameNode::isStartNameNodeNil()
           {
               return !isValidStartNameNode;
           }

           /**
            * Set StartNameNode to nill (currently the same as reset)
            */
           bool WSF_CALL
           AviaryHadoop::StartNameNode::setStartNameNodeNil()
           {
               return resetStartNameNode();
           }
