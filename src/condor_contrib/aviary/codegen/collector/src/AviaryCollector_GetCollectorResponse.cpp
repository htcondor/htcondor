       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetCollectorResponse|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetCollectorResponse::GetCollectorResponse()
        {
       ...
       AviaryCollector::GetCollectorResponse::GetCollectorResponse(std::vector<AviaryCommon::Collector*>* arg_Results)
        {
        ...
        bool WSF_CALL AviaryCollector::GetCollectorResponse::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.

            
             resetResults();//AviaryCommon::Collector
          if(qname != NULL)
          {
        ...
        bool WSF_CALL
        AviaryCollector::GetCollectorResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetCollectorResponse : "
                     ...
                     */
                       std::vector<AviaryCommon::Collector*>* arr_list =new std::vector<AviaryCommon::Collector*>();
                      ...
                      */
                                             ...
                                             
                               {
                                  ...
                                  if (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("results", axiom_element_get_localname(current_element, Environment::getEnv())))
                                  {
                                     ...
                                     AviaryCommon::Collector* element = new AviaryCommon::Collector();
          ...
          bool WSF_CALL
          AviaryCollector::GetCollectorResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetCollectorResponse::declareParentNamespaces(
	...
	AviaryCollector::GetCollectorResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetCollectorResponse", ns1 , &parent);
                   ...
                   else
                   {
                     ...
                     if (property_Results != NULL)
                     {
                         ...
                         for(i = 0; i < count; i++)
                         {
                            AviaryCommon::Collector* element = (*property_Results)[i];
             ...
             */
            std::vector<AviaryCommon::Collector*>* WSF_CALL
            AviaryCollector::GetCollectorResponse::getProperty1()
            {
                return getResults();
            }
             ...
             */
            std::vector<AviaryCommon::Collector*>* WSF_CALL
            AviaryCollector::GetCollectorResponse::getResults()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetCollectorResponse::setResults(
                    std::vector<AviaryCommon::Collector*>*  arg_Results)
             {
             ...
             */
            AviaryCommon::Collector* WSF_CALL
            AviaryCollector::GetCollectorResponse::getResultsAt(int i)
            {
                AviaryCommon::Collector* ret_val;
                if(property_Results == NULL)
                {
                    return (AviaryCommon::Collector*)0;
                }
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetCollectorResponse::setResultsAt(int i,
                    AviaryCommon::Collector* arg_Results)
            {
                 AviaryCommon::Collector* element;
                int size = 0;
                ...
                if(property_Results == NULL)
                {
                    property_Results = new std::vector<AviaryCommon::Collector*>();
                }
                else{
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetCollectorResponse::addResults(
                    AviaryCommon::Collector* arg_Results)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetCollectorResponse::sizeofResults()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetCollectorResponse::removeResultsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetCollectorResponse::resetResults()
           {
               int i = 0;
               int count = 0;
                ...
                if (property_Results != NULL)
                {
                  std::vector<AviaryCommon::Collector*>::iterator it =  property_Results->begin();
                  for( ; it <  property_Results->end() ; ++it)
                  {
                     AviaryCommon::Collector* element = *it;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetCollectorResponse::isResultsNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetCollectorResponse::setResultsNil()
           {
               return resetResults();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetCollectorResponse::isResultsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetCollectorResponse::setResultsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
