       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetSlotResponse|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetSlotResponse::GetSlotResponse()
        {
       ...
       AviaryCollector::GetSlotResponse::GetSlotResponse(std::vector<AviaryCommon::Slot*>* arg_Results)
        {
        ...
        bool WSF_CALL AviaryCollector::GetSlotResponse::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.

            
             resetResults();//AviaryCommon::Slot
          if(qname != NULL)
          {
        ...
        bool WSF_CALL
        AviaryCollector::GetSlotResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetSlotResponse : "
          ...
          bool WSF_CALL
          AviaryCollector::GetSlotResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetSlotResponse::declareParentNamespaces(
	...
	AviaryCollector::GetSlotResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetSlotResponse", ns1 , &parent);
                   ...
                   else
                   {
                     ...
                     if (property_Results != NULL)
                     {
                         ...
                         for(i = 0; i < count; i++)
                         {
                            AviaryCommon::Slot* element = (*property_Results)[i];
            ...
            AviaryCollector::GetSlotResponse::getProperty1()
            {
                return getResults();
            }
             ...
             */
            std::vector<AviaryCommon::Slot*>* WSF_CALL
            AviaryCollector::GetSlotResponse::getResults()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotResponse::setResults(
                    std::vector<AviaryCommon::Slot*>*  arg_Results)
             {
            ...
            AviaryCollector::GetSlotResponse::getResultsAt(int i)
            {
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetSlotResponse::setResultsAt(int i,
                    AviaryCommon::Slot* arg_Results)
            {
                ...
                if(property_Results == NULL)
                {
                    property_Results = new std::vector<AviaryCommon::Slot*>();
                }
                else{
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotResponse::addResults(
                    AviaryCommon::Slot* arg_Results)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlotResponse::sizeofResults()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotResponse::removeResultsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotResponse::resetResults()
           {
               int i = 0;
               int count = 0;
                ...
                if (property_Results != NULL)
                {
                  std::vector<AviaryCommon::Slot*>::iterator it =  property_Results->begin();
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotResponse::isResultsNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotResponse::setResultsNil()
           {
               return resetResults();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotResponse::isResultsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotResponse::setResultsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
