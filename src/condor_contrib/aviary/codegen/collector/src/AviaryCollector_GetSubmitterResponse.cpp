       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetSubmitterResponse|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetSubmitterResponse::GetSubmitterResponse()
        {
       ...
       AviaryCollector::GetSubmitterResponse::GetSubmitterResponse(std::vector<AviaryCommon::Submitter*>* arg_Results)
        {
        ...
        bool WSF_CALL AviaryCollector::GetSubmitterResponse::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.

            
             resetResults();//AviaryCommon::Submitter
          if(qname != NULL)
          {
        ...
        bool WSF_CALL
        AviaryCollector::GetSubmitterResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetSubmitterResponse : "
                     ...
                     */
                       std::vector<AviaryCommon::Submitter*>* arr_list =new std::vector<AviaryCommon::Submitter*>();
                      ...
                      */
                                             ...
                                             
                               {
                                  ...
                                  if (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("results", axiom_element_get_localname(current_element, Environment::getEnv())))
                                  {
                                     ...
                                     AviaryCommon::Submitter* element = new AviaryCommon::Submitter();
          ...
          bool WSF_CALL
          AviaryCollector::GetSubmitterResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetSubmitterResponse::declareParentNamespaces(
	...
	AviaryCollector::GetSubmitterResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetSubmitterResponse", ns1 , &parent);
                   ...
                   else
                   {
                     ...
                     if (property_Results != NULL)
                     {
                         ...
                         for(i = 0; i < count; i++)
                         {
                            AviaryCommon::Submitter* element = (*property_Results)[i];
            ...
            AviaryCollector::GetSubmitterResponse::getProperty1()
            {
                return getResults();
            }
             ...
             */
            std::vector<AviaryCommon::Submitter*>* WSF_CALL
            AviaryCollector::GetSubmitterResponse::getResults()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSubmitterResponse::setResults(
                    std::vector<AviaryCommon::Submitter*>*  arg_Results)
             {
             ...
             */
            AviaryCommon::Submitter* WSF_CALL
            AviaryCollector::GetSubmitterResponse::getResultsAt(int i)
            {
                AviaryCommon::Submitter* ret_val;
                if(property_Results == NULL)
                {
                    return (AviaryCommon::Submitter*)0;
                }
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetSubmitterResponse::setResultsAt(int i,
                    AviaryCommon::Submitter* arg_Results)
            {
                 AviaryCommon::Submitter* element;
                int size = 0;
                ...
                if(property_Results == NULL)
                {
                    property_Results = new std::vector<AviaryCommon::Submitter*>();
                }
                else{
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSubmitterResponse::addResults(
                    AviaryCommon::Submitter* arg_Results)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSubmitterResponse::sizeofResults()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSubmitterResponse::removeResultsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSubmitterResponse::resetResults()
           {
               int i = 0;
               int count = 0;
                ...
                if (property_Results != NULL)
                {
                  std::vector<AviaryCommon::Submitter*>::iterator it =  property_Results->begin();
                  for( ; it <  property_Results->end() ; ++it)
                  {
                     AviaryCommon::Submitter* element = *it;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSubmitterResponse::isResultsNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSubmitterResponse::setResultsNil()
           {
               return resetResults();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSubmitterResponse::isResultsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSubmitterResponse::setResultsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
