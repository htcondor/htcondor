...
static bool test_similar_return_false_same(void);
static bool test_similar_return_false_not_same(void);
static bool test_similar_return_false_almost(void);
static bool test_similar_return_false_ignore(void);
static bool test_similar_return_false_subset(void);
static bool test_similar_return_true_case(void);
static bool test_similar_return_true_case_order(void);
static bool test_similar_return_true_ignore_order(void);
static bool test_similar_return_true_ignore(void);
static bool test_similar_return_true_itself(void);
static bool test_similar_return_true_copy(void);
...
bool OTEST_StringList(void) {
	...
	driver.register_function(test_similar_return_false_same);
	driver.register_function(test_similar_return_false_not_same);
	driver.register_function(test_similar_return_false_almost);
	driver.register_function(test_similar_return_false_ignore);
	driver.register_function(test_similar_return_false_subset);
	driver.register_function(test_similar_return_true_case);
	driver.register_function(test_similar_return_true_case_order);
	driver.register_function(test_similar_return_true_ignore_order);
	driver.register_function(test_similar_return_true_ignore);
	driver.register_function(test_similar_return_true_itself);
	driver.register_function(test_similar_return_true_copy);
...
static bool test_similar_return_false_same() {
	e.emit_test("Does similar() return false when the two StringLists are not "
		"similar, but contain the same number of strings?");
	e.emit_comment("See ticket #1389");
	StringList sl("a;b;c", ";");
	StringList other("d;e;f", ";");
	char* orig = sl.print_to_string();
	char* check = other.print_to_string();
	bool retVal = sl.similar(other, true);
	e.emit_input_header();
	e.emit_param("StringList", orig);
	e.emit_param("StringList", check);
	e.emit_param("ANYCASE", "TRUE");
...
static bool test_similar_return_false_not_same() {
	e.emit_test("Does similar() return false when the two StringLists are not "
		"similar and contain different number of strings?");
	StringList sl("a;b;c", ";");
	StringList other("d;e;f;g;h;i", ";");
	char* orig = sl.print_to_string();
	char* check = other.print_to_string();
...
static bool test_similar_return_false_almost() {
	e.emit_test("Does similar() return false when the lists only differ by "
		"one string?");
	e.emit_comment("See ticket #1389");
	StringList sl("a;b;c", ";");
	StringList other("a;b;c", ";");
...
static bool test_similar_return_false_ignore() {
	e.emit_test("Does similar() return false when the lists are similar when "
		"ignoring case, but anycase is false?");
	e.emit_comment("See ticket #1389");
	StringList sl("a;b;c", ";");
	StringList other("A;B;C", ";");
	char* orig = sl.print_to_string();
	char* check = other.print_to_string();
	bool retVal = sl.similar(other, false);
	e.emit_input_header();
	e.emit_param("StringList", orig);
	e.emit_param("StringList", check);
	e.emit_param("ANYCASE", "FALSE");
...
static bool test_similar_return_false_subset() {
	e.emit_test("Does similar() return false when the passed StringList is a "
		"subset of the StringList called upon?");
	StringList sl("a;b;c;d;e;f", ";");
	StringList other("a;b;c", ";");
	char* orig = sl.print_to_string();
...
static bool test_similar_return_true_case() {
	e.emit_test("Does similar() return true when the StringLists are "
		"identical when not ignoring case?");
	StringList sl("a;b;c", ";");
	StringList other("a;b;c", ";");
	char* orig = sl.print_to_string();
...
static bool test_similar_return_true_ignore() {
	e.emit_test("Does similar() return return true when the StringLists are "
		"identical when ignoring case?");
	StringList sl("a;b;C;D", ";");
	StringList other("a;B;c;D", ";");
	char* orig = sl.print_to_string();
...
static bool test_similar_return_true_case_order() {
	e.emit_test("Does similar() return true when the StringLists are similar "
		"when not ignoring case?");
	StringList sl("a;b;c", ";");
	StringList other("c;a;b", ";");
	char* orig = sl.print_to_string();
	char* check = other.print_to_string();
	bool retVal = sl.similar(other, false);
	e.emit_input_header();
...
static bool test_similar_return_true_ignore_order() {
	e.emit_test("Does similar() return return true when the StringLists are "
		"similar when ignoring case?");
	StringList sl("a;b;C;D", ";");
	StringList other("D;B;c;a", ";");
	char* orig = sl.print_to_string();
	char* check = other.print_to_string();
	bool retVal = sl.similar(other, true);
	e.emit_input_header();
...
static bool test_similar_return_true_itself() {
	e.emit_test("Does similar() return true when passed the same StringList "
		"called on?");
	StringList sl("a;b;c", ";");
	char* orig = sl.print_to_string();
	bool retVal = sl.similar(sl, false);
	e.emit_input_header();
	e.emit_param("StringList", orig);
	e.emit_param("StringList", orig);
	e.emit_param("ANYCASE", "FALSE");
...
static bool test_similar_return_true_copy() {
	e.emit_test("Does similar() return true when using the copy constructor?");
	StringList sl("a;b;c", ";");
	StringList other(sl);
	char* orig = sl.print_to_string();
	char* check = other.print_to_string();
