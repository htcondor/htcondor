...
// this struct is used to contain statistics values for the Collector class.
// the values are published using the names as shown here. so for instance
// the ClassAd that we publish into will have "TotalAds=32" if the
// TotalAds field below contains the value 32.
//
