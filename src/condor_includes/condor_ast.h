...
class Integer : public IntegerBase
{
    ...
    virtual void    PrintToStr(char*);
	virtual Integer*  DeepCopy(void) const;
...
class Float: public FloatBase
{
	...
	virtual	int	    operator <=(ExprTree&);
    virtual void    PrintToStr(char*);
	virtual Float*  DeepCopy(void) const;
...
class String : public StringBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual String*     DeepCopy(void) const;
...
class Boolean : public BooleanBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual Boolean*    DeepCopy(void) const;
...
class Undefined : public UndefinedBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual Undefined*  DeepCopy(void) const;
...
class Error : public ErrorBase
{
	...
	Error() : ErrorBase() {}
    virtual void        PrintToStr(char*);
	virtual Error*      DeepCopy(void) const;
...
class AddOp: public AddOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual AddOp       *DeepCopy(void) const;
};
...
class SubOp: public SubOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual SubOp       *DeepCopy(void) const;
};
...
class MultOp: public MultOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual MultOp      *DeepCopy(void) const;
};
...
class DivOp: public DivOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual DivOp       *DeepCopy(void) const;
};
...
class MetaEqOp: public MetaEqOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual MetaEqOp    *DeepCopy(void) const;
};
...
class MetaNeqOp: public MetaNeqOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual MetaNeqOp   *DeepCopy(void) const;
};
...
class EqOp: public EqOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual EqOp       *DeepCopy(void) const;
};
...
class NeqOp: public NeqOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual NeqOp       *DeepCopy(void) const;
};
...
class GtOp: public GtOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual GtOp       *DeepCopy(void) const;
};
...
class GeOp: public GeOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual GeOp       *DeepCopy(void) const;
};
...
class LtOp: public LtOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual LtOp       *DeepCopy(void) const;
};
...
class LeOp: public LeOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual LeOp       *DeepCopy(void) const;
};
...
class AndOp: public AndOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual AndOp      *DeepCopy(void) const;
};
...
class OrOp : public OrOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual OrOp        *DeepCopy(void) const;
};
...
class AssignOp: public AssignOpBase
{
    ...
    virtual void        PrintToStr(char*);
	virtual AssignOp    *DeepCopy(void) const;
