...
#define CARMI_LAST    (CARMI_REQ_URL_FOR_FILE)
...
#define CO_CHECK_GENERAL_CKPT				(CO_CHECK_FIRST + 7)
#define CO_CHECK_GENERAL_CKPT_ON_VACATE		(CO_CHECK_FIRST + 8)
#define CO_CHECK_RM_CKPT					(CO_CHECK_FIRST + 9)
#endif
