...
const int SECMAN_ERR_INVALID_POLICY = 2001;
const int SECMAN_ERR_CONNECT_FAILED = 2001;
const int SECMAN_ERR_NO_SESSION = 2001;
const int SECMAN_ERR_ATTRIBUTE_MISSING = 2001;
const int SECMAN_ERR_NO_KEY = 2001;
const int SECMAN_ERR_COMMUNICATIONS_ERROR = 2001;
const int SECMAN_ERR_AUTHENTICATION_FAILED = 2001;
