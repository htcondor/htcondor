...
while(True):
    ...
    if(command.upper() == "COMMANDS"):
        print("S COMMANDS QUIT VERSION RESULTS VERSION AZURE_PING AZURE_VM_CREATE AZURE_VM_DELETE AZURE_VM_LIST AZURE_VMSS_CREATE AZURE_VMSS_DELETE AZURE_VMSS_START AZURE_VMSS_STOP AZURE_VMSS_RESTART")
        continue
