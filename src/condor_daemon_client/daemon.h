...
public:
	...
	void setForceAuthentication(SecMan::sec_req force) { m_force_auth = force; }
	SecMan::sec_req getForceAuthentication() { return m_force_auth; }
...
protected:
	...
	SecMan::sec_req m_force_auth{SecMan::SEC_REQ_UNDEFINED};
	SecMan _sec_man;
