...
bool
makeStartdAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/ )
{
...
bool
makeQuillAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/ )
{
...
bool
makeScheddAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/ )
{
...
bool
makeLicenseAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/ )
{
...
bool
makeMasterAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/ )
{
	hk.ip_addr = "";
...
bool
makeCkptSrvrAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/)
{
	hk.ip_addr = "";
...
bool
makeCollectorAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/)
{
	hk.ip_addr = "";
...
bool
makeStorageAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/)
{
	hk.ip_addr = "";
...
bool
makeNegotiatorAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/)
{
	hk.ip_addr = "";
...
bool
makeHadAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/)
{
	hk.ip_addr = "";
...
bool
makeGridAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& from)
{
    MyString tmp;
...
bool
makeGenericAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& /*from*/ )
{
	hk.ip_addr = "";
...
bool
makeXferServiceAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& from)
{
...
bool
makeLeaseManagerAdHashKey (AdNameHashKey &hk, ClassAd *ad, const ipaddr& from)
{
	return makeNegotiatorAdHashKey( hk, ad, from );
}
