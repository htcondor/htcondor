...
collect (int command, Sock *sock, const ipaddr& from, int &insert)
{
	ClassAd	*clientAd;
	ClassAd	*rval;
...
ClassAd *CollectorEngine::
collect (int command,ClassAd *clientAd,const ipaddr& from,int &insert,Sock *sock)
{
	ClassAd		*retVal;
	ClassAd		*pvtAd;
	int		insPvt;
