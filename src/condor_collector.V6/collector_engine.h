...
class CollectorEngine : public Service
{
  public:
	...
	ClassAd *collect (int, Sock *, const ipaddr&, int &);
	ClassAd *collect (int, ClassAd *, const ipaddr&, int &, Sock* = NULL);
  ...
  private:
	typedef bool (*HashFunc) (AdNameHashKey &, ClassAd *, const ipaddr&);
