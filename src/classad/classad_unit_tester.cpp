...
static void test_classad(const Parameters &, Results &results)
{
    ...
    success = basic->InsertAttr("new", (classad::Value::IntType)4);
    ...
    success = classad2.InsertAttr("a",(classad::Value::IntType)7);
    ...
    success = classad3.InsertAttr("c", (classad::Value::IntType)6);
    ...
    classad3.InsertAttr("c", (classad::Value::IntType)6);
