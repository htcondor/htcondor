#ifndef _CONDOR_WAIT_FOR_STACK_H
#define _CONDOR_WAIT_FOR_STACK_H
...
class WaitForStack : public Functor {
	public:
		WaitForStack( ClassAd * r, EC2GahpClient * g, ClassAd * s,
...
#endif /* _CONDOR_CREATE_WAIT_FOR_STACK_H */
