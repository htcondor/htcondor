...
// Utility function.
void
addStringListToRequestLine( StringList & sl, std::string & reqLine ) {
	const char * text;
	char * escapedText;
...
// Check VM status
int EC2GahpClient::ec2_vm_status(	std::string service_url,
									std::string publickeyfile,
									std::string privatekeyfile,
									std::string instance_id,
									StringList &returnStatus,
...
int EC2GahpClient::ec2_spot_status( std::string service_url,
                                    std::string publickeyfile,
                                    std::string privatekeyfile,
                                    std::string request_id,
                                    StringList & returnStatus,
