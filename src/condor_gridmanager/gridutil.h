...
// Helper functions for classads.  Adds or inserts the name=value
// pair into the classad.  Handles quoting and other magic as necessary.
...
// Prefer the specialized forms, but just in case you want it:
