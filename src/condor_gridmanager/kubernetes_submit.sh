...
# Based on code by Giuseppe Fiorentino (giuseppe.fiorentino@mi.infn.it)
#
# Description:
#   Submission script for Kubernetes, to be invoked by blahpd server.
# Usage:
#   kubernetes_submit.sh -c <command> [-i <stdin>] [-o <stdout>] [-e <stderr>] [-w working dir] [-- command's arguments]
#
