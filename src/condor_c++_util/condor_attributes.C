...
const char *ATTR_IS_WAKE_SUPPORTED        = "IsWakeSupported";
const char *ATTR_WAKE_SUPPORTED_FLAGS     = "WakeSupportedFlags";
const char *ATTR_IS_WAKE_ENABLED          = "IsWakeEnabled";
const char *ATTR_WAKE_ENABLED_FLAGS       = "WakeEnabledFlags";
