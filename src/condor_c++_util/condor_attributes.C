...
PLEASE keep the attributes in this file in alphabetical order!!!!!
Sort them on the attribute name (e.g. "ATTR_START", not the value e.g
"Start").  This list should EXACTLY match the list in
condor_includes/condor_attributes.h!

Also, PLEASE do NOT use tabs to format this file.  It creates weird
formatting problems when other people view it.  Instead, use spaces.
PLEASE keep it consistent.  If you're adding an attribute here, put it
in the right place, and make it look like the rest of the file.
Thanks!
