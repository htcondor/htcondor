/* This file has neccesary definitions to handle permissions on
 * Windows NT.  This header file comes from Microsoft, but is not
 * normally included in a well known place with Visual C++ or NT.
