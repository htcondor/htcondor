...
const char * const ATTR_GLOBUS_CONTACT_STRING	 = "GlobusContactString";
...
const char * const ATTR_GLOBUS_RESOURCE			 = "GlobusResource";
...
const char * const ATTR_PRIVATE_NETWORK_IP_ADDR  = "PrivateNetworkIpAddr";
const char * const ATTR_PRIVATE_NETWORK_NAME     = "PrivateNetworkName";
const char * const ATTR_PUBLIC_NETWORK_IP_ADDR   = "PublicNetworkIpAddr";
...
const char * const ATTR_REMOTE_JOB_ID			 = "RemoteJobId";
const char * const ATTR_REMOTE_OWNER			 = "RemoteOwner";
const char * const ATTR_REMOTE_POOL				 = "RemotePool";
const char * const ATTR_REMOTE_SCHEDD			 = "RemoteSchedd";
