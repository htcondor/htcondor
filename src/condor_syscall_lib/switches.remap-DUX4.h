...
REMAP_ZERO( poll, __poll, int )
REMAP_FOUR( profil, __profil, void , short *, unsigned int , unsigned int , unsigned int )
...
REMAP_ONE( reboot, __reboot, void , int )
...
REMAP_THREE( setitimer, __setitimer, int , int , struct itimerval *, struct itimerval *)
