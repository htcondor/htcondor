...
help( const char * argv0 ) {
	...
	fprintf( stdout, "\tThe instances will be terminated after <lease-duration> "
		"seconds by a lease mechanism which will also delete the SFR and itself "
		"at that time.\n" );
}
