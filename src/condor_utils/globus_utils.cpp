...
activate_globus_gsi( void )
{
	...
	if ( (dl_hdl = dlopen("libglobus_common.so", RTLD_LAZY)) == NULL ||
		 ...
		 (dl_hdl = dlopen("libglobus_callout.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_proxy_ssl.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_openssl_error.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_openssl.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_gsi_cert_utils.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_gsi_sysconfig.so", RTLD_LAZY)) == NULL ||
		 ...
		 (dl_hdl = dlopen("libglobus_oldgaa.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_gsi_callback.so", RTLD_LAZY)) == NULL ||
		 (dl_hdl = dlopen("libglobus_gsi_credential.so", RTLD_LAZY))== NULL ||
		 ...
		 (dl_hdl = dlopen("libglobus_gsi_proxy_core.so", RTLD_LAZY)) == NULL ||
		 ...
		 (dl_hdl = dlopen("libglobus_gssapi_gsi.so", RTLD_LAZY)) == NULL ||
		 ...
		 (dl_hdl = dlopen("libglobus_gss_assist.so", RTLD_LAZY)) == NULL ||
...
#if defined(HAVE_EXT_VOMS)
		 (dl_hdl = dlopen("libvomsapi.so", RTLD_LAZY)) == NULL ||
