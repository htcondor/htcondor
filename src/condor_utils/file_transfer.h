...
class FileTransfer: public Service {
  ...
  public:
	...
	size_t InvokeMultiUploadPlugin(const std::string &plugin_path, const std::string &transfer_files_string, ReliSock &sock, bool send_trailing_eom, CondorError &err);
