...
BOOST_FIXTURE_TEST_CASE(cp_compute_1, cpfix) {
    ...
    BOOST_CHECK_CLOSE(consumption["cpus"], 2.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["memory"], 128.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["disk"], 1024.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["actuators"], 7.0, 0.0001);
}
...
BOOST_FIXTURE_TEST_CASE(cp_compute_2, cpfix) {
    ...
    BOOST_CHECK_CLOSE(consumption["memory"], 128.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["disk"], 1024.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["actuators"], 3.0, 0.0001);
...
BOOST_FIXTURE_TEST_CASE(cp_compute_3, cpfix) {
    ...
    BOOST_CHECK_CLOSE(consumption["memory"], 128.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["disk"], 1024.0, 0.0001);
    BOOST_CHECK_CLOSE(consumption["actuators"], 14.0, 0.0001);
