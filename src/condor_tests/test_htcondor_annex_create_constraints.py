...
TEST_CASES = [
    ...
    ( ['shared@expanse', '--nodes', '2'], False ),
    ( ['shared@expanse', '--nodes', '1'], False),
    ( ['shared@expanse', '--cpus', '4'], True ),
    ( ['shared@expanse', '--cpus', '180'], False ),
    ( ['shared@expanse', '--mem_mb', '1024'], True ),
    ( ['shared@expanse', '--mem_mb', str(1024*1024)], False ),
    ( ['shared@expanse', '--nodes', '1', '--cpus', '4'], True ),
    ( ['shared@expanse', '--nodes', '2', '--cpus', '4'], False ),
    ( ['shared@expanse', '--nodes', '1', '--mem_mb', '1024'], True ),
    ( ['shared@expanse', '--nodes', '2', '--mem_mb', '1024'], False ),
    ( ['shared@expanse', '--cpus', '4', '--mem_mb', '1024'], True ),
    ( ['shared@expanse', '--cpus', '180', '--mem_mb', '1024'], False ),
    ( ['shared@expanse', '--cpus', '4', '--mem_mb', str(1024*1024)], False ),
    ( ['shared@expanse', '--nodes', '1', '--cpus', '4', '--mem_mb', '1024'], True ),
    ( ['shared@expanse', '--nodes', '1', '--cpus', '180', '--mem_mb', '1024'], False ),
    ( ['shared@expanse', '--nodes', '1', '--cpus', '4', '--mem_mb', str(1024*1024)], False ),
    ( ['shared@expanse', '--nodes', '1', '--cpus', '4', '--mem_mb', '1024'], True ),

    ( ['gpu-shared@expanse', '--gpus', '1'], False ),
    ( ['gpu-shared@expanse', '--nodes', '1', '--gpus', '1'], False ),
    ( ['gpu-shared@expanse', '--gpus', '5'], False ),
    ( ['gpu-shared@expanse', '--nodes', '5', '--gpus', '1'], False ),

    ( ['gpu-shared@expanse', '--cpus', '4', '--gpus', '1'], True ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--nodes', '1', '--gpus', '1'], True ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--gpus', '5'], False ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--nodes', '5', '--gpus', '1'], False ),

    ( ['gpu-shared@expanse', '--mem_mb', '1024', '--gpus', '1'], True ),
    ( ['gpu-shared@expanse', '--mem_mb', '1024', '--nodes', '1', '--gpus', '1'], True ),
    ( ['gpu-shared@expanse', '--mem_mb', '1024', '--gpus', '5'], False ),
    ( ['gpu-shared@expanse', '--mem_mb', '1024', '--nodes', '1', '--gpus', '5'], False ),

    ( ['gpu-shared@expanse', '--cpus', '4', '--mem_mb', '1024', '--gpus', '1'], True ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--mem_mb', '1024', '--nodes', '1', '--gpus', '1'], True ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--mem_mb', '1024', '--gpus', '5'], False ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--mem_mb', '1024', '--nodes', '1', '--gpus', '5'], False ),

    ( ['gpu-shared@expanse', '--cpus', '80', '--mem_mb', '1024', '--gpus', '1'], False ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--mem_mb', str(1024*1024), '--gpus', '1'], False),
    ( ['gpu-shared@expanse', '--cpus', '80', '--mem_mb', '1024', '--nodes', '1', '--gpus', '1'], False ),
    ( ['gpu-shared@expanse', '--cpus', '4', '--mem_mb', str(1024*1024), '--nodes', '1', '--gpus', '1'], False),
