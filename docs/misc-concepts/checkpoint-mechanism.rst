...
services. :index:` <single: implementation;checkpoint>`
...
:index:` <single: compression;checkpoint>`
...
:index:` <single: stand alone;checkpoint>`
...
:index:` <single: library interface;checkpoint>`
