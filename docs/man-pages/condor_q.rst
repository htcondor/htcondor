...
The available output data are as follows:
 ...
 ST
    ...
    somewhat according to the job universe and the timing of updates:
    ...
    .. list-table::
       ...
       * - State
         - Description
       * - I
         - Idle (waiting for a machine to execute on)
       * - Ic
         - Idle, but cannot be scheduled because it is in cooldown status
       * - R
         - Running
       * - H
         - On hold
       ...
       * - <
         - Actively transferring the input sandbox
       * - <q
    ...
    *fmt*. To display the attribute or expression the format must
    ...
    .. list-table::
       ...
       * - Specifier
         - Description
       * - %s
         - Suitable for strings such as :ad-attr:`Owner`
       * - %d
         - Suitable for integers such as :ad-attr:`ClusterId`
       * - %f
         - Suitable for floating point numbers such as :ad-attr:`RemoteWallClockTime`
       * - %v
