HTCondor Job Description Language
=================================

:index:`Job Description Language`

Description
-----------

The HTCondor Job Description Language (JDL) defines the commands used in
submit description files passed to :tool:`condor_submit`. See
:manpage:`condor_submit(1)` for information about the *condor_submit* tool and
