...
:index:` <single: condor_dagman_metrics_reporter;HTCondor commands>`
:index:` <single: condor_dagman_metrics_reporter command>`
 ...
 **-t **\ *maxtime*
    ...
    :index:` <single: DAGMAN_PEGASUS_REPORT_TIMEOUT>` configuration variable.
 **-f **\ *metrics\_file*
