...
:index:`condor_transfer_data;HTCondor commands<single: condor_transfer_data;HTCondor commands>`\ :index:`condor_transfer_data command<single: condor_transfer_data command>`
