.. |rrm| replace:: :subcom:`retry_request_memory`
.. |rrd| replace:: :subcom:`retry_request_disk` 
...
+----------------------------------+-------------------------------------+--------------------+-----------------------------+
| | 34                             | Job resource usage exceeded a       | Exceeded Resource: |                             |
| | [JobOutOfResources]            | provisioned limit; the limit        |                    |                             |
|                                  | exceeded is specified in the        |                    |                             |
|                                  | subcode.                            |                    |                             |
+----------------------------------+-------------------------------------+--------------------+-----------------------------+
|                                  | Memory usage exceeded               | 102                | Resubmit with larger        |
|                                  |                                     |                    | :subcom:`request_memory` or |
|                                  |                                     |                    | consider using |rrm|        |
+----------------------------------+-------------------------------------+--------------------+-----------------------------+
|                                  | Disk usage exceeded                 | 104                | Resubmit with larger        |
|                                  |                                     |                    | :subcom:`request_disk` or   |
|                                  |                                     |                    | consider using |rrd|        |
+----------------------------------+-------------------------------------+--------------------+-----------------------------+
