...
:tool:`htcondor annex`, helps users extend an existing HTCondor
...
The rest of this chapter is concerned with using the :tool:`htcondor annex` tool
...
manually construct a :ref:`condor_in_the_cloud` using :tool:`htcondor annex`.
