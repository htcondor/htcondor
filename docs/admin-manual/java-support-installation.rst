...
:index:`Java;installation<single: Java;installation>` :index:`Java<single: Java>`
...
**java\_vm\_args**\ :index:`java_vm_args;submit commands<single: java_vm_args;submit commands>`, the
