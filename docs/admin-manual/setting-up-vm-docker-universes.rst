...
:index:`for the vm universe;installation<single: for the vm universe;installation>`
:index:`set up for the vm universe;universe<single: set up for the vm universe;universe>`
...
-  If using file transfer (the submit description file contains
   **vmware\_should\_transfer\_files =
   true**\ :index:`vmware_should_transfer_files = true;submit commands<single: vmware_should_transfer_files = true;submit commands>`),
...
-  If using a shared file system, ensure that the submit description
   file command
   **vmware\_dir**\ :index:`vmware_dir;submit commands<single: vmware_dir;submit commands>` does not
...
:index:`set up;docker universe<single: set up;docker universe>`
:index:`for the docker universe;installation<single: for the docker universe;installation>`
:index:`docker;universe<single: docker;universe>`
:index:`set up for the docker universe;universe<single: set up for the docker universe;universe>`
...
**docker\_image**\ :index:`docker_image;submit commands<single: docker_image;submit commands>` to
...
:index:`HasDocker;ClassAd machine attribute<single: HasDocker;ClassAd machine attribute>`
