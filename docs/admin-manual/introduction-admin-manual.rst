...
An HTCondor pool
:index:`HTCondor<single: HTCondor; pool>`\ :index:`pool of machines<single: pool of machines>` is
...
:index:`resource<single: resource; owner>`\ :index:`machine<single: machine; owner>` the one who
...
:index:`machine<single: machine; central manager>`
 ...
 Central Manager
    ...
    :index:`machine<single: machine; execute>`
 Execute
    ...
    :index:`machine<single: machine; submit>`
 Submit
    Any machine in the pool, including the central manager, can be
    ...
    :index:`machine<single: machine; checkpoint server>`
 Checkpoint Server
...
:index:`HTCondor daemon<single: HTCondor daemon; descriptions>`
:index:`daemon<single: daemon; descriptions>`
