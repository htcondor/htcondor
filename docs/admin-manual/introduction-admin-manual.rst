...
An HTCondor pool
:index:` <single: pool;HTCondor>`\ :index:` <single: pool of machines>` is
comprised of a single machine which serves as the central manager,
:index:` <single: central manager>`\ and an arbitrary number of other
...
:index:` <single: owner;resource>`\ :index:` <single: owner;machine>` the one who
...
machine that is providing that service: :index:` <single: central manager>`
:index:` <single: central manager;machine>`
 ...
 Central Manager
    ...
    network to the central manager. :index:` <single: execute machine>`
    :index:` <single: execute;machine>`
 Execute
    ...
    resource requests it can serve. :index:` <single: submit machine>`
    :index:` <single: submit;machine>`
 Submit
    Any machine in the pool, including the central manager, can be
    ...
    :index:` <single: checkpoint server>`
    :index:` <single: checkpoint server;machine>`
 Checkpoint Server
...
:index:` <single: descriptions;HTCondor daemon>`
:index:` <single: descriptions;daemon>`
 ...
 *condor\_master*
    ...
    *condor\_master* also supports various administrative commands that
    ...
    :index:` <single: condor_startd daemon>`
 *condor\_startd*
    ...
    :index:` <single: condor_starter daemon>`
 *condor\_starter*
    ...
    machine, and exits. :index:` <single: condor_schedd daemon>`
 *condor\_schedd*
    ...
    *condor\_rm*, all must connect to the *condor\_schedd* to do their
    ...
    serve that particular request. :index:` <single: condor_shadow daemon>`
 ...
 *condor\_shadow*
    ...
    *condor\_shadow* which performs the system call on the submit
    ...
    accessed. :index:` <single: condor_collector daemon>`
 *condor\_collector*
    ...
    *condor\_collector* for important information, such as what address
    ...
    :index:` <single: condor_negotiator daemon>`
 *condor\_negotiator*
    ...
    *condor\_negotiator* can preempt that resource and match it with the
    ...
    this number grows. :index:` <single: condor_kbdd daemon>`
 ...
 *condor\_kbdd*
    ...
    enforce. :index:` <single: condor_ckpt_server daemon>`
 *condor\_ckpt\_server*
    ...
    submit machine. :index:` <single: condor_gridmanager daemon>`
 *condor\_gridmanager*
 ...
 *condor\_credd*
    ...
    a secure manner. :index:` <single: condor_had daemon>`
 *condor\_had*
 ...
 *condor\_replication*
    ...
    machine stops working. :index:` <single: condor_transferer daemon>`
 *condor\_transferer*
    ...
    exiting. :index:` <single: condor_procd daemon>`
 *condor\_procd*
    ...
    is enabled. :index:` <single: condor_job_router daemon>`
 *condor\_job\_router*
...
to provide optional functionality. :index:` <single: condor_hdfs daemon>`
