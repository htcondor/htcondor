...
:index:` <single: power management>` :index:` <single: green computing>`
:index:` <single: offline machine>`
...
:index:` <single: entering a low power state;power management>`
...
``HIBERNATE`` :index:` <single: HIBERNATE>` configuration variable (see
...
:index:` <single: HIBERNATE_CHECK_INTERVAL>` configuration variable. A
...
:index:` <single: leaving a low power state;power management>`
...
:index:` <single: condor_rooster daemon>`
...
evaluate the ``UNHIBERNATE`` :index:` <single: UNHIBERNATE>` expression of
the offline machines.

To do this, define a log file using the ``OFFLINE_LOG``
:index:` <single: OFFLINE_LOG>` configuration variable. See
section \ `Configuration
Macros <../admin-manual/configuration-macros.html>`__ on
page \ `Configuration
...
:index:` <single: OFFLINE_EXPIRE_ADS_AFTER>`. The timing begins from the time
...
:index:` <single: Linux platform details;power management>`
...
:index:` <single: Windows platform troubleshooting;power management>`
...
:index:` <single: green computing>` :index:` <single: power management>`
:index:` <single: administrators manual>`
