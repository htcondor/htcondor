...
schedds.  See :ref:`admin-manual/ep-policy-configuration:directly
attaching an ep to one ap` for a description of how direct attach works
and why an administrator might want to use it.
