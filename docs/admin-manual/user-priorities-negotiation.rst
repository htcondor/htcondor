...
:index:`priority<single: priority; in machine allocation>`
...
EUP may be useful:
 ...
 Nice users
    ...
    **nice\_user**\ :index:`submit commands<single: submit commands; nice_user>` set to
...
:index:`negotiation<single: negotiation; priority>` :index:`matchmaking<single: matchmaking; priority>`
:index:`preemption<single: preemption; priority>`
...
:index:`matchmaking<single: matchmaking; negotiation algorithm>`
...
:index:`scheduling<single: scheduling; pie slice>`
:index:`scheduling<single: scheduling; pie spin>`
...
:index:`groups<single: groups; accounting>` :index:`accounting<single: accounting; by group>`
:index:`priority<single: priority; by group>`
...
:index:`ClassAd job attribute<single: ClassAd job attribute; AccountingGroup>`
...
:index:`negotiation<single: negotiation; by group>` :index:`groups<single: groups; quotas>`
:index:`quotas<single: quotas; hierarchical quotas for a group>`
