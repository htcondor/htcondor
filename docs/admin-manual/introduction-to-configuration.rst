...
:index:` <single: configuration: introduction>`
...
:index:` <single: evaluation order;configuration file>`
...
#. The value of configuration variable ``LOCAL_CONFIG_DIR``
   :index:` <single: LOCAL_CONFIG_DIR>` lists one or more directories which
...
#. The value of configuration variable ``LOCAL_CONFIG_FILE``
   :index:` <single: LOCAL_CONFIG_FILE>` lists one or more configuration
...
:index:` <single: in configuration file;macro>`
:index:` <single: macro definitions;configuration file>`
...
``LOCAL_CONFIG_FILE`` :index:` <single: LOCAL_CONFIG_FILE>` configuration
variable.
...
(Note that the ``include command`` :index:` <single: include command>`
...
:index:` <single: INCLUDE syntax;configuration>`
:index:` <single: INCLUDE configuration syntax>`
...
:index:` <single: Error and warning syntax;configuration>`
:index:` <single: Error and warning configuration syntax>`
...
:index:` <single: IF/ELSE syntax;configuration>`
:index:` <single: IF/ELSE configuration syntax>`
...
:index:` <single: function macros;configuration>`
...
:index:` <single: configuration change requiring a restart of HTCondor>`
...
restart of HTCondor in order to use the changed value.
 ...
 ``$(IPV4_ADDRESS)``\ :index:` <single: IPV4_ADDRESS>`
 ...
 ``$(SUBSYSTEM)``\ :index:` <single: SUBSYSTEM>`
    ...
    :index:` <single: subsystem names>`
    :index:` <single: subsystem names;macro>`
 ...
 ``$(DETECTED_CPUS)``\ :index:` <single: DETECTED_CPUS>`
    ...
    :index:` <single: COUNT_HYPERTHREAD_CPUS>` is ``False``. When
    ``COUNT_HYPERTHREAD_CPUS`` is ``True``.
 ``$(DETECTED_PHYSICAL_CPUS)``\ :index:` <single: DETECTED_PHYSICAL_CPUS>`
...
:index:` <single: macros;configuration file>`

 ``$(ARCH)``\ :index:` <single: ARCH>`
