...
:index:`distributed ownership<single: distributed ownership; of machines>`
...
of) different times, :index:`job<single: job; multiple data sets>`\ perhaps
...
:index:`HTCondor<single: HTCondor; resource management>`
:index:`resource<single: resource; management>`
...
:index:`resource<single: resource; offer>`\ A user specifies a resource request ad
:index:`resource<single: resource; request>`\ when submitting a job. The request
