...
#     generating a file list to file %file section (@CPACK_RPM_INSTALL_FILES@)
...
MESSAGE("Using patched version of CPackRPM.cmake-2.8.3 located in build/cmake")
...
# Remove user-specified files
FOREACH ( _REMOVE_FILE  ${CPACK_RPM_SPEC_IGNORE_FILES} )
  STRING (REGEX REPLACE "${_REMOVE_FILE}\n" "" CPACK_RPM_INSTALL_FILES ${CPACK_RPM_INSTALL_FILES})
ENDFOREACH()
