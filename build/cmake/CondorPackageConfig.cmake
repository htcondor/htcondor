...
if(PRE_RELEASE)
  ...
  elseif(UNIX)
    execute_process( COMMAND date "+%Y%m%d_%H%M%S" OUTPUT_VARIABLE DATE OUTPUT_STRIP_TRAILING_WHITESPACE )
    set (CONDOR_PACKAGE_NAME "${PACKAGE_NAME}-${PACKAGE_VERSION}-${DATE}")
  else()
