...
if ( ${OS_NAME} STREQUAL "LINUX" )
	...
	if (${BIT_MODE} MATCHES "32" OR ${SYS_ARCH} MATCHES "IA64" )
		if ( ${SYSTEM_NAME} MATCHES "rhel3" )
			...
			set( CONDOR_RPATH "$ORIGIN/../lib/condor:/usr/lib/condor:$ORIGIN/../lib:/lib:/usr/lib" )
			set( EXTERNALS_RPATH "$ORIGIN/../lib/condor:/usr/lib/condor:$ORIGIN/../lib:/lib:/usr/lib" )
			set( PYTHON_RPATH "$ORIGIN/../condor:$ORIGIN/../:/lib:/usr/lib" )
		endif()
	else()
		set( CONDOR_RPATH "$ORIGIN/../lib/condor:/usr/lib64/condor:$ORIGIN/../lib:/lib64:/usr/lib64" )
		set( EXTERNALS_RPATH "$ORIGIN/../lib/condor:/usr/lib64/condor:$ORIGIN/../lib:/lib64:/usr/lib64" )
		set( PYTHON_RPATH "$ORIGIN/../condor:$ORIGIN/../:/lib64:/usr/lib64" )
	endif()
