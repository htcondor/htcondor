...
if ($boos) {
	...
	if ($ENV{NMI_PLATFORM} =~ /_win/i) {
		...
		print FH '"sources\msconfig\tar.exe" -czf swap_userdir.tgz userdir/BUILD-ID userdir/BUILD-EPOCH userdir/GIT-SHA userdir/nmi_tools userdir/src/condor_examples userdir/src/condor_tests' . "\n";
		...
		print FH '#!/bin/sh' . "\n";
		print FH 'tar czf swap_userdir.tgz userdir/BUILD-ID userdir/BUILD-EPOCH userdir/GIT-SHA userdir/nmi_tools userdir/src/condor_examples userdir/src/condor_tests' . "\n";
