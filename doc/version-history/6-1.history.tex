...
It was not publically released, as it will be released as 6.2.0 once
it is considered ``stable'' by heavy testing at the UW-Madison
Computer Science Department Condor pool.
...
section~\ref{sec:Security-Access-Levels} on
page~\pageref{sec:Security-Access-Levels}.
...
\item The Linux 2.2.14 kernel, which is used by default with RedHat 6.2,
...
\item Initial supported added for RedHat Linux 6.2 (i.e. glibc 2.1.3).
