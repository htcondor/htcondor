...
\MacroNI{QUEUE\_SUPER\_USER\_MAY\_IMPERSONATE} specifies a regular
expression that matches the usernames (i.e. job owner names) that
...
has had a job in the queue during the life of the schedd.  For
proper functioning of \Condor{shadow}, \Condor{gridmanager}, and
\Condor{job\_router}, this expression, if set, must match the owner
