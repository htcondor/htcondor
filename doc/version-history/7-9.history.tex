...
\item The schedd will now also advertise demand by jobs for slots,
weighted by the count of requested CPUs, if the parameter
NEGOTIATOR\_USE\_WEIGHTED\_DEMAND is set to true (defaults to
false).
\Ticket{3574}
