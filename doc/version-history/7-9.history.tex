...
\item when the configuration variable \Macro{ASSIGN\_CPU\_AFFINITY}
is set, the \Condor{startd} will automatically set the CPU affinity
mask the job runs with, so that a multi-threaded job will not use
