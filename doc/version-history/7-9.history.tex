...
\item Fixed a bug wherein it was impossible for the \Condor{startd} to clean
up execute directories after a \Condor{starter} was prematurely killed, while using 
...
\item Using privilege separation may cause execute directories to be leaked, if
the starter is shutdown prematurely, say, by a hard kill signal or power
interruption.
\Ticket{3573}
