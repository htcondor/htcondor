...
and \Macro{MACHINE\_RESOURCE\_<resourcename>}
...
\item Fixed a bug where the use of a pipe in the config file on Windows would
cause a visible console window to show up whenever the configuration was read.
\Ticket{1534}
