...
\item The \Condor{schedd} can now write an audit log that records all
commands issued by users that modify the job queue.
To enable this feature, set the new configuration variable
\Macro{SCHEDD\_AUDIT\_LOG} to the filename that the \Condor{schedd}
should use to write the audit log.
\Ticket{3493}
