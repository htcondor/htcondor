...
\item The \condor{collector} will accept and display collector ads for
...
parameter \Macro{COLLECTOR\_NAME}.
\Ticket{3467}
...
\item Fixed a bug introduced in Condor 7.9.0 that caused the following
parameters to not sort ads properly when they evaluated to True or False:
