...
support for lists and sub-ClassAds. 
\Ticket{3494}
...
\item Fixed leaking mount points to the greater
namespace when using features such as MOUNT_UNDER_SCRATCH 
on filesystems that have been mounted with shared propagation 
enabled. 
\Ticket{3505}
...
\item Fixed a bug where \Condor{status} queries would not work unless the \Condor{collector}
