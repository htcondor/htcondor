...
to \Expr{True} to indicate that an X.509 user proxy is required for the
job. If \SubmitCmd{x509userproxy} isn't set, then the proxy file
will be looked for in the standard locations.
\Ticket{3025}
