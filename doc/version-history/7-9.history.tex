...
\item Condor will avoid selecting down (disabled) network interfaces on Linux.  Previously Condor could select a down interface over an up (active) interface.
