...
\item The Concurrency limits now work with parallel jobs
...
% gittrack #1647
\item \Condor{job\_router} is no longer restricted to routing only vanilla
...
% gittrac #1342
% gittrac #1644
\item Fixed a problem affecting the use of 7.5.3 \Condor{startd} and
  \Condor{master} daemons in a pool with a collector from before
  7.5.2.  On shutdown, \Condor{startd} and \Condor{master} caused
  all startd and master ads respectively to be removed from the
  collector.
