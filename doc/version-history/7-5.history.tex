...
\item Windows packages are not included in this release.  We expect to
  release Windows packages in Condor 7.5.6.

\item AIX packages are not included in this release.  We are planning
  to drop support for AIX.  Please contact us if this is a problem for
  you.
...
\item The size of the Condor installation has increased by as much as
  60\% compared to 7.5.4.  We hope to eliminate most of this
  increase in 7.5.6.
