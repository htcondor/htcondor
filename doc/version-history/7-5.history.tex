...
% gittrac #1719
\item New configuration setting \Macro{STARTD\_PUBLISH\_WINREG} can contain
a list of Windows registry keynames whose values will be published in StartD's
ClassAd.
