...
development libraries. This change should be mostly transparent in the 
...
\item The new configuration variable \Macro{TARGET\_MACHINE\_ATTRS}
specifies a list of machine ClassAd attributes for which \Expr{Target.} should
be prepended to these attributes appearing in any job ClassAd expressions.

\item The new configuration variable \Macro{TARGET\_JOB\_ATTRS}
specifies a list of job ClassAd attributes for which \Expr{Target.} should
be prepended to these attributes appearing in any machine ClassAd expressions.
