...
% gittrac #1922
\item A bug has been fixed that caused Condor daemons to crash in rare
  circumstances when receiving connections.  The crash occurred during
  authorization of the new connection.
