...
\item Quill is now a ``contrib feature'' of Condor.  This means it is
  no longer included in the builds of Condor provided by UW, but it is
  available as a feature that can be enabled by those who compile
