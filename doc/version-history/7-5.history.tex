...
% gittrac #1886
\item \Condor{schedd} is now more efficient in handling the exit of
  \Condor{shadow} processes when there are large numbers of shadows.
...
\item The new configuration variable
  \MacroNI{SHADOW\_CHECKPROXY\_INTERVAL} specifies the number of
