...
% gittrac #1817
\item Fixed a compatibility problem between versions of
  \Condor{status} from before 7.5.2 and versions of \Condor{startd}
  from 7.5.2 and onwards when using the \Opt{-direct} option.  In this
  situation, \Condor{status} did not retrieve any ads.  From 7.5.5
  and onwards, older versions of \Condor{status} should work.
