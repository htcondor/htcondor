...
\item The unix \Condor{master} failed when trying to restart itself if
\MacroNI{MASTER\_LOCK} was defined or if it was invoked with
\Opt{-t}.  This bug has existed since 7.0 and likely much earlier.
