...
\item The format of \Condor{status -grid} has been changed to provide more
useful information.
...
% gittrac #356
\item For grid-type nordugrid in the grid universe, job status information
...
% gittrac #475
\item The new configuration expression \Macro{GRIDMANAGER\_SELECTION\_EXPR}
...
corresponding throttle have been removed.
