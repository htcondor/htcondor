...
% gittrac 1631
\item Fixed an erroneous error message from \Condor{run} which stated
that the ``DAGMan job was aborted by the user" when the job submitted
by \Condor{run} was aborted by the user. It now states that ``The job
