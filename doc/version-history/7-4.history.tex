...
% gittrac #1256
\item Fixed a problem that in rare cases caused \Condor{schedd} to
crash shortly after \Condor{gridmanager} exited.  This bug has existed since
before Condor 6.8.
...
\item Condor version 7.4.2 not yet released.
