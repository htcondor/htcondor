...
\item
  ...
  \Attr{transfer\_output\_files} and \Expr{ON\_EVICT\_OR\_EXIT} fails
  to produce all of the specified files and exits (suppose when core
  dumping due to a fault) then the stdout, stderr, and core file of the
  job weren't brought back.
