...
\item The new configuration variable
  ...
  be set to \Expr{False} to disable Condor's dynamic algorithm for chosing
...
\item 
  Fixed a bug where processor affinity settings were ignored if
...
% gittrack 1405
\item \MacroNI{TCP\_FORWARDING\_HOST} did not work in some situations because
of Condor's attempts to automatically rewrite published addresses to
...
that start with a digit, such as "1abc", as specifying a
cluster number. 
