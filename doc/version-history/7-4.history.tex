...
% gittrac 1434
\item Fixed bad behavior in \Condor{quilld} where, under certain error
...
database. As a consequence of this bug fix, the \Attr{LogBody} column
for each row in the \Attr{Error\_SqlLogs} table will be empty. Please
consult the \Condor{quilld} daemon log file for the error instead.
