...
of trouble was introduced in 7.3.2.  However, a smaller memory leak that
...
% gittrack 1160
\item Fixed a bug from 6.1.14 that resulted in the \Condor{schedd} performing
the operation scheduled via \MacroNI{WALL\_CLOCK\_CKPT\_INTERVAL} at the
specified frequency (default 1h) multiplied by the number of times the
\Condor{schedd} daemon had been reconfigured during its lifetime.  This could
lead to degraded performance, especially prior to 7.4.1 when this operation
was more disk-intensive.
