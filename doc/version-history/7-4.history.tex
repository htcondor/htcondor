...
% gitrack #553
\item Fixed a bug where if \Condor{compile} is invoked in such a manner as
this: \Condor{compile} \Opt{gcc} \Opt{-print-prog-name=ld} an error would
be emitted and \Condor{compile} would exit with a bad exit code.
