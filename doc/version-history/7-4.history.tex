...
% gittrac 1485
\item Fixed a bug in which \Condor{submit} checked for bad schedd cron 
 arguments incorrectly within a submit file. Now \Condor{submit} will detect 
 the problem and print out an error message.
