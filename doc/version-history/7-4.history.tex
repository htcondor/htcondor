...
% gittrac 1543
\item When the startd is running with an execute directory on
a very large filesystem, with more than 32 bits worth of free blocks
...
as with a filename with no directory specified.
...
% gittrac 961
\item Fixed a bug where the \Attr{STARTD\_CRON\_TEST\_PERIOD} macro's default
unit should have been seconds, but instead was undefined.
