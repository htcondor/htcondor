...
if the job exits in such a manner so as to not produce all
output files specified in \SubmitCmd{transfer\_output\_files},
then the files which are not able to be transferred back due to non-existence
will appear as zero length files.
