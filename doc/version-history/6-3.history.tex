...
\item Added detection of Java during installation process.

\item When you use \Condor{hold} and \Condor{release}, you now see an
entry about the event in the UserLog file for the job.

\item When you use \Condor{rm} to remove a Condor job, you now see a
string saying the job was removed by \Condor{rm} in the UserLog file
