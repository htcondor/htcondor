%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introduction to HTCondor Versions}\label{sec:History-Intro}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{version-history/8-9.history.tex}
% upgrade instructions are in the Pool Management section
\input{version-history/upgradingto8-8.tex}
%\input{version-history/upgradingto8-6.tex}
%\input{version-history/upgradingto8-4.tex}
%\input{version-history/upgradingto8-2.tex}
%\input{version-history/upgradingto8-0.tex}
\input{version-history/8-8.history.tex}
\input{version-history/8-7.history.tex}
\input{version-history/8-6.history.tex}
% as of the 8.8.0 release, the 8-5 and 8-4 version histories no longer included.
%\input{version-history/8-5.history.tex}
%\input{version-history/8-4.history.tex}
% as of the 8.6.0 release, the 8-3 and 8-2 version histories no longer included.
...
%\input{version-history/7-9.history.tex}
