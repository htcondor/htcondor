...
\item The upgrade will change the \AdAttr{CheckpointPlatform} for all
...
\AdAttr{CheckpointPlatform} to its previous value using the
\Macro{CHECKPOINT\_PLATFORM} configuration macro, or change the checkpointed
jobs' \AdAttr{LastCheckpointPlatform} using \Condor{qedit}.
