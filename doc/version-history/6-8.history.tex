...
\item Fixed a bug where Condor would erroneously say a scheduler
universe's executable was missing or not executable if the scheduler
universe job had been submitted with CopyToSpool == False in the submit
description file and the user had a umask which prevented the condor
user from following the search path to the user owned executable.
