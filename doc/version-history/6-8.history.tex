...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{\label{sec:New-6-8-8}Version 6.8.9}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\noindent Release Notes:

Version 6.8.9 of Condor is identical to version 6.8.8 except that we
back-ported and included the four security patches released and documented
in Version 7.0.5.  See the bugs fixes labeled ``Security'' in
section~\ref{sec:New:7-0-5} above.
