...
Additonally, each daemon now runs a small test at startup to verify
that stderr and stdout work as expected -- if not, the daemon will
hang at startup rather than randomly.
