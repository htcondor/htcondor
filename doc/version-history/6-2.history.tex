...
not being automatically appened to the requriements of a Vanilla-universe job,
possibly causing it to run on machines where it will not sucessfully run. This
has been fixed.
