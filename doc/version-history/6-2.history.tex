...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\label{sec:New-6-2-3}Version 6.2.3}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent New Features:
\begin{itemize}

\item None. This version is identical to 6.2.2, but with a bug fixed
in the installer.
...
\item The installer can now find condor_run
...
If you refer to \MacroU{IP\_ADDRESS}, it will be replaced with the
