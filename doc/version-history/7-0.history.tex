...
\item This is a bugfix release.  A bug in 7.0.2 sometimes caused
the schedd to become unresponsive for 20 seconds when starting
\Condor{shadow} to run a job, so anyone running 7.0.2 is strongly
...
\item Fixed a bug in 7.0.2 that sometimes caused the schedd to become
unresponsive for 20 seconds when starting \Condor{shadow} to run a job.
