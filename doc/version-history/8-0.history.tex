...
\item HTCondor now forces proxies that it delegates to be a minimum of 1024 bits.
...
\item Fixed a rare bug in the \Condor{negotiator} where even
if preemption was completely disabled via the \Macro{PREEMPTION\_REQUIREMENTS} = false
setting, a newly started job could be preempted.  This bug is much more likely when
\Macro{NEGOTIATOR\_CYCLE\_DELAY} is set lower than the default value.
\Ticket{4185}
