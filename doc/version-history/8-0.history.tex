...
where group hierarchies with internal nodes that set accept\_surplus to
...
\item \Macro{CCB\_ADDRESS} did not correctly support a list of CCB
  servers.  Only the first one was used.
\Ticket{3699}
...
\item Fixed a bug that caused some log messages to be terminated with binary characters.
\Ticket{3706}
