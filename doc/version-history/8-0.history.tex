...
\item Fixed a bug that caused \Condor{q} \Opt{-dag} \Opt{-run}.to print garbage.
\Ticket{3578}

\item Fixed a memory leak in the \Condor{gridmanager} triggered when
submitting grid-type ec2 jobs.
\Ticket{3720}
