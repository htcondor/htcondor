...
\item Fixed \Condor{q} command line parsing to look for \Opt{-stream-results}
...
\item Fixed a bug that caused attempts to set CPU affinity to be
quietly ignored on Windows.
\Ticket{4131}
