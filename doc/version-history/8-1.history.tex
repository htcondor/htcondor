...
\item Improved restart time of the \Condor{schedd} after a crash.
\Ticket{4169}
...
\item Fixed a bug that would leak one socket in each daemon when
the \Macro{NO\_DNS} option is set.
\Ticket{4140}
