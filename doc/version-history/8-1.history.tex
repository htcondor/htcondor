...
\item Fixed a bug introduced earlier in this developer series that could cause
\Condor{submit} to crash when reading large submit files.
\Ticket{4260}

\item Fixed a bug that prevented a configuration variable from referring to itself
when the previous value was defined in the code rather than in a configuration file.
\Ticket{4256}
