...
enhanced to support lower-cost, higher-latency updates to the job
ad residing in the \Condor{schedd}.  These two new subcommands,
set\_job\_attr\_delayed and get\_job\_attr\_delayed allow the job
to send lightweight notification for events such as progress
monitorings, which need not be durable.
\Ticket{3353}
