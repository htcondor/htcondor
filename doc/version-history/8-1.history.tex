...
\item Added startd attributes \Macro{TotalJobStarts}, \Macro{RecentTotalJobStarts} which respective, report
the total number of jobs started by this startd since it booted, and the number of jobs started in the
last twenty minutes.  Similiarly, the startd now also reports \Macro{TotalPreemptions} and
\Macro{RecentTotalPreemptions}, the number of jobs preempted since the started has started, and
