...
\item The python bindings now allow the user to perform the same file locking protocol
as HTCondor daemons.
\Ticket{4315}
...
\item The shared port daemon no longer will block on a very unresponsive daemon.
\Ticket{4314}
