...
\item \Condor{ssh\_to\_job} no longer tries to connect to held jobs.  It
instead reports the hold reason.  This also applies to interactive jobs.
\Ticket{3867}

 Interactive jobs, and \Condor{ssh\_to\_job}, now report if (and why)
the job in question is held, as this will normally prevent them from
connecting.
\Ticket{3867}
