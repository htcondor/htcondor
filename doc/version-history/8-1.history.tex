...
to contain only files that the configurator needs to add to the list of valid files.
A new configuration variable \Macro{SYSTEM\_VALID\_SPOOL\_FILES} contains the
files that are known to be valid at the time HTCondor was built. \Condor{preen}
will use the union of these two configuration variables as the set of valid files.
\Ticket{4257}
