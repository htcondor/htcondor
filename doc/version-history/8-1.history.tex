...
\item Added configuration parameter \Macro{OFFLINE\_MACHINE\_RESOURCE\_<name>}
...
\item In UW style builds, set the RPATH such that LD\_LIBRARY\_PATH need
not be set in order to use the python bindings.
\Ticket{4128}
