...
\ticket Fixed a bug that caused substitution in configuration values to ignore
per-daemon overrides. This is a long-standing bug that may result in subtle changes
in the way your configuration files are processed.
See section \ref{sec:Config-File-Macros} for an example.
\Ticket{3822}
