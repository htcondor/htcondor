...
\item Added attributes to the \Condor{defrag} daemons MeanDrainedArrived,
which measures the mean time between arrivals of fully drained machines,
and DrainedMachines, which measures the total numbers of fully drained machines
which have arrived during the runtime of this \Condor{defrag} daemon.
\Ticket{4055}

\item Added support for the defrag option for the \Condor{status} command.
\Ticket{4039}
