...
\item The \Condor{gridmanager} and \Condor{ft-gahp} can now create a
dynamic security session for performing file transfers.
Before, the security configuration parameters had to be set in a special
...
controls whether sensitive data (e.g. security keys or passwords) should be
hidden when communication with a GAHP server is written to a dameon log.
The default is True.
\Ticket{3536}
