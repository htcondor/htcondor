...
values in Celcius, but ended in F to indicate Farenheit. The endings have been
changed to C to correctly indicate Celcius. For instance \Attr{CUDA<n>DieTempF}
