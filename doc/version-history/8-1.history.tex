...
\Item A new tool \Condor{gpu\_discovery} will detect CUDA and OpenCL GPUs and report them
in the format needed to configure GPU resources using the configuration variable
