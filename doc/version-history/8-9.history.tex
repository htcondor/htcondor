...
\item In the configuration files, if \MacroNI{ALLOW\_DAEMON} and
\MacroNI{DENY\_DAEMON} are omitted, \MacroNI{ALLOW\_WRITE} and
...
Also, \MacroNI{ALLOW\_DAEMON} and \MacroNI{DENY\_DAEMON} no longer fall back
to using \MacroNI{ALLOW\_WRITE} and \MacroNI{DENY\_WRITE} when reading
configuration files.
\Ticket{6824}
