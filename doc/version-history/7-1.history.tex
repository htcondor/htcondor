...
\item Added \Macro{MAX\_PENDING\_STARTD\_CONTACTS}.  This limits the
...
\item Added \Macro{SEC\_ENABLE\_MATCH\_PASSWORD\_AUTHENTICATION}.
...
startds on a network with 0.1 second round trip times).  See
