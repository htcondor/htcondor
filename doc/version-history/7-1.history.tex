...
% issue [#1516]
\item If the \AdAttr{IWD} is not defined in a fetched job classified
ad, the \Condor{starter} no longer treats this as a fatal error, and
instead uses the temporary job execution sandbox as the initial
working directory.
