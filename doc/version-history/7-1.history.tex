...
in the context of their profile. This includes the ``My Documents'' directory 
hierarchy (and its monikers) and the user's Registry hive.  To use it add
\SubmitCmd{load\_profile} to your submit file.  Please note that this is 
currently not supported when used in conjunction with 
\SubmitCmd{run\_as\owner}. Please refer to 
