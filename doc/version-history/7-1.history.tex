...
user that the VM is started under.
...
\item The VM universe no longer supports the use of the \SubmitCmd{xm}
...
<<<<<<< HEAD:doc/version-history/7-1.history.tex
...
setuid root. Runnin the \Condor{vm-gahp} as setuid root is no longer
...
\item Condor now supports the ability for the \Condor{master} to run a
  ...
  program.
>>>>>>> Documented the MASTER_SHUTDOWN_<name> and condor_shutdown_master:doc/version-history/7-1.history.tex
...
\item New configuration paramters
