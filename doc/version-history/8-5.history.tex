...
%TEMP -- move this to 8.5.7 when merging!!!!
\item Added the capability for more flexible connections between
splices in DAGs (see TEMPTEMP for more details).  Also added an
INCLUDE command to the DAG language (see TEMPTEMP for more details).
\Ticket{5213}
