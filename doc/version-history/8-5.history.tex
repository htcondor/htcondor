...
\item The ability to send \Condor{drain} commands is now exposed through the python bindings.
\Ticket{5507}

\item A new class - the Submit class - was added to the python bindings. It allows for the submission of HTCondor
jobs via the python bindings using the same keywords and automatic behavior as \Condor{submit}.
\Ticket{5666}
...
\item A new function has been added to the ClassAd language to facilitate the mapping of users to groups
in the \Condor{schedd} and \Condor{job\_router}.
\Ticket{5751}
