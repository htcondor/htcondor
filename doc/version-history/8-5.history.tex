...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{\label{sec:New-8-5-9}Version 8.5.9}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item HTCondor version 8.5.9 not yet released.
%\item HTCondor version 8.5.9 released on Month Date, 2016.
...
%\item HTCondor version 8.5.8 released on Month Date, 2016.
...
can set the BASE\_CGROUP param to the empty string.
\Ticket{5936}

\item Added new param \Macro{DOCKER\_VOLUME\_DIR\_XXX\_MOUNT\_IF} which is an expression,
...
is to set configuration macro \MacroNI{NEGOTIATOR\_CROSS\_SLOT\_PRIOS} to \Expr{True}.
\Ticket{6014}
