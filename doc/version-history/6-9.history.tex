...
\item Added attribute \AdAttr{GridJobStatus} to the classified ads of
grid universe jobs. This string shows the job's status as reported
...
\item The new variable \Macro{WANT\_UDP\_COMMAND\_SOCKET} controls
  ...
  The deault is \Expr{True}, but it is now possible to completely
