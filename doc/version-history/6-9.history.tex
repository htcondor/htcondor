...
a Local/Scheduler universe job will be started. This expression is evaulated
...
expressions evaulated before execution. If the expression evalulates to false, the
