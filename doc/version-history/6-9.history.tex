...
so. This prevents the daemon from needing to temporarily swtich away
...
\item \Condor{glidein} generates a default config file that is missing
the new required procd parameters.  It also sets
\MacroNI{PREEN\_INTERVAL} to an invalid value (0).  To fix this,
remove the setting of \MacroNI{PREEN\_INTERVAL} and add the following
lines:
