...
\item Fixed a bug in the example condor_config.generic and
hawkeye_config files, where COLLECTOR_HOST was being included in the
default STARTD_EXPRS in non-string form, resulting in an invalid value
