...
\item Added support for the \Macro{TRUST\_UID\_DOMAIN} config file
  setting.
...
\item Fixed a series of bugs which were causing the \Condor{collector}
  to seg-fault under some (unusual) circumstances.
