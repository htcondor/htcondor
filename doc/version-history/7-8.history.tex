...
\begin{itemize}
	...
	\item Fixed a problem with Noop jobs, that is jobs submitted with noop\_job = true, would in rare cases cause the schedd to crash.  \Ticket{3156}
...
\item \Condor{startd} crashed if a job failed to match a partitionable
slot after application of \MacroNI{MODIFY\_REQUEST\_EXPR} settings.
\Ticket{3260}
