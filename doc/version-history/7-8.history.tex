...
\item Fixed a bug that can cause the first grid-type cream jobs destined 
for a particular CREAM server to never to be submitted to that server.
This bug was probably introduced in Condor 7.6.5.
\Ticket{3054}
...
\item Fixed a bug that prevented the -f command line option of condor\_history
