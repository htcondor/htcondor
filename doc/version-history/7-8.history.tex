...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{\label{sec:New-7-8-9}Version 7.8.9}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item HTCondor version 7.8.9 not yet released.
%\item HTCondor version 7.8.9 released on Month Date, 2013.
...
\item Fixed a bug that caused the \Condor{master} on Windows to think there were new binaries
when changing to and from daylight savings time.
The master would then kill and restart itself and all of the dameons
if \Macro{MASTER\_NEW\_BINARY\_RESTART} was configured to its default value of GRACEFUL.
\Ticket{3572}
