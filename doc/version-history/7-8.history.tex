...
\item Restored Globus and VOMS support on Mac OS X.
\Ticket{2991}

\item Fixed a bug when running in privsep mode where if a job created a hardlink
from one file to another, condor was unable to transfer the files back to the
submit side, and put the job on hold.
\Ticket{2987}
...
\item (Added in 7.7.6.)  Added the \Arg{-\_condor\_relocatable} argument
