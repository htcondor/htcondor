...
\item HTCondor version 8.4.8 not yet released.
%\item HTCondor version 8.4.8 released on Month Date, 2016.
...
\item Fixed a bug in \Condor{history} that caused it to treat all unrecognised arguments
as user names
\Ticket{5706}
