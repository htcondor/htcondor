...
\item \Condor{history} no longer reports an error when run on a system that does not have a history file.
...
\item Fixed a bug introduced in 8.4.1 that could cause the \Condor{schedd} to exit.
...
platforms such as Arm64.  Bug was reported by Debian maintainers as their Bug 804386.
\Ticket{5380}
