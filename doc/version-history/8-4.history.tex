...
50 to 100, and added config knob \MacroNI{CHIRP\_DELAYED\_UPDATE\_MAX\_ATTRS}.
...
\item Executables on Windows now have the correct appname in their version
resource.  Before this change, all tools had the appname condor\_gpu\_discovery.
\Ticket{5795}
