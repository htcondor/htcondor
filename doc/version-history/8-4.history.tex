...
\item Fixed a bug that would cause the \Condor{shadow} to hang while
trying to delete old shadow logs when the value of \Macro{MAX_NUM_SHADOW_LOG}
was larger than the default value of 1. The bug would also sometimes result in the
\Condor{Schedd} hanging.
\Ticket{5499}
