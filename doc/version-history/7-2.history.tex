...
checkpoint image server will now notice if this situation occurs and emit
a message in the log file explaining to upgrade to the 64-bit version.
...
finished.  If \AdAttr{ParallelShutdownPolicy} was
\AdStr{WAIT\_FOR\_ALL}, the job was prematurely treated as though it
...
\item Occasionally, Condor daemons will, for unknown reasons, bind the
  ...
  with the address of 0.0.0.0 (as in the below example):
\begin{verbatim}
5/6 16:34:26 DaemonCore: Command Socket at <0.0.0.0:53795>
\end{verbatim}
  If you encounter this problem, please send an email as to
