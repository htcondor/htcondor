...
\item Fixed a Windows platform bug in the \Prog{mail.exe} program,
which was causing it to become unresponsive when run.  If left running, the
application also increased its memory consumption.
