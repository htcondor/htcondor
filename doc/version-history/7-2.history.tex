...
% PR 964
\item Added \Opt{-version} and \Opt{-help} flags to \Condor{submit\_dag}.
...
\item Environment variable names are now properly treated as case-insensitive
on Windows. The most common symptom of this bug was the inability to specify
a custom PATH setting for a job from its submit file.
