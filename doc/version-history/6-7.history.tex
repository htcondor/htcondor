...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\label{sec:New-6-7-6}Version 6.7.7}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item Added initial support for the \Syscall{getdents},
	...
	There are two caveats: these calls will not work in heterogenous
...
\item \condor{q} -globus now works properly for GT4 jobs. Also, the resouce
...
\item Added support for libc's \Syscall(system) function for standard
	...
	heterogenous submission contexts of the user is not careful.
