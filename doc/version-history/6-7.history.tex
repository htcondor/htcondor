...
\item Added \Arg{-direct} to the usage message for \Condor{q} and reworded
some entries for clarity.
...
\Condor{master}.  This feature is currently used only for
\Condor{HAD}.  To properly use the HAD feature for the
\Condor{negotiator} daemon, you must now add an entry to your
condor\_config:
...
``controller'' of \Condor{negotiator}.
...
further reduce load on NIS servers.  See section~\ref{param:PasswdCacheRefresh} on
