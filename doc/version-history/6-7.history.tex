...
\item The \SubmitCmd{globus} universe and the follow submit commands
are now deprecated: \SubmitCmd{globusscheduler}, \SubmitCmd{grid\_type},
...
The \SubmitCmd{grid} universe and \SubmitCmd{grid\_resource} submit
...
heirarchy. A client with DAEMON or ADMINISTRATOR access also have WRITE
