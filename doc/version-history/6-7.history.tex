...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{\label{sec:New-6-7-21}Version 6.7.21}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%  Karen's note:  this 6.7.21 section appears for now, but
%%  presumably will become the 6.8.0 version history.
%%  To make that transition easier, please place a comment with EVERY
%%  added item to identify if the item is intended for 6.8.0.  Thanks.
...
% Gnats PR 661
\item Added the \MacroNI{DAGMAN\_BOOTSTRAP\_ALLOW\_EVENTS} configuration
macro to accomodate the case where a schedd crash causes a job to be
re-run after a termination event for that job is written to the log.
