...
\item Fixed a bug in Condor's file transfer mechanism that showed up
  ...
  submit host.
  Now, if either \Attr{stream_output} or \Attr{stream_error} are set
  to true, Condor will transfer any other output but will not attempt
  to transfer back STDOUT or STDERR.
