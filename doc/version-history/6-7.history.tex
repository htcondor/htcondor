...
\item Grid universe jobs can now determine their grid-type via
match-making, in addition to which resource they'll be submitted to. Thus,
you can submit a grid universe job that may become a gt2, gt4, or condor
grid-type job, depending on what resource ad it's matched with.
...
\URL{http://prdownloads.sourceforge.net/condor-ext/condor_drmaa_6_7_14_src.tgz}
