...
per job is reduced.  For sites that have been using the undocumented
\Macro{SIGNIFICANT\_ATTRIBUTES} setting in the config file, we suggest
removing that setting, as Condor will now pick an optimal value
for \Macro{SIGNIFICANT\_ATTRIBUTES} automatically if it is not
