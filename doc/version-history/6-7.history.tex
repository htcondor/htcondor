...
\item Fixed a rare bug where after a job has been marked terminated,
it could be run again and another execute event could happen after the
terminate event.  This fix is applicable to the vanilla, standard,
parallel, mpi, and java universes.
