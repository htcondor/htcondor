...
\item DaemonCore has been enhanced to detect the difference between
network failures and authorization failures;
it previously identified authorization failures as network failures.
With the enhancement,
a detected authorization failure is placed on the error stack before
sending the response ClassAd.
When the error message is printed,
it identifies who the user was mapped to and the authentication method.
\Ticket{4751}
