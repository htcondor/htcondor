...
\item Attributes in the scheduler ad written by the \Condor{schedd} that
count the number of jobs in various states now include all jobs, not just
jobs that need to be matched by the negotiator.
