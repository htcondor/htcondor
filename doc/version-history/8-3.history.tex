...
\item The synchronization of the job log was improved by only
using fsync where necessary and fdatasync where sufficient.  This should
provide a small reduction in disk IO on the schedd.
\Ticket{4283}
