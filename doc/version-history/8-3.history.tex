...
\item The configuration parameter \Macro{MAX\_JOBS\_RUNNING} has been
modified that that it only applies to job universes that require a
...
with the paramters \Macro{START\_SCHEDULER\_UNIVERSE} and
\Macro{START\_LOCAL\_UNIVERSE}, respectively.
\Ticket{4589}
