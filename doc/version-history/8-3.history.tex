...
\item Fixed a bug where Condor would not correctly set the KeyboardIdle
attribute on keyboards connected to psuedo terminals.
\Ticket{5217}

\item Docker universe jobs had a bug where it would insert
carriage returns and newlines at the end of every line in
stdout and stderr.  This has been fixed.
\Ticket{5212}
