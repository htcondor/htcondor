...
\item Fixed bug whereby tuning configuration variable 
\Macro{MAX\_ACCEPTS\_PER\_CYCLE} is ignored when \Condor{shared\_port} is used,
potentially causing significant delays when issuing new commands to 
heavily loaded HTCondor schedds.
\Ticket{5146}
