...
if the default location for configuration variable
\Macro{DAEMON\_SOCKET\_DIR} (\Expr{\$(LOCK)/daemon\_sock}) is longer
than 90 characters in length.
On Linux, abstract sockets are now the primary method for
...
This reduces memory usage when GSI authentication isn't used.
