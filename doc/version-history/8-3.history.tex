...
\item The \Macro{SCHEDD\_INTERVAL\_TIMESLICE}, which controls various housekeeping
events in the \Condor{schedd} now defaults to 1\% (previously 5\%).  By default,
housekeeping will now take up a maximum of 1\% of the \Condor{schedd}'s runtime.
\Ticket{4484}
