...
\Ticket{4933}
  ...
  \item Condor{submit} now supports submit attribute assigments on the command line
\Ticket{4983}

  \item Condor{submit} will accept if and include statements in the same way
  that configuration files do.
\Ticket{4913}
