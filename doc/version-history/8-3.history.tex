...
\item Revamped the Python ClassAd parsing methods to be able to parse
in either the "Old" or "New" ClassAd format.
The Python ClassAd parsing methods can automatically detect
...
\item Added \Condor{credd}, \Condor{set\_shutdown}, the \Condor{set\_shutdown}
manual page, and \Condor{vm-gahp-vmare} to the Red Hat Enterprise Linux 6 and 7
RPM packages.
These files were inadvertently omitted from the new style RPM packages.
\Ticket{5098}
