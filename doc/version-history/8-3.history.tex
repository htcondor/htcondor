...
and for protecting a busy schedd from overly-lengthy interruptions to
accept a very large number of jobs at once.
\Ticket{5081}

\item Add configuration setting, \MacroNI{MAX\_JOBS\_PER\_OWNER},
to limit the number of jobs submitted (total in the queue) for each owner
(submitting user).
\Ticket{4641}
