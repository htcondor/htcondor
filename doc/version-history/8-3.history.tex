...
\item Various synax errors on SPLICE lines in a DAG (e.g., appending
NOOP or DONE) are now reported as fatal errors, rather than being
silently ignored.
\Ticket{2722} \Ticket{4825}

\item Changed the default values for \MacroNI{DAGMAN\_MAX\_PRE\_SCRIPTS}
and \MacroNI{DAGMAN\_MAX\_POST\_SCRIPTS} from 0 (unlimited) to 20.
\Ticket{4999}
