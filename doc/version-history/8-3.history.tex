...
are now evaluated against the Job ClassAd rather than being treated as constants.
\Ticket{5002}
\Ticket{5004}
...
\item When \Condor{gpu\_discovery} is passed the \Opt{config} option it now returns the number
of GPUs detected as well as the other attributes in configuration syntax.
This makes it more convenient to use as part of a configuration script.
\Ticket{5040}
