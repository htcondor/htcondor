...
\item Improved writing to the user job log and the event log.
Disabling locking when writing to these files
(controlled by configuration parameters \Macro{ENABLE\_USERLOG\_LOCKING}
...
\item Place holder for a description of this bug fix.
\Ticket{4919}
