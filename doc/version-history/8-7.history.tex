...
To get the old totals display set the configuration parameter \Macro{CONDOR\_Q\_SHOW\_OLD\_SUMMARY} to true.
\Ticket{6254}

\item Added a parameter \Macro{DEDICATED\_SCHEDULER\_USE\_SERIAL\_CLAIMS} which 
...
\Macro{SUBMIT\_SKIP\_FILECHECKS} is set to false.  The default is now true.
\Ticket{6220}
...
\item Added configuration paramater \MacroNI{ALTERNATE\_JOB\_SPOOL},
...
resulted in \Condor{q} displaying incorrect totals when \Macro{CONDOR\_Q\_SHOW\_OLD\_SUMMARY}
was set to false.
\Ticket{6272}
