...
\item Added configuration parameters \MacroNI{GAHP\_SS​L\_CADIR} and
\MacroNI{GAHP\_SS​L\_CAFILE} to specify trusted CAs when authenticating
EC2 and GCE servers.
This used by be controlled by \MacroNI{SOAP\_SS​L\_CA\_DIR} and
\MacroNI{SOAP\_SS​L\_CAFILE}, which have been removed.
\Ticket{6684}
