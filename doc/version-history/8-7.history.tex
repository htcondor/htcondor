...
%\item HTCondor version 8.7.4 released on Month Date, 2017.
...
result in any user visible changes at runtime.  The StarterLog will
...
\item We now produce runtime statistics in \Condor{dagman}, tracking how 
...
as if they were the result of a lookup rather than the names of configuration variables
to look up.
\Ticket{6416}

\item Remove CE requiremts for the BLAHP can now be expressed in a simple form
