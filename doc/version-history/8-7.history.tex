...
\item If HTCondor is started with \MacroNI{CUDA\_VISIBLE\_DEVICES} set
in the environment, it will report on those devices with the specified
indices, instead of the indices of that subset.
\Ticket{6584}
