...
\item The performance for claiming a paritonable slot in a startd is greatly
improved.  This feature is implemented in both the schedd and startd, so 
both sides must be updated to at least 7.7.5 to see the benefit.  To disable
this feature, the paramater CLAIM\_PARTIONABLE\_LEFTOVERS can be set to
false on either the submit or execute machines.  The default value for
