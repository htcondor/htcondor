...
\item \Condor{schedd} now logs a more informative error message
when it rejects job ad updates from \Condor{shadow} due to
...
\item Since 7.7.2, there was a rare condition that could cause
a job to be removed from the queue if it was put on hold while
it was running.  In such cases, there was also a spurious
