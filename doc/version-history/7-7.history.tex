...
changes to the original DAG file take effect when running a rescue DAG.
\Ticket{2165}
...
DAG file, as a rescue DAG.  See section~\ref{param:DAGManWritePartialRescue}
for details.  Also, the previously-existing configuration variable
\MacroNI{DAGMAN\_OLD\_RESCUE} has been removed, because it is incompatible
with the new partial rescue DAGs.
\Ticket{2165}
