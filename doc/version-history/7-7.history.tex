...
can contain an expression which is passed from the \Condor{negotiator}
to the \Condor{collector},
 when it fetches ClassAds for the negotiation cycle. 
\Ticket{2277}

\item The new configuration variable 
\Macro{NEGOTIATOR\_SLOT\_POOLSIZE\_CONSTRAINT} 
replaces \Macro{GROUP\_DYNAMIC\_MACH\_CONSTRAINT},
which has been retained as a alternate name.  
...
was made obsolete by \Macro{NEGOTIATOR\_SLOT\_CONSTRAINT},
so \MacroNI{NEGOTIATOR\_STARTD\_CONSTRAINT\_REMOVE}  has been removed.
\Ticket{2277}
