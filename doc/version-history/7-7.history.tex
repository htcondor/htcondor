...
\item \Condor{q} \Opt{-run} now displays a job's EC2VirtualMachineName
...
\item Lines like ``ProcAPI sanity failure on pid 1317, age = -1901476270''
should no longer appear in the \Condor{master} daemon log on Mac OS X.
\Ticket{2594}
