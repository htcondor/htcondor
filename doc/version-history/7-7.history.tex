...
have the form \Macro{SCHEDD\_COLLECT\_STATS\_FOR\_XXXX} and should contain
a ClassAd expression.
XXXX will be prefixed to the names of attributes in the \Condor{schedd} ad
such as \Attr{XXXXJobsStarted} which would be the count of jobs that have
started that satisfy the expression.
\Ticket{2862}
