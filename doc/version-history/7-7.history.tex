...
\item Made keep\_claim\_idle a real submit description
file command.
\Ticket{2094}
...
\item Advertised new attributes \Attr{RemoteGroup}, \Attr{RemoteNegotiatingGroup},
\Attr{RemoteAutoregroup} and their Submitter counterparts to support enhanced
preemption policies with accounting group awareness.
\Ticket{2885}
