...
\item Condor version 7.7.4 has all of the features and fixes of Condor 7.7.3,
with one major addition.  This is the ability to run in a pure ipv6 network.
This is disabled by default.  To enable this code, set the config file 
parameter ENABLE\_IPV6 to true.  Note that running in a mixed ipv6 and ipv4
environment has not been tested, and is not supported.
