...
\item New a new configuration variable \Macro{MUST\_MODIFY\_REQUEST\_EXPRS} for the \Condor{startd}.
If false, then \Macro{MODIFY\_REQUEST\_EXPRs} are only applied if the job claim still matches the partitionable
