...
\item Fixed a rare bug where the Condor CGahp process could get
into an infinite loop on startup if more than one was running from
different users whose name only differed in the last character.
\Ticket{2749}
