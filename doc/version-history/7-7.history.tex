...
items in reverse chronological order.  Added -forwards flag
to enable the old behavior to print out historical jobs in
forwards chronological order.
...
\Macro{NEGOTIATOR\_READ\_CONFIG\_BEFORE\_CYCLE}, which causes the
...
\item Fixed path to sftp\_server on Mac OS X and Debian.
\Ticket{2789}
