...
\item The new \Condor{gangliad} can publish metrics from daemon ClassAds 
...
\item If you reference attribute \AdAttr{SubmittorUserPrio} in your
	configuration, such as in your \MacroNI{preemption\_requirements} 
	expression, you will need to change it to \AdAttr{SubmitterUserPrio} 
