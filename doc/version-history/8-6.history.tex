...
\item \Condor{chirip} will now no longer abort when given a command that it cannot execute
successfully execute, such as fetching from a file that does not exist.
\Ticket{6402}
