...
\Macro{NEGOTIATOR\_ALLOW\_QUOTA\_OVERSUBSCRIPTION} is true (the default)
\Ticket{6514}
...
not being deleted when the \Condor{schedd} relinquished its claim on the slot before the
