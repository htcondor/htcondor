...
with a root user id, but without CAP\_SYSADMIN.
\Ticket{6603}
...
\item Fixed a bug where the configuration paramter \Macro{STARTD\_RECOMPUTE\_DISK\_FREE} was
...
accounting ads when configuration paramter
