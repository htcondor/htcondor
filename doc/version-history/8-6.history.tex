...
While \Macro{use ROLE : Execute, CentralManager} would correctly add both roles.
\Ticket{6171}
...
\Prog{bosco\_quickstart} no longer assumes that submitting to a SLURM
...
\item Fixed a bug which in some obscure but possible configurations a spurious
