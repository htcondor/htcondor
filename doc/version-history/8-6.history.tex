...
\item HTCondor version 8.6.5 not yet released.
%\item HTCondor version 8.6.5 released on Month Date, 2017.
...
\item Add avx2 to the set of processor flags advertise by the \Condor{startd}.
\Ticket{6317}
...
may have been particularly noticeable in the collector.
\Ticket{6342}

\item Fixed a bug that caused an infinite loop in the starter when
cgroups were enabled on systems like Debian where the kernel has disabled
