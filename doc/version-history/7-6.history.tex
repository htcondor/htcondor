...
\item Updated the \Condor{negotiator} daemon's assessment of pool size to properly
take partitionable slots into account.
\Ticket{2440}
...
\item \Condor{preen} failed to honor the \Opt{-remove} option
and would always remove lock files.
\Ticket{2497}
