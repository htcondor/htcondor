...
\item Condor version 7.6.1 not yet released.
...
% gittrac #2069
\item In Condor 7.6.0, the \Condor{schedd} would create a spool directory
for every job. The previous behavior has now been restored (create a spool
directory only when needed).

%gittrac #2086
\item Fixed a bug introduced in 7.5.2 that caused the \Condor{negotiator}
daemon to crash if any machine ads contained circular attribute references.
