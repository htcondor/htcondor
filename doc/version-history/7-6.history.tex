...
\item Restored the semantics of \Macro{GROUP\_AUTOREGROUP} to its pre-HGQ
mode: submitters with no accounting group (group ``<none>'') negotiate last
and any accounting groups with autoregroup enabled also negotiate with
the group-less submitters.
\Ticket{2679}
