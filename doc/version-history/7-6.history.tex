...
\item Fixed a bug where Condor would fail to properly detect that it was running
as Local System for non-english versions of Windows.  This would Condor to fail
to run jobs on the slot accounts.
\Ticket{2642}
