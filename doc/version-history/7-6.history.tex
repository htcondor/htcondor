...
would alternate between states GM\_REGISTER and GM\_RESTART (visible in
the gridmanger daemon log).
\Ticket{2916}

\item Added logic to the \Condor{negotiator} that enables job \Term{preemption} 
to properly respect \Term{group quotas}.
\Ticket{2570}
...
\item Condor failed to execute jobs when using glexec 0.9.0 through 0.9.5.
\Ticket{2907}
