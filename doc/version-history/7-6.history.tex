...
\item Condor version 7.6.2 not yet released.
%\item Condor version 7.6.2 released on Month Date, 2011.
...
(missing node name or submit file in JOB lines).  Also, \Condor{dagman}
now prints DAG file lines as they are parsed if the debug verbosity
setting (\Condor{submit\_dag} \Arg{-debug}) is 6 or above.
