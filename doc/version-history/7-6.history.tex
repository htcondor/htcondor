...
\item Fix sample Linux startup script \File{condor.boot.rpm} to no longer
assume that the contents of \File{/var/run} will persist across a reboot
or that environment variable \Macro{USER} is set.
\Ticket{2133}
