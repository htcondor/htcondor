...
\item Fixed a minor bug if \Macro{JOB\_START\_DELAY} was set to 0 that
   would prevent the \Condor{schedd} from correctly cleaning up during
   graceful shutdown (\verb@SIGTERM@, or \Condor{off}).
