...
\item Added a new configuration variable,
      ...
      \Condor{submit} before giving up.  It cannot be set to less than
      1 attempt, or more than 10; if left undefined, it defaults to 6.
...
\item Fixed bugs in DAGMan parsing of submit files (to determine
  ...
  DAGMan would incorrectly use the first definition, rather than
  the last.
