...
\item Fixed the faulty argument parsing in condor_rm, condor_release,
  and condor_hold. Before you could accidentally type ``condor_rm
  -analyze'', and it would remove all of your jobs. Now it gives an
  error.

\item One Windows, when you type a command like
