...
% this bug was fixed by kent but not in time for 6.6.5, so i'm just
% commenting it out of the version history for now.  we can uncomment
% this blurb and stick it in the 6.6.6 version history... 
%\item Fixed an error in the \Condor{dagman} submit file parsing code:
