...
\item The default set of metrics published by the condor\_gangliad has been
reduced to the essential Scheduler and Negotiator metrics.
Also, the unit for accumulated times has changed from seconds to hours.
\Ticket{4299}
