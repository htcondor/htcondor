...
\item Fixed a usability problem with EC2 jobs: HTCondor now ignores
trailing whitespace in the \SubmitCmdNI{ec2\_access\_key\_id}
and \SubmitCmdNI{ec2\_secret\_access\_key} files.
\Ticket{4791}
