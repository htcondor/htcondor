...
\item Changed the default value of \Macro{CONDOR\_Q\_USE\_V3\_PROTOCOL}
from true to false.  This works around slowness running condor\_q with this protocol
when querying schedulers with large numbers of jobs in them.  Also raised
the default value of \Macro{SCHEDD\_QUERY\_WORKERS} from 3 to 8.
\Ticket{4696}
