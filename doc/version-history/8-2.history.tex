...
\item Streamlined the network protocol used by \condor{submit}, resulting
	in faster job submission times and less \condor{schedd} overhead, 
	especially when performing a submit to a remote schedd.
\Ticket{3846}
