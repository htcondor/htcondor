...
\item Fixed bugs prohibiting start RANK from preemption dynamic slots.
\Ticket{4580}
...
\item Fixed a bug that caused \Condor{dagman} to core dump if
\Macro{DAGMAN\_ALWAYS\_USE\_NODE\_LOG} is set to \Expr{False} and
\Macro{DAGMAN\_USE\_STRICT} is set to 1 or higher.
\Ticket{4600}
