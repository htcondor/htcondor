...
% & - RedHat Enterprise Linux 4, with \File{compat-glibc} and \File{compat-glibc-headers} packages \\
 & - Debian Linux 3.1 (sarge) \\
 & - Fedora Core 1, 2, 3, 4 \\
% & - Fedora Core 2, 3, with \File{compat-glibc} and \File{compat-glibc-headers} packages \\
% & - Fedora Core 4, with \File{compat-gcc-32-3.2.3} and \File{compat-gcc-32-c++-3.2.3}  and \File{compat-gcc-32-g77-3.2.3} and \File{compat-libgcc-296-2.96} and \File{compat-libstdc++-296-2.96} and \File{compat-libstdc++-33-3.2.3} and \File{compat-libf2c-32-3.2.3} packages \\
...
\hline
Fedora Core 1, 2, 3, 4 on x86 & gcc, g++, and g77 & as shipped  \\ 
\hline
