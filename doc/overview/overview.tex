...
\section{High-Throughput Computing (HTC) and its Requirements}
...
Silicon Graphics MIPS (R4400, R4600, R8000, R10000) & IRIX 6.2, 6.3, 6.4 \\ 
 & IRIX 6.5 \\ \hline
Intel x86 & RedHat Linux 5.2, 6.x \\
...
In addition, there is an e-mail list at \Email{condor-world@cs.wisc.edu}.  The Condor Team 
