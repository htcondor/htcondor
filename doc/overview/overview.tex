%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{High-Throughput Computing (HTC) and its Requirements}\label{sec:overview}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{HTCondor's Power}\label{sec:what-is-condor}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
because commercial packages rarely make their source and/or object code
available. 
...
x86\_64 & - Red Hat Enterprise Linux 6 \\ 
 ...
 & - Debian Linux 9.0 (stretch) (clipped) \\ \hline 
 & - Macintosh OS X 10.10 through 10.13 (clipped) \\ \hline
 & - Ubuntu 14.04; Trusty Tahr \\ \hline 
 & - Ubuntu 16.04; Xenial Xerus (clipped) \\ \hline
 & - Ubuntu 18.04; Bionic Beaver (clipped) \\ \hline
\end{tabular}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Contact Information}\label{contact-info}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
