...
The Condor source code is not currently available for public download.
If you desire the Condor source code,
please contact the Condor Team in order to discuss it further 
...
PowerPC & - Macintosh OS X 10.3 (clipped) \\
 & - AIX 5.2, 5.3 (clipped) \\
 & - Yellowdog Linux 3.0, 5.0 (clipped) \\
...
PowerPC with Yellowdog Linux 3.0, 5.0 & Yes \\ \hline
Itanium with Red Hat Enterprise Linux 3 & Yes \\
Itanium with SuSE Linux Enterprise 8.1, 9 & Yes \\ \hline
