...
Sun SPARC Sun4m, Sun4c, Sun UltraSPARC & - Solaris 9 (clipped) \\
...
PowerPC & - Macintosh OS X 10.4 (clipped) \\
 & - AIX 5.2, 5.3 (clipped) (Using the AIX 5.2 binaries) \\
...
Condor is also available, but is not currently distributed as
tested binaries for the platforms shown in 
Table~\ref{other-platforms}.

\begin{center}
\begin{table}[hbt]
\begin{tabular}{|p{6cm}p{10cm}|} \hline
\emph{Platform} & \emph{Notes} \\ \hline \hline
FreeBSD 6, 7 (clipped) on Intel x86 
 &  Known to compile \\ \hline
FreeBSD 7 (clipped) on Itanium IA64
 & Known to compile \\ \hline
\end{tabular}
\caption{\label{other-platforms}Other Condor \VersionNotice\ available platforms}
\end{table}
\end{center}
...
\hline
Red Hat Debian Linux 5.0 (lenny) on x86 and x86\_64 & gcc, g++, gfortran as shipped &  \\ 
\hline
...
Sun SPARC Sun4m,Sun4c, Sun UltraSPARC with Solaris 9 & Yes \\ \hline
Intel x86 with Red Hat Enterprise Linux 3, 4, 5, Debian Linux 4.0, 5.0 & Yes \\ 
Intel x86 with Fedora Core 1 - 11 & Yes \\
...
Opteron x86\_64 with Red Hat Enterprise Linux 3, 4, 5, Debian Linux 5.0  & Yes \\ \hline
\end{tabular}
