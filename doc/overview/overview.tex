...
\index{HPUX!limitations}
and Digital Unix
(OSF/1),
\index{OSF/1!limitations}
...
\index{UNIX system call!fork(2)}
exec(2),
\index{UNIX system call!exec(2)}
system(3)
\index{UNIX system call!system(3)}
...
\index{UNIX system call!setitimer(2)}
and
alarm(2))
\index{UNIX system call!alarm(2)}
