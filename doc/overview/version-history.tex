...
\item Solaris 2.8 SPARC has been added to the list of ports that now
support remote system calls and checkpointing.
...
\item Fixed a bug in \Condor{q} where issuging a \Opt{-global} with a
