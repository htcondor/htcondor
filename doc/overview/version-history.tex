...
arguments into a seperate config setting, \Macro{PREEN\_ARGS}.}
...
message.
In addition, the SMP startd module now includes the \Condor{vacate}
and \Condor{checkpoint} tools, since they have been enhanced in 6.1.X
to support SMP-specific functionality.  
...
visable with \Condor{status}, instead of having to wait 15 minutes for
...
causing it to be case-sensitve when parsing the Condor submit file.
