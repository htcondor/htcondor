...
This includes support for RedHat 6.0, Debian 2.1 and other popular
Linux distributions.
Whereas the Linux machines had once been fragmented across libc5 and
glibc, they have now been reunified.
...
\item Fixed a bug where we couldn't ever open more than \_POSIX\_PATH\_MAX
file descriptors in our OpenFileTable implementation. \_POSIX\_PATH\_MAX
was not the right constant that should have been used in that context.
