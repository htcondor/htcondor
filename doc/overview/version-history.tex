...
\item Fixed a bug in the \condor{startd} which could cause a cycle of
continuous job suspends and job resumes.
...
This information can be viewed and queried with the \Condor{view}
tool, which is available as a seperate contrib module.
