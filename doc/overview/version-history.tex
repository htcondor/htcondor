...
\item DAGMan produces confusing failure output if any of the submit files
given to it contain multiple \texttt{queue} statements or a
\texttt{queue} statement that queues more than one instance of the
job.
