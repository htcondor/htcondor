...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:New-6-1-8}Version 6.1.9}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{itemize}

\item Added \OptArg{-r}{minutes}} option to daemonCore to have the
daemon gracefully shut down after <minutes> minutes.

\item Added full support for Linux 2.0.x and 2.2.x kernels using libc5,
glibc20 and glibc21. Whereas the linux machines had once been fragmented
across libc5 and glibc, they have been reunified again. Part of this
reunification process was the removal of shared library support from
Linux. Also, please use \Condor{compile} on the same machine on which
you compiled your object files.

\item Fixed a bug in \Condor{shadow} that would send incorrect job
completion mail under Linux.
...
the structure statfs.

\item Fixed a bug in the remote system call of fchdir(2) that caused
