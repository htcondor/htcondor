...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:New-6-1-15}Version 6.1.15}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
jobs.
And, a problem which caused \func{pvm\_exit() to hang was diagnosed:
PVM tasks which call \func{pvm\_catchout()} to catch the output of
child tasks should be sure to call it again with a NULL argument to
disable output collection before calling \func{pvm\_exit()}.
...
Now, the shadow will always log an execute event before it logs any
other events.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:New-6-1-14}Version 6.1.14}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
``PERIODIC\_CHECPOINT'' (note the spelling mistake) to the attributes 
