...
Boolean taken from the submit description file command
\SubmitCmd{encrypt\_execute\_directory}. Specifies if HTCondor
should encrypt the remote scratch directory on the machine where
the job executes.
