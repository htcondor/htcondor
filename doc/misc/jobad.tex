...
post command using the Old argument syntax. If both \AdAttr{PostArgs}
...
post command using the New argument syntax, excepting that double quotes must
...
pre command using the Old argument syntax. If both \AdAttr{PreArgs}
...
pre command using the New argument syntax, excepting that double quotes must
