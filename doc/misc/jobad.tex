...
\item[\AdAttr{EmailAttributes}:]  String containing a comma-separated
list of job ad attributes. The attribute names and values will be
included in the email notification of job completion.
