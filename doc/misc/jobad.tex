...
String containing a comma-separated list of actions that can be
performed on a Deltacloud instance as given by the service.
...
String taken from the submit description file command
\SubmitCmd{deltacloud\_hardware\_profile\_memory}. Specifies memory
details in the hardware configuration to be used for a grid-type
deltacloud job.
...
String taken from the submit description file command
\SubmitCmd{deltacloud\_hardware\_profile\_storage}. Specifies memory
details in the hardware configuration to be used for a grid-type
deltacloud job.
...
Specifies the SSH keypair to use for a grid-type deltacloud job.
...
String providing a comma-separated list of private IP addresses
allocated to a running Deltacloud instance.
...
String providing a comma-separated list of public IP addresses
allocated to a running Deltacloud instance.
...
Specifies the username to be used to authenticate
with the Deltacloud service for a grid-type deltacloud job.
