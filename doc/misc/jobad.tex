...
In the case of \AdAttr{RemoteWallClockTime}, 
one can disregard suspended time by
subtracting out \AdAttr{CumulativeSuspensionTime}.
However, no analogous attribute representing committed suspension time exists,
...
For this case, the expression causes the job to be kept in the queue
