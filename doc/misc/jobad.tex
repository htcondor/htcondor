...
Each item in the list may be a string identifying the resource,
or it may be a ClassAd expression that evaluates to a string,
evaluated in the context of a machine ClassAd match. 
...
%%% ClassAd attribute: EC2AccessKey
\index{ClassAd job attribute!EC2AccessKey}
\index{EC2AccessKey!job ClassAd attribute}
...
file command \SubmitCmd{ec2\_access\_key\_id}.
