...
the slot1 ad of a multi-slot machine will have \AdAttr{slot<X>\_MachineLastMatchTime}
where \MacroNI{X} is replaced by the slot id of each of the slots
...
a hibernating machine should be woken up (e.g. by \Condor{rooster}).
