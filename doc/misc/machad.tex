...
\item[\AdAttr{RemoteAutoregroup}:]  Boolean attribute is \Expr{True} if
this resource was claimed via negotiation under autoregroup, \Expr{False}
otherwise.
...
frequently be the same as \AdAttr{RemoteGroup}, but may differ in cases such
as negotiation under autoregroup, in which case it will have the name of the
root group ``<none>''.
