...
definitions:
	...
	\item[\AdStr{SOLARIS5.10}:] for Solaris 2.11 or 5.11
...
String definitions for Linux operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{RedHat6}:] for RedHat Linux version 6
	\item[\AdStr{Fedora16}:] for Fedora Linux version 16
	\end{description}
String definitions for MacOS operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{MacOSX605}:] for MacOS version 10.6.5 (Snow Leopard)
	\item[\AdStr{MacOSX703}:] for MacOS version 10.7.3 (Lion)
	\end{description}
String definitions for BSD operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{FREEBSD7}:] for FreeBSD version 7
	\item[\AdStr{FREEBSD8}:] for FreeBSD version 8
	\end{description}
String definitions for Unix operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{SOLARIS5.10}:] for Solaris 2.10 or 5.10
	\item[\AdStr{SOLARIS5.11}:] for Solaris 2.11 or 5.11
	\end{description}
String definitions for Windows operating systems have the following values:
	\begin{description}
	\item[\AdStr{WINNT500}:] for Windows 2000
	\item[\AdStr{WINNT501}:] for Windows XP
	\item[\AdStr{WINNT502}:] for Windows Server 2003
	\item[\AdStr{WINNT600}:] for Windows Vista
	\item[\AdStr{WINNT601}:] for Windows 7
	\end{description}
%
...
definitions:
	\begin{description}
	\item[\AdStr{LINUX}:] for LINUX 2.0.x, LINUX 2.2.x, LINUX 2.4.x, or LINUX 2.6.x kernel systems
	\item[\AdStr{OSX}:] for Darwin
	\item[\AdStr{FREEBSD7}:] for FreeBSD version 7
	\item[\AdStr{FREEBSD8}:] for FreeBSD version 8
	\item[\AdStr{SOLARIS5.10}:] for Solaris 2.10 or 5.10
...
String definitions for Linux operating systems have the following values:
	\begin{description}
...
Integer definitions for Linux operating systems have the following values:
	\begin{description}
	\item[\AdStr{6}:] for RedHat Linux version 6
	\item[\AdStr{16}:] for Fedora Linux version 16
	\end{description}
Integer definitions for MacOS operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{6}:] for MacOS version 10.6.5 (Snow Leopard)
	\item[\AdStr{7}:] for MacOS version 10.7.3 (Lion)
	\end{description}
Integer definitions for BSD operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{7}:] for FreeBSD version 7
	\item[\AdStr{8}:] for FreeBSD version 8
	\end{description}
Integer definitions for Unix operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{5}:] for Solaris 2.10 or 5.10
	\item[\AdStr{5}:] for Solaris 2.11 or 5.11
	\end{description}
Integer definitions for Windows operating systems have the following values:
	\begin{description}
	\item[\AdStr{501}:] for Windows XP
	\item[\AdStr{600}:] for Windows Vista
	\item[\AdStr{601}:] for Windows 7
	\end{description}
%
...
String definitions for BSD operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{FREEBSD}:] for FreeBSD version 7
	\item[\AdStr{FREEBSD}:] for FreeBSD version 8
	\end{description}
String definitions for Unix operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{SOLARIS5.10}:] for Solaris 2.11 or 5.11
...
String definitions for Linux operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{Linux}:] for RedHat Linux version 6
	\item[\AdStr{Linux}:] for Fedora Linux version 16
	\end{description}
String definitions for MacOS operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{MacOSX}:] for MacOS version 10.6.5 (Snow Leopard)
	\item[\AdStr{MacOSX}:] for MacOS version 10.7.3 (Lion)
	\end{description}
String definitions for BSD operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{FreeBSD}:] for FreeBSD version 7
...
version number.
Integer definitions for Linux operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{602}:] for RedHat Linux version 6.2
	\item[\AdStr{1600}:] for Fedora Linux version 16.0
	\end{description}
Integer definitions for Unix/BSD operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{704}:] for FreeBSD version 7.4
	\item[\AdStr{802}:] for FreeBSD version 8.2
	\end{description}
Integer definitions for MacOS operating systems use the following patterns:
	\begin{description}
	\item[\AdStr{605}:] for MacOS version 10.6.5 (Snow Leopard)
	\item[\AdStr{703}:] for MacOS version 10.7.3 (Lion)
	\end{description}
Integer definitions for Windows operating systems have the following values:
	\begin{description}
