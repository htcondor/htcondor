...
definitions:
	...
	LINUX 2.4.x, LINUX 2.6.x, or LINUX 3.10.0 kernel systems, as well as Scientific Linux, 
        Ubuntu versions 12.04 and 14.04, and Debian 8.0 (jessie)
...
definitions:
	\begin{description}
	\item[\AdStr{LINUX}:] for LINUX 2.0.x, LINUX 2.2.x, LINUX 2.4.x, LINUX 2.6.x, or LINUX 3.10.0 kernel systems, as well as Scientific Linux, Ubuntu 
versions 12.04 and 14.04, and Debian 8
	\item[\AdStr{OSX}:] for Darwin
	\item[\AdStr{FREEBSD7}:] for FreeBSD version 7
	\item[\AdStr{FREEBSD8}:] for FreeBSD version 8
	\item[\AdStr{SOLARIS5.10}:] for Solaris 2.10 or 5.10
...
\item[\AdAttr{OpSysName}:] A string containing a terse description of the operating system.
	...
	\item[\AdStr{Ubuntu}:] for Ubuntu versions 12.04 and 14.04
	\item[\AdStr{Debian}:] for Debian version 8
...
the operating system.
	...
	\item[\AdStr{Fedora}:] for Fedora Linux version 16
	\item[\AdStr{Debian}:] for Debian Linux version 5 or 6 or 8
	\item[\AdStr{Ubuntu}:] for Ubuntu versions 12.04 and 14.04
