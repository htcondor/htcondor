...
(\File{condor\_syscall\_lib.a}), using the
\Condor{compile} command.  This means that the
...
\File{libckpt.a}, which provides checkpointing for Unix processes
...
functionality is provided in the \File{condor\_syscall\_zlib.a} and
\File{libzckpt.a} libraries.  If \File{/usr/lib/libz.a} exists on your
workstation, \Condor{compile} will automatically link your job with
...
To link in standalone mode, use the \Condor{compile}
...
\File{libckpt.a}, your program will require two new command line
