...
If some machines in your pool have this hook, and others don't,
you'll probably want to advertise that fact.  Add this to the
execute side configuration file on machines that have the hook.

\begin{verbatim}

HasJava5PrepareHook = true
STARTD_EXPRS = HasJava5PrepareHook
