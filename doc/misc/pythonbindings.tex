...
Description here.
\\ \hline
\texttt{\_\_delitem\_\_( )}

Description here.
\\ \hline
\texttt{setdefault( )}

\texttt{setdefault} description.
\\ \hline
\texttt{get( )}
...
\texttt{keys} description.
\\ \hline
\texttt{items( )}

\texttt{items} description.
\\ \hline
\texttt{update( )}

\texttt{update} description.
\\ \hline
\texttt{refresh( )}

\texttt{refresh} description.
\\ \hline
...
Given a filesystem \texttt{path}, attempt to load it as a shared library
of ClassAd functions.  See the documentation for \Macro{CLASSAD\_USER\_LIBS}
