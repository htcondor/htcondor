...
\texttt{set\_subsystem( name, type )}

Set the subsystem name.

Parameter \texttt{name} is the subsystem name used when initializing the
configuration system.

Parameter \texttt{type} is the HTCondor daemon type used when initializing the
configuration system.
