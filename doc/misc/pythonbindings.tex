...
is distinct from typical POSIX locks).

Parameter \texttt{file\_obj} is a file object corresponding which should
be locked.  Parameter \texttt{lock\_type} specifies whether the lock should
be for reads or for writes.

This returns a context manager object; the lock is released as soon as
