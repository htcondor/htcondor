...
Deprecated. Parse input into a ClassAd.
Returns a ClassAd object.
...
Deprecated. Parse old ClassAd format input into a ClassAd.
Returns a ClassAd object.
...
Deprecated. Given \texttt{input} of a string or file, return an iterator of
