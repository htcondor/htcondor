...
\\ \hline
\texttt{drainJobs( (int)how\_fast = DRAIN\_GRACEFUL,
...
(from the DrainTypes enum: DRAIN\_FAST, DRAIN\_GRACEFUL or DRAIN\_QUICK)
(defaults to DRAIN\_GRACEFUL if not specified).
