...
\index{COD!required attributes!Owner} 
 ...
 \item[\Attr{RequestCpus}] This is required when running on a startd
...
allocated for this job from the partitionable slot.
 ...
 \item[\Attr{RequestDisk}] This is required when running on a startd
\index{COD!required attributes!RequestDisk} 
that uses partitionable slots.  It specifies the disk space, in megabytes
allocated for this job from the partitionable slot.

 \item[\Attr{RequestMemory}] This is required when running on a startd
