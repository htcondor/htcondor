...
\index{COD!required attributes!JobUniverse} 
   ...
   This attribute is required if the default \MacroNI{START} expression
   is used, as it references the attribute \Attr{IsValidCheckpointPlatform},
