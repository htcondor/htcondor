...
\item[\AdAttr{CollectorHost}:] The name of the main collector
  which this schedd reports to.  If a schedd flocks to other
  collectors, this attribute still represents the "home" collector,
  so this value can be used to tell if a schedd is currently flocking.
