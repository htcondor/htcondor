...
attempt. To simplify the client's job in figuring out what the job
requires, a \Procedure{discoverJobRequirements} method accepting a JobAd and
...
% A common job submission case also requires the job's
