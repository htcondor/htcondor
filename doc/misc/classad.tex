...
due to the interpretation characters in forming command-line arguments.
...
Within the argument,
Unix escapes the double quote mark with a backslash followed by a double
quote mark.
Windows escapes the double quote mark with two consecutive double
quote marks (no spaces in between).
