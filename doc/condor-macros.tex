...
\newcommand{\VersionNotice}{Version 6.2.0}
\newcommand{\CopyrightNotice}{Copyright \copyright\ 1990-2001 Condor Team, Computer Sciences Department, 
...
\newcommand{\oOptArgnm}[2]{[\OptArgnm{#1\ }{#2}]}% optional Option w/Arg w/ombox
