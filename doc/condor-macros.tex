...
\newcommand{\VersionNotice}{Version 7.4.0}
...
\newcommand{\ConstMethodDef}[6]
 { \BaseFunctionDef{{#1}::{#2}} {#3} {; #4} {} {const}   {#5} {#6} {Method}  }
...
\newcommand{\Constructor}[3]	% {class} {param list} {synopsis}
...
% Function parameters
\newcommand{\ParamDefOpt}[3]				% Optional param
 { \texttt{#2} {#1} -- \textit{Optional;} default = {#3} \\ }
\newcommand{\ParamDef}[2]				% Required parameter
 { \texttt{#2} {#1} \\ }
\newcommand{\Param}[1]       {\mbox{\textit{#1}}}	% Parameter reference
\newcommand{\Const}[1]       {\texttt{#1}}		% Constant expression
\newcommand{\Type}[1]        {\texttt{#1}}		% Custom type
