...
\newcommand{\Env}[1]{\textt{#1}}		% Environment variable
\newcommand{\DCPerm}[1]{\textt{#1}}		% DC Permission
\newcommand{\Expr}[1]{\textt{#1}}		% Config file expression
\newcommand{\Macro}[1]{\textt{#1}}		% Config file macro
		% Release directory entry
\newcommand{\Release}[1]{\textt{\Sinful{release\_dir}}/{#1}}	
