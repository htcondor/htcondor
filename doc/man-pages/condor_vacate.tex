...
\Description
\Condor{vacate} causes the startd to checkpoint any running jobs
...
Condor job running on that host, then \Condor{vacate} has no effect. 

Normally there is no need for the user or administrator to explicitly run \Condor{vacate}. Vacating a running condor job off of a
