...
For a \SubmitCmd{grid\_type-string} of \SubmitCmd{pbs}, no additional
parameters are used.
See section~\ref{sec:PBS} for details.

For a \SubmitCmd{grid\_type-string} of \SubmitCmd{lsf}, no additional
parameters are used.
...
and the grid-type is one of \SubmitCmd{gt2}, \SubmitCmd{gt3},
