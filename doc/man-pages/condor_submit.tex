...
The compress format is the same as used by GNU gzip.  The files given in this
list must be complete pathnames, but may be abbreviated by using $*$ as a wildcard.
...
it will be copied back to its original location.  The files given in this list must be
complete pathnames, but may be abbreviated by using $*$ as a wildcard.
