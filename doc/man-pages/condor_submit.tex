...
Description of vm\_cdrom\_files.
...
Description of vm\_networking\_type.
...
Description of vm\_should\_transfer\_cdrom\_files.
...
Description of vm\_type.

%%%%%%%%%%%%%%%%%%%
%% vmware_dir
%%%%%%%%%%%%%%%%%%%

\item[vmware\_dir = $<$vmware \Bar\ xen$>$]
\index{submit commands!vmware\_dir}
Description of vmware\_dir.
...
Description of vmware\_should\_transfer\_files.
...
Description of vmware\_snapshot\_disk.
...
Description of xen\_cdrom\_device.

%%%%%%%%%%%%%%%%%%%
%% xen_disk
%%%%%%%%%%%%%%%%%%%

\item[xen\_disk = $<$list-of-disk-files$>$]
\index{submit commands!xen\_disk}
Description of xen\_disk.
...
Description of xen\_extra.

%%%%%%%%%%%%%%%%%%%
%% xen_kernel
%%%%%%%%%%%%%%%%%%%

\item[xen\_kernel = $<$kernel-file$>$]
\index{submit commands!xen\_kernel}
Description of xen\_kernel.
...
Description of xen\_ram\_disk.

%%%%%%%%%%%%%%%%%%%
%% xen_root
%%%%%%%%%%%%%%%%%%%

\item[xen\_root = $<$root-device$>$]
\index{submit commands!xen\_root}
Description of xen\_root.
...
Description of xen\_transfer\_files.
...
will skip this step. The default is \Expr{False}.
