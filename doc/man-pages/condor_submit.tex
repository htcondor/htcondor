...
Note that in the case of globus universe, the default behavior is
different.  \emph{No} output files will be transferred by default.  If
you do specify a list of output files to transfer, the paths are
evaluated relative to \Opt{remote\_initialdir}, or if no
\Opt{remote\_initialdir} is specified, relative to the temporary
scratch directory that is created for the job.
