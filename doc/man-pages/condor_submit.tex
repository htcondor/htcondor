...
For globus universe jobs, \SubmitCmd{input} may be a URL that the Globus
...
another.
For globus universe jobs, \SubmitCmd{output} may be a URL that the Globus
tool \Prog{globus\_url\_copy} understands.
...
For globus universe jobs, \SubmitCmd{error} may be a URL that the Globus
tool \Prog{globus\_url\_copy} understands.
...
%% grid_type
%%%%%%%%%%%%%%%%%%%
\item[grid\_type = " $<$ gt2 \Bar\ gt3 \Bar\ oracle \Bar\ nordugrid \Bar\ condor $>$  "] A
