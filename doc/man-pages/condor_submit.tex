...
\OptItem{\OptArg{-batch-name}{command}}{Set the batch name for this submit.
  The batch name is displayed by \Condor{q} \Opt{-progress}.  It is intended
  ...
  takes precedence over a batch name specified in the submit description file itself. }
