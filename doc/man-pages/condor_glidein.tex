...
\oOptArg{-\hspace{.25 mm}-vms}{VM count}
...
\begin{Options}
    ...
    \OptItem{\OptArg{-\hspace{.25 mm}-vms}{VM count}}{
	Number of virtual machines to split up allocated resources
	into.
	By default, Condor divides multiple-CPU resources into one
	virtual machine for each CPU, with an equal share of RAM,
	disk, and swap space.
	...
	Install \Arg{filename} as the config file on the Globus resource
	instead of the default config file during the setup phase.
	}
