...
\begin{Options}
    ...
    \OptItem{\OptArg{-p}{poolname}}{Specify the name of the pool to
        be searched. Without this option, the current pool is searched.}
\end{Options}
...
And administrator should set preemption requirements for
the Condor pool.
The expression 
\begin{verbatim}
(Interactive =?= TRUE )
...
If not able to locate any machines, \Condor{findhost} will return the value 1.
