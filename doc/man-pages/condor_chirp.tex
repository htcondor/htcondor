...
\begin{description}
  ...
  \OptItem{\Opt{write} \oOptArg{-offset}{offset} \oOptArg{-stride}{length skip} \Arg{RemoteFileName} \Arg{LocalFileName} [\Arg{Length}]}
    ...
    \Arg{Length} argument is provided after \Arg{LocalFileName}, then the
    write will halt after the \Arg{Length} input bytes have been written,
