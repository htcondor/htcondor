...
\Lbr{} \OptArg{-name}{hostname} \Bar{} \Arg{hostname} \Bar{}
\OptArg{-addr}{"\SinfulAny"} \Bar{} \Arg{"\SinfulAny"} \Bar{}
\OptArg{-constraint}{expression} \Bar{} \Optnm{-all} \Rbr{}
}
%%%% Was:
%%%%\Optnm{-pool centralmanagerhostname[:portnumber]}\\
%%%%\Optnm{-name hostname \Bar{} hostname \Bar{} -addr "\SinfulAny" \Bar{} "\SinfulAny" } \Optnm{\Dots{}} \oOptnm{ \Bar{} -all} \\
...
\Bar{} \OptArg{-name}{scheddname} \Rbr{} \Bar{} \oOptArg{-addr}{"\SinfulAny"}
}
%%%% Was:
%%%%\oOptnm{-pool centralmanagerhostname\oOptnm{:portnumber}}
%%%%\oOptnm{-name hostname \Bar{} -addr "\SinfulAny" }

%% Specification of the jobs with which you want to mess.
\newcommand{\ToolJobs}{
\Argnm{ cluster\Dots{} \Bar{} cluster.process\Dots{} \Bar{} user\Dots{} }
}
