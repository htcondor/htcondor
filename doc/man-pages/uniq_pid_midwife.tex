...
whether the program is still running or whether it has exited.  It
accomplishes this by recording a enforced unique process identifier to
the artifact.
...
\begin{Options}
  ...
  \OptItem{\OptArg{--precision}{seconds}}{
    ...
    to process creation times.  Defaults to an operating specific
