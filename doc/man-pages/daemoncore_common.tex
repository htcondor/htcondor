...
begin), the file will be left in the log directory. If you leave
your pidfile in your log directory, you will want to add whatever
filename you use to the VALID_LOG_FILES parameter, described in
section~\pageref{param:ValidLogFiles}\ of the manual, so that
\Condor{preen} does not remove it. }
