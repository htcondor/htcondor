...
\begin{description}
    ...
    and the operating system is is defined by the machine ClassAd
    \AdAttr{OpSys}.
    The string ``Total'' ask for information about all platforms.
    
    The information displayed includes the total number of machines, and
    the state of the machines where }
\begin{verbatim}
    unclaimed state  = 1
    matched state    = 2
    claimed state    = 3
