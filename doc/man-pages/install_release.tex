...
{installs an arbitrary software release into a named directory}
...
a mounted file system, a http server, a ftp server, or a grid ftp
server.
...
\begin{Options}
  ...
  \OptItem{\Arg{package}}{
    ...
    package. Locations on file systems can be specified without the
    \URL{file:} prefix, but other locations must prefix with the
    appropriate protocol (\URL{http:}, \URL{ftp:}, \URL{gsiftp:}).
  }
  \OptItem{\Opt{-wget}}{
