\begin{ManPage}{\Stork{submit}}{man-stork-submit}{1}
{submit a Stork job}
...
%\item[dap\_type = \lt{}reserve \Bar{}\ release \Bar{}\ transfer \Bar{}\ stage \Bar{}\ remove \gt{}]
...
% reserve_size
%%%%%%%%%%%%%%%%%%%
%\item[reserve\_size = \lt{}size-in-bytes\gt{}]
