\begin{ManPage}{\Condor{checkpoint}}{1}{checkpoint jobs running on the specified hosts}
...
\Description
\Condor{checkpoint} causes the startd's on the specified hosts to perform a periodic
