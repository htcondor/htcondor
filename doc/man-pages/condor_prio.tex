\begin{ManPage}{\Condor{prio}}{man-condor-prio}{1}
...
\OptArg{-p}{priority} \Bar{} \OptArg{+}{value} \Bar{} \OptArg{-}{value}
\oOptArg{-n}{schedd\_name}
\Arg{cluster \Bar{} cluster.process \Bar{} username \Bar{} \Opt{-a}}
...
For \Opt{-a}, \Condor{prio} attempts to change priority of
