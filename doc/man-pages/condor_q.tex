...
\begin{Options}
  ...
  \OptItem{\OptArg{-userlog}{file}}{Display jobs from a userlog,
    instead of the real ClassAds from the \Condor{schedd} daemon.
    This is most useful for automated testing of the status of jobs known to be
    in the given userlog because it reduces the load on the \Condor{schedd}.
