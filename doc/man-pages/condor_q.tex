...
\begin{Options}
  ...
  \OptItem{\OptArg{-attributes}{X,Y,...}}{Specify the attributes which should be displayed when using the \Opt{-xml} or \Opt{-long} options.  Limiting the number of attributes increases the efficiency of the query.}
