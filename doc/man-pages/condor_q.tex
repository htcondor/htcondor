...
\begin{Options}
	...
	\OptItem{\OptArg{-format}{fmt attr}}{Display attribute \emph{attr} in
		...
		attribute.   \%s is suitable for strings like Owner, \%d
		for integers like ClusterId, and \%f for floating point
		numbers like RemoteWallClockTime.  An incorrect format
