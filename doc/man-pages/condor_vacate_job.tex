\begin{ManPage}{\Condor{vacate\_job}}{man-condor-vacate-job}{1}
...
\begin{Options}
	...
	\OptItem{\OptArg{-constraint}{expression}} {Vacate all jobs which match
        ...
        \OptItem{\Opt{-all}}{Vacate all the jobs in the queue}
        \OptItem{\Opt{-fast}}{Perform a fast vacate and hard kill the jobs}
\end{Options}
