...
\begin{Options}
  ...
  \OptItem{\Opt{-AlwaysRunPost}}{This optional argument causes the submit
     description file generated for the submission of \Condor{dagman} to
     be modified.  This will pass the \Opt{-AlwaysRunPost} flag in the
     arguments to \Condor{dagman} in the submission file, which causes
     \Condor{dagman} to use the return value from a PRE script to determine
     whether a POST script will run.  By default, \Condor{dagman} runs the
