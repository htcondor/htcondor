...
\begin{Options}
  ...
  \OptItem{\Opt{-valgrind}}{This optional argument tells
     \Condor{submit\_dag} to create a Condor submit file that runs
     \emph{valgrind} on \Condor{dagman}.  (This feature is mainly intended
     for testing.)
  }
  \end{Options}
