...
\begin{Options}
  ...
  \OptItem{\Opt{-force}}{Require \Condor{submit\_dag} to overwrite
     ...
     "new-style" rescue DAG mode (see section~\ref{sec:DAGRescueNew})
     ...
     If "old-style" rescue DAG mode (see section~\ref{sec:DAGRescueOld})
  ...
  \OptItem{\Opt{-usedagdir}}{This optional argument causes
     ...
     an "old-style" rescue DAG (see section~\ref{sec:DAGRescueOld}).
     }
  ...
  \OptItem{\OptArg{-oldrescue}{0|1}}{Whether to use "old-style" rescue
    DAG naming (see section~\ref{sec:DAGRescueOld}) when creating a
