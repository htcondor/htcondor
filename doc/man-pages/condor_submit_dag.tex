...
\begin{Options}
  ...
  \OptItem{\OptArg{-priority}{number}}{Sets the minimum job priority 
     of jobs submitted by the DAGMan running under the \Condor{dagman} 
  ...
  \OptItem{\Opt{-dont\_use\_default\_node\_log}}{ Tells \Condor{dagman} 
     ...
     and submitting to a \Condor{schedd} daemon 
     with version number 7.8.0 or an earlier version.}
