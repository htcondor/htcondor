...
\begin{Options}
  ...
  \OptItem{\OptArg{-batch-name}{batch_name}}{
    Set the batch name for this dag.
    The batch name is displayed by \Condor{q} \Opt{-progress}.  It is intended
    for use by users to give meaningful names to their dags and to influence
    how \Condor{q} groups jobs for display.
  }
