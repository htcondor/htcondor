\begin{ManPage}{\Condor{cod}}{man-condor-cod}{1}
...
\Arg{request}
\ToolLocate
\Lbr{} \oOpt{-help \Bar{} -version} \Bar{} \oOpt{-debug \Bar{} -timeout N \Bar{} -classad file} \Rbr{}
...
\Lbr{} \oOpt{-help \Bar{} -version} \Bar{} \oOpt{-debug \Bar{} -timeout N \Bar{} -classad file} \Rbr{}
\oOpt{-keyword string \Bar{} -jobad filename \Bar{} -cluster N \Bar{} -proc N \Bar{} -requirements expr}
