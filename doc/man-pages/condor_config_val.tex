...
\Condor{config\_val} can help with testing.
...
\begin{Options}
  ...
  \OptItem{\OptArg{-set}{"var = value"}}{(edit option) 
    The \Opt{-set} option sets one or more persistent configuration file 
  ...
  \OptItem{\OptArg{-unset}{var}}{(edit option) What unset does.
    Each of the persistent configuration variables listed reverts to
    its previous value.
   }
  \OptItem{\OptArg{-rset}{"var = value"}}{(edit option) 
    The \Opt{-rset} option sets one or more persistent configuration file 
  ...
  \OptItem{\OptArg{-runset}{var}}{(edit option) What runset does.
    Each of the configuration variables listed reverts to
    its previous value as long as the daemon continues running..
   }
