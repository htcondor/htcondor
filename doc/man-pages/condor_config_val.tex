...
\SynProg{\Condor{config\_val}} \oOpt{options} \Opt{-expand}
...
If the \Opt{-expand} option is given in addition to the \Opt{-dump}
option, then macros in the config files are expanded before
being printed out.
