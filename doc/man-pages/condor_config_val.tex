...
\begin{Options}
	...
	in use. }
	\OptItem{\OptArg{-dump}}{ Returns a list of all of the defined macros
	in the configuration files found by \Condor{config\_val} along with
	their values. If \OptArg{-v} is suppled as well, then the specific
	configuration file which defined each macro--along with the line
	number of definition, is also printed. \Note: The output of this
	argument is likely to change in a future revision of Condor. }
