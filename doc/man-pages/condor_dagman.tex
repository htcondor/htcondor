...
\begin{Options}
    ...
    \OptItem{\OptArg{-maxidle}{NumberOfJobs}}{Sets the maximum number of idle
       ...
       \Condor{dagman}.
       If not specified, the number of idle jobs is unlimited. Note that
       nothing special is done to the submit file: a ``queue 5000'' statement in
       a submit file where \Arg{-maxidle} is set to 250 will result in a cluster
       of 5000 new jobs being submitted to the schedd; in this case, \Condor{dagman}
