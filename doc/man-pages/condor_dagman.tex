...
\begin{Options}
    ...
    \OptItem{\OptArg{-maxidle}{NumberOfJobs}}{Sets the maximum number of idle
       ...
       \Condor{dagman}.
       If not specified, the number of idle jobs is defined by the
       \Macro{DAGMAN\_MAX\_JOBS\_IDLE} configuration macro which, as
       of version 8.3.3, defaults to 1000.
       See section~\ref{param:DAGManMaxJobsIdle} for details.
