...
\begin{Options}
    ...
    \OptItem{\Opt{-dont\_use\_default\_node\_log}}{\Bold{This flag is
       disabled as of version 8.3.1.}  (This feature has been disabled to
       simplify the code and make certain planned features easier to
       implement -- see \Ticket{3994})
       Tells \Condor{dagman}
