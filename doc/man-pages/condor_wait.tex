...
\Condor{wait} will wait forever for jobs to finish, unless you
...
\begin{Options}
    ...
    \OptItem{\OptArgnm{-num}{number}}{Wait only for this many 
    jobs to end. The default is all jobs in the logfile.} 
...
\end{verbatim}
This command waits for all jobs that exist in \File{logfile} and are part
