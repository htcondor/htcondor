...
The username to be used to authenticate with a Deltacloud service.
...
Used for \SubmitCmd{deltacloud} jobs.
Path and filename of a file containing the secret key to be used to
...
Used for \SubmitCmd{deltacloud} jobs.
An optional description of the memory desired for the VM, overriding
the seledted hardware profile.
...
Used for \SubmitCmd{deltacloud} jobs.
An optional description of the storage desired for the VM, overriding
the selected hardware profile.
...
Used for \SubmitCmd{deltacloud} jobs.
Identifier of the SSH keypair that should be used to allow remote login
to the running instance. The keypair needs to be created before
submission.
...
Used for \SubmitCmd{deltacloud} jobs.
A block of data that can be accessed by the virtual machine job inside
the cloud service.
