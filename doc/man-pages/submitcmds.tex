...
For grid type \SubmitCmd{boinc} jobs, 
...
For grid type \SubmitCmd{gce} jobs, 
specifies a path and file name of the authorization file that grants
...
\SubmitCmdNI{batch}, 
\SubmitCmdNI{condor}, \SubmitCmd{cream}, 
\SubmitCmdNI{deltacloud}, 
\SubmitCmdNI{ec2},
...
For a \SubmitCmdNI{grid-type-string} of \SubmitCmdNI{deltacloud},
