...
expression becoming true, this expression is evaluated to
set the value of \AdAttr{HoldReason} in the job ad.  If this
expression is undefined or produces an empty of invalid string,
...
value of \AdAttr{HoldReasonSubCode} in the job ad.  The default
subcode is 0.  The \AdAttr{HoldReasonCode} will be set to 3, which
...
This value replaces the default allocation of 512 Mbytes of stack space.
