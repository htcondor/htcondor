...
Use the \SubmitCmd{vanilla} universe to submit shell scripts to HTCondor.
...
The \SubmitCmd{scheduler} universe is for a job that is to run on the
...
The \SubmitCmd{local} universe is for a job that is to run on the
machine where the job is submitted.
