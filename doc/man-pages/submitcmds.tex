...
%%\Bar\ local \Bar\ grid \Bar\ java \Bar\ vm\gt{}]
...
\item[transfer\_output\_remaps $=$ \lt{} `` name $=$ newname ; name2 $=$ newname2 ... ''\gt{} ]
...
\item[buffer\_files $=$ \lt{} `` name $=$ (size,block-size) ; name2 $=$ (size,block-size) ... '' \gt{} ]
\item[buffer\_size $=$ \lt{}bytes-in-buffer\gt{}]
\item[buffer\_block\_size $=$ \lt{}bytes-in-block\gt{}]
...
\item[file\_remaps $=$ \lt{} `` name $=$ newname ; name2 $=$ newname2 ... ''\gt{} ]
...
\item[+PreCmd = \texttt{"}\lt{}executable\gt{}\texttt{"}]
...
\item[+PreArgs = \texttt{"}\lt{}argument\_list\gt{}\texttt{"}]
...
\item[+PreArguments = \texttt{"}\lt{}argument\_list\gt{}\texttt{"}]
Defines command line arguments for the prescript, 
...
\item[+PreEnv = \texttt{"}\lt{}environment\_vars\gt{}\texttt{"}]
...
\item[+PreEnvironment = \texttt{"}\lt{}environment\_vars\gt{}\texttt{"}]
Defines the environment for the prescript,
...
\item[+PostCmd = \texttt{"}\lt{}executable\gt{}\texttt{"}]
A vanilla universe job may specify that a script is to be run 
...
\item[+PostArgs = \texttt{"}\lt{}argument\_list\gt{}\texttt{"}]
...
\item[+PostArguments = \texttt{"}\lt{}argument\_list\gt{}\texttt{"}]
Defines command line arguments for the postscript, 
presuming the New argument syntax.
An exception to the syntax is that double
quotes must be escaped with a backslash instead of another double
...
\item[+PostEnv = \texttt{"}\lt{}environment\_vars\gt{}\texttt{"}]
...
\item[+PostEnvironment = \texttt{"}\lt{}environment\_vars\gt{}\texttt{"}]
Defines the environment for the postscript,
presuming the New environment syntax.
