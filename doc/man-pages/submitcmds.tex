...
\item[+PreArgs = $<``$argument\_list''$>$]
Arguments for the prescript, in the old syntax (see the section on
the arguments command (~\ref{man-condor-submit-arguments}) for more
details.
...
\item[+PreArguments = $<``$argument\_list''$>$]
Arguments for the prescript, in the new syntax (except that double
quotes must be escaped with a backslash instead of another double
quote) (see the section on the arguments command
(~\ref{man-condor-submit-arguments}) for more details.
...
\item[+PostArgs = $<``$argument\_list''$>$]
Arguments for the postscript, in the old syntax (see the section on
the arguments command (~\ref{man-condor-submit-arguments}) for more
details.
...
\item[+PostArguments = $<``$argument\_list''$>$]
Arguments for the postscript, in the new syntax (except that double
quotes must be escaped with a backslash instead of another double
quote) (see the section on the arguments command
(~\ref{man-condor-submit-arguments}) for more details.
...
IMPORTANT NOTE:  if any of the pre/post script values are not enclosed
