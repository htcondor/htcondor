...
For grid type \SubmitCmdNI{ec2} jobs,
a space- or comma- separated list of the names of additional parameter(s)
...
parameter.  A name in the \SubmitCmd{ec2\_parameter\_names} list may contain
periods, but these are replaced by underscores when specifying the value.
