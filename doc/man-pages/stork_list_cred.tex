...
{list all credentials of a user stored on the \Condor{credd} daemon on behalf of Stork}
...
As more credential types are handled by the \Condor{credd} daemon,
...
\begin{Options}
  ...
  \OptItem{\OptArg{-n}{hostname:portnumber}}
    {Identify the \Condor{credd} daemon by host name and port number.}
\end{Options}
