...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Why do Condor daemons exit with "Unexpected performance counter size" or "unable to spawn the ProcD" errors?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Condor relies on some of Windows' built-in performance counters for its
operation. It is possible (via the registry) for performance counters that
Condor requires to be disabled. If this is the case, you may see daemons
...
\verb@HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PerfProc\Performance@. If a value \verb@Disable Performance Counters@ exists, delete it or set
it to \verb@0@.
