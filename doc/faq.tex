...
In some rare cases, as in gcc compiled simultaneously with
\Opt{--without-gnu-ld} and and \Opt{--with-ld}, the enforcement mechanism
we rely upon to have gcc choose our supplied linker script is ignored.

When this happens, an executable is produced, but it is bereft of the
...
This specific case can be fixed by recompiling gcc so that those to flags
