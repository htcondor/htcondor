%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Microsoft Windows}\label{sec:platform-windows}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Finally, HTCondor has all the security mechanisms present
in the full-blown version of HTCondor.  See section~\ref{sec:Security-Authorization}
starting on page~\pageref{sec:Security-Authorization} for complete information
on how to allow/deny access to HTCondor.
