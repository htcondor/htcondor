...
\Condor{credd} to manage the secure password store.  This makes a
...
a \Condor{credd} for password management.  These will typically be
...
\item \Macro{CREDD\_CACHE\_LOCALLY} - This affects Condor's behavior
      ...
      communication with the \Condor{credd}.  If not set, the default
      value is False.
\end{itemize}

Careful attention must be given to the \Condor{credd}'s security
configuration.  All communication with the \Condor{credd} should be
