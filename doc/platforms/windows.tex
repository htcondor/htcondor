...
This feature may not require any modifications to Condor's
configuration.  Perl scripts, using \Prog{ActivePerl}, for example,
require no administrative intervention.
...
\end{verbatim}
Where \verb@<EXT>@ represents the file name extension.
...
for a script with the file name extension of \verb@wsh@, or \verb@vbs@, etc..
