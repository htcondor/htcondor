...
Perl scripts, using \Prog{ActivePerl} require no administrative intervention.
...
The \verb@Open2@ verb of \Prog{Windows Scripting Host} allows standard input,
...
The fix for this error is to give access explicitly for the job
