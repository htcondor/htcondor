...
preferred method of installation for use Condor is the 
``Shared Installation'' method.  Using this method allows all users 
have access to the executables.  During the installation process 
...
tool is called \Prog{boinccmd.exe}.
