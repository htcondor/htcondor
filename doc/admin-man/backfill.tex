...
\Prog{boinc\_client} is killed (for example, when an HTCondor job arrives
...
The \Prog{boinc\_client} executables can be obtained at 
...
spawned by HTCondor (the \Prog{boinc\_client}) can not automatically
...
This \Condor{starter} is just like the one used to spawn normal HTCondor
jobs.
