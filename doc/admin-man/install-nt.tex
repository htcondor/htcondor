...
Installation Procedure using the included Setpup Program}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\label{sec:NT-Manual-Install}Manual Installation Condor on Windows NT}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\index{Windows NT!manual install|(}
If you are to install Condor on many different machines, you may wish
to use some other mechanism to install Condor NT rather than running
the Setup program descibed aboute.

\Warn This is for advanced users only!  All others should use the Setup program described about.
...
For your convience, we have included a file called \File{install.exe} in 
...
\item [The Registry]
Condor NT uses a few registry entries in its operation.  The key that Codnor
...
version of Condor, execept that executable files end in \File{.exe}.  For
example the on Unix one of the files is \File{condor\_master} and on Condor
NT the coresponding file is \File{condor\_master.exe}.
