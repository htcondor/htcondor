...
must be stored on the local disk.  Unfortunately, there is not a clear
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\label{sec:NT-Install}Manually Installing Condor on Windows NT}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Here is a brief overview of what is required to be installed to enable
Condor NT to operate:
