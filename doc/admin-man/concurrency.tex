...
due to the treatment of quote marks by \Condor{submit}.
...
The direct specification of the job ClassAd attribute \Attr{ConcurrencyLimits}
must be used in this situation.
Specification of submit command \SubmitCmdNI{concurrency\_limits}
will not work, as \Condor{submit} would inject double quote marks
