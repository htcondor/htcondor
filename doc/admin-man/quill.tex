...
As of Condor 7.5.5, Quill is a ``contrib feature'' of Condor.  This
means it is not included in the builds of Condor provided by UW, but
it is available as a feature that can be enabled by those who compile
