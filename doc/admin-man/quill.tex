...
The \File{.pgpass} file contains exactly one line.
...
for \MacroNI{QUILL} and \MacroNI{QUILL\_LOG}.  If you are upgrading from
an old configuration that does not have these, you will need to define them.
