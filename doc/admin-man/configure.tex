...
\begin{verbatim}
        # Let this exectuable be resolved by user's path in the wrapper
        cmd = sleep
\end{verbatim}
  As opposed to
\begin{verbatim}
...
\label{param:NegotiatorStartdConstraintRemove}
\item[\Macro{NEGOTIATOR\_STARTD\_CONSTRAINT\_REMOVE}]
  A boolean value that defaults to \Expr{False}.
