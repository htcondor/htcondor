...
Examples using these configuation macros,
...
The default value is 18 (allow terminated/aborted event combination
and allow execute event before job's submit event).
