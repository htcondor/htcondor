...
For the host, a comma separated list of the host names or IP addresses
...
These macros affect how Condor runs vm universe jobs on
...
The complete path and file name of a Condor configuration file
containing settings specific to the execution of either
a VMware or Xen virtual machine.
There is no default value for this required configuration variable.
...
A value set for this  configuration variable overrides the
value set by \MacroNI{VM\_MAX\_MEMORY}.
...
virtual machine software.  They allow the \Condor{vm-gahp} to
