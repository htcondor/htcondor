...
\item[\Macro{DEFAULT\_DOMAIN\_NAME}] \label{param:DefaultDomainName}
  ...
  (or NIS, etc.) for either your official host name or as an
  ...
  domain to be appended to your host name, if changing your host
  ...
  to know the full host name.  So, for \MacroUNI{DEFAULT\_DOMAIN\_NAME} to
