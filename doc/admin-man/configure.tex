...
\item[\Macro{DAGMAN\_CONFIG\_FILE}]
  The name of the configuration file (if any) to be used by \Condor{dagman}.
  (Note that this configuration macro is set automatically by
  \Condor{submit\_dag}, and should not be explicitly set by the user.)
  Defaults to "".
