...
\item[\Macro{NEGOTIATION\_CYCLE\_STATS\_LENGTH}] Specifies how many
 ...
 published in the \Condor{negotiator}'s ad.  The default is 3.  The
 ...
 \AdAttr{LastNegotiationCycleDuration1}, \ldots.  The attribute
 ...
 cycle, and so on.  See
 page~\pageref{attr:LastNegotiationCycleActiveSubmitterCountX} for a
