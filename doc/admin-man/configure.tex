...
\item[\Macro{DAGMAN\_WRITE\_PARTIAL\_RESCUE}]
  ...
  or full DAG file as a rescue DAG.  As of version 7.2.2, writing a partial
  DAG is preferred.
...
\item[\Macro{DAGMAN\_RESET\_RETRIES\_UPON\_RESCUE}]
  ...
  in a rescue DAG is decreased if any retries were used in the original
  run of the DAG; otherwise, the original number of retries is allowed
