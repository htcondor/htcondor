...
\item[\Macro{COLLECTOR\_PORT}] \label{param:CollectorPort}
  The port that the \Condor{collector} uses. Defaults to 9618.
...
\item[\Macro{CONDOR\_VIEW\_PORT}] \label{param:CondorViewPort}
...
\item[\Macro{CONDOR\_DEVELOPERS\_COLLECTOR\_PORT}]
  \label{param:CondorDevelopersCollectorPort}
