...
\end{verbatim}
  ...
  \item \verb@$(<configuration variable>)@ may be used where the
    ...
    A value that is does not evaluate to a simple boolean value
    is considered \verb@False@.
\end{itemize}
...
\item[\Macro{SCHEDD\_USE\_SLOT\_WEIGHT}]
  ...
  \Condor{schedd} should use the SLOT\_WEIGHT expression
  to weight running and idle job counts in the submitter ad.
