...
\item[\Macro{DAGMAN\_PEGASUS\_REPORT\_METRICS}]
  The path the the \Condor{dagman\_metrics\_reporter} executable.  
  Defaults to
...
\item[\Macro{DAGMAN\_PEGASUS\_REPORT\_TIMEOUT}]
  An integer value representing seconds that defaults to 100 seconds.
  The \Condor{dagman\_metrics\_reporter} will exit after successfully 
  contacting all its metrics servers,
  or after it has executed for more than this duration of time.
\end{description}
