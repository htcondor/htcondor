...
\item[\Macro{OPEN\_VERB\_FOR\_<EXT>\_FILES}]
  ...
  \verb@<EXT>@. In Microsoft nomenclature, \Term{verbs} are actions
  ...
  The \Prog{Windows Scripting Host} (\Term{WSH}) is a perfect example
  of a Windows application that has a command-line alternative.  The
  \verb@Open@ \Term{verb} runs scripts as a Windowed application.
  Meaning that all the \Term{WSH} scripts run using this \Term{verb}
  will result in all the output being piped to a Window. The
  \verb@Open2@ \Term{verb}, in contrast, is a command-line
