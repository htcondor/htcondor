...
\item[\Macro{UNHIBERNATE}]
  ...
  In addition, collection of offline machine ClassAds must be enabled
  for this expression to work.  See \Macro{OFFLINE\_LOG} on
  page~\pageref{param:OfflineLog}.
...
For \Condor{rooster} to wake up hibernating machines, the collection
of offline machine ClassAds must be enabled.  See
\Macro{OFFLINE\_LOG} on page~\pageref{param:OfflineLog}.
