...
\item[\Macro{ENABLE\_HISTORY\_ROTATION}] \label{param:EnableHistoryRotation} 
  ...
  operating system. If this is not defined, it is assumed to be true.

\item[\Macro{HISTORY\_MAX\_SIZE}] \label{param:HistoryMaxSize}
...
\item[\Macro{HISTORY\_NUMBER\_BACKUPS}] \label{param:HistoryNumberBackups}
