...
\item[\Macro{GSI\_DAEMON\_NAME}]
  ...
  Any certificates matched by this setting are accepted whether
  or not the daemon hostname matches the hostname in the
  daemon's certificate.  Therefore, if
  ...
  \MacroNI{GSI\_DAEMON\_NAME} to control this behavior, we
