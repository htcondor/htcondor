...
\item[\Macro{COLLECTOR\_UPDATE\_INTERVAL}]
  This parameter is defined in seconds and defaults to 900 (every 15
  minutes). This parameter controls the frequency of the the periodic
  updates to a central \Condor{collector} at UW-Madison with (see
  \MacroNI{CONDOR\_DEVELOPERS\_COLLECTOR} above).
