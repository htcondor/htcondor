...
Other than macros, a Condor configuration file can contain comments or
line continuations.
...
\item[\Macro{NEGOTIATOR\_TRAFFIC\_LIMIT}]
  ...
  initiate per \Macro{NEGOTIATOR\_TRAFFIC\_INTERVAL} for job placement
