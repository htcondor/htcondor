...
\item[\Macro{ACCOUNTANT\_DATABASE\_NAME}] \label{param:AccountantDatabaseName} 
  This macro defines the name of the file used for the database of
  accounting information.  
  If it is not defined, it defaults to a file named ``Accountant.log''
  in your \Macro{SPOOL} directory. 
