...
\end{verbatim}
  ...
  \begin{itemize}
    ...
    \item \MacroNI{prefix} Specifies a string which is prepended
   ...
   the last one in the list is followed.
	...
	\MacroNI{continuous} is used to specify a module which runs in continous
	mode (as described above).
	In continous mode, the \Condor{startd} daemon will
