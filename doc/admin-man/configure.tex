...
is used.
For the \Condor{collector} daemon, the value defaults to 81920, and
...
\item[\Macro{SUBMIT\_DEFAULT\_SHOULD\_TRANSFER\_FILES}]
  ...
  Valid values are YES, TRUE, ALWAYS, NO, FALSE, NEVER and IF_NEEDED.
  If the value is not one of these, then IF_NEEDED will be used.
