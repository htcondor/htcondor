...
\label{param:NegotiatorMaxTimePerSubmitter} This macro limits the
amount of time the negotiator will spend with a submitter during one
negotiation cycle.  Once this time limit has been reached, the
negotiator will still finish its current ``pie spin'' but will skip
...
negotiator will spend with a submitter in one \emph{pie spin}.  A
negotiation cycle is composed of at least one pie spin, possibly more,
...
submitter per negotiation cycle, you can protect the negotiator
against spending a long time talking to one submitter (e.g. someone
with a very slow schedd), but this can result in unfair allocation of
