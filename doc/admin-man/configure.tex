...
\item[\Macro{GANGLIA\_METRICS\_CONFIG\_DIR}]
  ...
  \item[AggregateGroup] When an aggregate function has been
    ...
    type.  The default \Attr{AggregateGroup} would be set accordingly.
  ...
  \item[Machine] The name of the host associated with this metric.
    ...
    metrics with no \Attr{AggregateGroup} defined, the default
