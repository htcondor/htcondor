...
\item[\Macro{ALLOW\_PSLOT\_PREEMPTION}]
  A boolean value that defaults to \Expr{False}.
  When set to \Expr{True} for the \Condor{negotiator} and all
  \Condor{startd}s and \Condor{schedd}s, enables a new matchmaking
  mode, where one or more dynamic slots can be preempted in order to
