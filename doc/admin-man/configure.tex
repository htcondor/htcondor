...
\item[\Macro{CONDOR\_VIEW\_CLASSAD\_TYPES}]
  If configured, it provides the ad types that will be forwarded to the
  \Macro{CONDOR\_VIEW\_HOST}. The ad types can be found with 
  \Condor{status -any} -any. The default forwarding behavior of the 
  Collector is equivalent to 
  \begin{verbatim}
