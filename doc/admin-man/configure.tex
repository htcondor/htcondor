...
\item[\Macro{CKPT\_PROBE}] \label{param:CkptProbe}
	Defines the location of a helper process Condor will use to
	determine information for the \Attr{CheckpointPlatform} attribute
	in the machine's classified advertisement. The default value
	for this parameter is \File{\$(LIBEXEC)/condor\_ckpt\_probe}.
