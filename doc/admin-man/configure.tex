...
\item[\Macro{ENABLE\_CLASSAD\_CACHING}]
  A boolean value that controls whether the recent caching feature of
  ClassAds is used. Caching saves memory when a Condor process contains
  many ClassAds with the same expressions.
  The default value is \Expr{True}, i.e. use caching.
