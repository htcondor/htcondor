...
\item[\Macro{UPDATE\_INTERVAL}] \label{param:UpdateInterval}
  ...
  state or activity change, or if the value of its \Macro{START} expression
  ...
  \Macro{START} expression for details on states, activities, and the
  \Macro{START} expression.  This macro is defined in
  terms of seconds and defaults to 300 (5 minutes).
