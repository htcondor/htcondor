...
\item[\Macro{CHIRP\_DELAYED\_UPDATE\_PREFIX}]
  ...
  defines a list of prefixes for attribute names which can be used with the
  \Condor{chirp} commands \Opt{set\_job\_attr\_delayed} and 
  \Opt{get\_job\_attr\_delayed}.
  The list is delimited by spaces and commas.
  Because it must be set to the
