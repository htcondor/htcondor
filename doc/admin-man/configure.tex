...
\item[\Macro{CheckpointPlatform}]
  Overrides the automatically-generated machine ad attribute 
  \AdAttr{CheckpointPlatform} (see section
  \ref{CheckpointPlatform-machine-attribute}),
  which is used to identify systems where previously taken checkpoints
  for the standard universe may resume.
