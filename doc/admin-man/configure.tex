...
\item[\Macro{MAX\_<SUBSYS>\_LOG}]
  ...
  number of rotated files (determined by \ref{param:MaxNumSubsysLog}) 
  is exceeded. Thus the maximum space devoted to logging for 
  any one program will be \Macro{MAX\_NUM\_<SUBSYS>\_LOG} + 1 times 
...
\item[\Macro{MAX\_NUM\_<SUBSYS>\_LOG}]
  Controls the maximum number of rotatations a log file 
  is allowed to perform before the oldest one will be 
  rotated away. Thus, at most \Macro{MAX\_NUM\_<SUBSYS>\_LOG} + 1
