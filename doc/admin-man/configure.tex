...
\item[\Macro{CONSOLE\_DEVICES}]
  ...
  Unfortunately, modern versions of Linux don't update the access time of
  device files for USB devices. Thus, these files can't be be used to
  determine when the console is in use. Instead, you can use the
  \Condor{kbdd}, which gets this information by connecting to the X
  server.
