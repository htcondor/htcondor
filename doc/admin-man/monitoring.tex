...
Given that Ganglia is already deployed in the pool,
monitoring of HTCondor is enabled by running the \Condor{gangliad} daemon.
Add \Expr{GANGLIAD} to the definition of configuration
variable \MacroNI{DAEMON\_LIST} on the host running
the Ganglia \Prog{gmetad}.
...
On a large pool with many ClassAds
