...
The value may be the path to a file on the local machine, or a URL beginning with http.
If the value is a URL, then the \Condor{urlfetch} tool will be used to fetch it whenever
the configururation is read.
