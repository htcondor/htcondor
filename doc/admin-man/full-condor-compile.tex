\section{Full Installation of \Condor{compile}}
...
also supported.  See the \Cmd{condor_compile}{1} man page for details on
...
are on.  The location of the system linker (\Prog{ld}), is as follows:
	...
	Operating System              Location of \Prog{ld} (ld-path)
	Linux                         /usr/bin
...
replaced by the path to your system's \Prog{ld}.
