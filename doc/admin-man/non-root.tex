%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Running Condor as Non-Root}
\label{sec:Non-Root}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item[\Condor{schedd}] The biggest problem running the schedd
    ...
    \File{UserLog} files get created with the right permissions.
    ...
    that just writes to \File{stdout} and \File{stderr} will work.  If
...
\item[\Condor{kbdd}] On platforms that need the \Condor{kbdd}
    (Digital Unix and IRIX) the \Condor{kbdd} has to run as root.  If
    ...
    can't run the \Condor{master} as root.  Without the \Condor{kbdd},
