...
\item[\DCPerm{DAEMON}] \label{dcperm:config} This access level is ?
...
% server-side 
\index{configuration macro!SEC\_DEFAULT\_AUTHENTICATION}
\index{configuration macro!SEC\_DEFAULT\_ENCRYPTION}
\index{configuration macro!SEC\_DEFAULT\_INTEGRITY}
%\index{configuration macro!SEC\_DEFAULT\_NEGOTIATION}
\index{configuration macro!SEC\_READ\_AUTHENTICATION}
\index{configuration macro!SEC\_READ\_ENCRYPTION}
\index{configuration macro!SEC\_READ\_INTEGRITY}
%\index{configuration macro!SEC\_READ\_NEGOTIATION}
\index{configuration macro!SEC\_WRITE\_AUTHENTICATION}
\index{configuration macro!SEC\_WRITE\_ENCRYPTION}
\index{configuration macro!SEC\_WRITE\_INTEGRITY}
%\index{configuration macro!SEC\_WRITE\_NEGOTIATION}
\index{configuration macro!SEC\_ADMIN\_AUTHENTICATION}
\index{configuration macro!SEC\_ADMIN\_ENCRYPTION}
\index{configuration macro!SEC\_ADMIN\_INTEGRITY}
%\index{configuration macro!SEC\_ADMIN\_NEGOTIATION}
\index{configuration macro!SEC\_DAEMON\_AUTHENTICATION}
\index{configuration macro!SEC\_DAEMON\_ENCRYPTION}
\index{configuration macro!SEC\_DAEMON\_INTEGRITY}
%\index{configuration macro!SEC\_DAEMON\_NEGOTIATION}
\index{configuration macro!SEC\_CONFIG\_AUTHENTICATION}
\index{configuration macro!SEC\_CONFIG\_ENCRYPTION}
\index{configuration macro!SEC\_CONFIG\_INTEGRITY}
%\index{configuration macro!SEC\_CONFIG\_NEGOTIATION}

\index{configuration macro!SEC\_OWNER\_AUTHENTICATION}
\index{configuration macro!SEC\_OWNER\_ENCRYPTION}
\index{configuration macro!SEC\_OWNER\_INTEGRITY}
%\index{configuration macro!SEC\_OWNER\_NEGOTIATION}
\index{configuration macro!SEC\_NEGOTIATOR\_AUTHENTICATION}
\index{configuration macro!SEC\_NEGOTIATOR\_ENCRYPTION}
\index{configuration macro!SEC\_NEGOTIATOR\_INTEGRITY}
%\index{configuration macro!SEC\_NEGOTIATOR\_NEGOTIATION}
...
\index{configuration macro!SEC\_DEFAULT\_INTEGRITY}
%\index{configuration macro!SEC\_DEFAULT\_NEGOTIATION}
\index{configuration macro!SEC\_CLIENT\_AUTHENTICATION}
\index{configuration macro!SEC\_CLIENT\_ENCRYPTION}
\index{configuration macro!SEC\_CLIENT\_INTEGRITY}
%\index{configuration macro!SEC\_CLIENT\_NEGOTIATION}
...
\index{configuration macro!SEC\_DEFAULT\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_READ\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_WRITE\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_ADMIN\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_DAEMON\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_CONFIG\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_OWNER\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_NEGOTIATOR\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_CLIENT\_AUTHENTICATION\_METHODS}
\index{configuration macro!SEC\_DEFAULT\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_READ\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_WRITE\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_ADMIN\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_DAEMON\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_CONFIG\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_OWNER\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_NEGOTIATOR\_CRYPTO\_METHODS}
\index{configuration macro!SEC\_CLIENT\_CRYPTO\_METHODS}
...
\index{configuration macro!ALLOW\_READ}
\index{configuration macro!ALLOW\_WRITE}
\index{configuration macro!ALLOW\_ADMINISTRATOR}
\index{configuration macro!ALLOW\_CONFIG}
\index{configuration macro!ALLOW\_DAEMON}
\index{configuration macro!DENY\_READ}
\index{configuration macro!DENY\_WRITE}
\index{configuration macro!DENY\_ADMINISTRATOR}
\index{configuration macro!DENY\_CONFIG}
\index{configuration macro!DENY\_DAEMON}

\index{configuration macro!ALLOW\_OWNER}
\index{configuration macro!ALLOW\_NEGOTIATOR}
\index{configuration macro!DENY\_OWNER}
\index{configuration macro!DENY\_NEGOTIATOR}
...
Condor is part of the Globus software \Url{http://www.globus.org}.
