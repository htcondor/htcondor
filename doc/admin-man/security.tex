...
Section~{sec:Security}. However, Condor does not turn on these
...
and is described in Section~{sec:figure-out}. This form of security
...
Note that both \MacroNI{DEFAULT} and \MacroNI{CLIENT} 
