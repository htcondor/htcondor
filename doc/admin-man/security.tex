...
be thought of as `when I am acting as a client, these are the servers
I allow/deny'.  It should not be confused for `when I am the server, these
are the clients I allow/deny'.
