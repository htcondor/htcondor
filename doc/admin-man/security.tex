...
These configuration macros may be set to any of the following
values:
\begin{verbatim}
    REQUIRED
    PREFERRED
...
\verb@REQUIRED@ results in authentication being enabled for their
communications.
...
\begin{tabular}{|c|c|c|c|c|c|}
  ...
  \hline
\end{tabular}
\caption{How negotiation resolves whether a given security
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:security-negotiation-methods}Configuration for the
