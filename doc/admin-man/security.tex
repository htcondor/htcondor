...
\begin{verbatim}
SEC_DEFAULT_AUTHENTICATION_METHODS = KERBEROS, GSS_AUTHENTICATION
\end{verbatim}
indicates that either Kerberos or X.509 authentication may be used,
but Kerberos is preferred over X.509.
...
The details of Condor's requirements for using X.509 authentication
and Kerberos authentication are given below.
