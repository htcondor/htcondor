...
If communications require authentication, then the
...
An access level is granted for users by configuration settings.
...
Here is an example of the daemon-side portion of the configuration file.
...
Note that this configuration requires that all Condor daemons be
...
This implies that if a specific user is both denied and given authorization,
