...
The \MacroNI{HIBERNATE} expression 
...
See the \Condor{power} manual page on
...
An optional an expiration time for each ClassAd can
...
A description of \MacroNI{OFFLINE\_LOG} is at
section~\ref{param:OfflineLog} on
page~\pageref{param:OfflineLog},
and a description of \MacroNI{OFFLINE\_EXPIRE\_ADS\_AFTER} is at
section~\ref{param:OfflineExpireAdsAfter} on
page~\pageref{param:OfflineExpireAdsAfter}.
