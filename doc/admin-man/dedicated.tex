...
be preempted by a machine's user pressing a key or by other means.

By default, the dedicated schedule will never preempt running jobs.
...
never occur. \Macro{SCHEDD\_PREEMPTION\_REQUIREMENTS} must evaluate to true
...
preemptible machines are sorted by \Macro{SCHEDD\_PREEMPTION\_RANK}, and
