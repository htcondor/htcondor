...
# The above expression looks at slot1_Activity, so we need to add
# Activity to the list of slot attributes to advertise.
STARTD_SLOT_ATTRS = $(STARTD_SLOT_ATTRS) Activity
