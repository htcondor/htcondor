...
First, we describe in some detail how the \Condor{startd} works, to
give you an idea of what is possible.  Then, we'll describe all the
expressions that are used by the \Condor{startd} and what they do.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\condor{startd} States and Activities}
...
\Term{activities} the startd is in.
...
section~\ref{classad-reference} for specifics of how undefined terms are handled 
