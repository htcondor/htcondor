...
The maximum vacating time is determined by \Macro{MachineMaxVacateTime}.
This may be adjusted by \Macro{JobMaxVacateTime}.
...
machine's max vacate time setting, then retirement time will be
converted into vacating time, up to the amount of
\MacroNI{JobMaxVacateTime}.  Once the vacating time expires, the
...
end of the retirement time so that hard-killing of the job will not
