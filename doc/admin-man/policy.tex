...
The configuration introduces the notion of a slot,
even in the case of a single, physical CPU.
The policy utilizes two slots,
one (called slot1 in the example) that runs jobs following
...
# Since SUSPEND can only be TRUE on slot2, we can write the
# CONTINUE expression specifically for slot2:
