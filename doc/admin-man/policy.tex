...
This behaves just
as though the claim were preempted by a higher priority job after the
specified amount of time.  The retiring claim will allow the existing
job to complete, but will not allow any new jobs to be started.
If there is more work to do,
the \Condor{schedd} must go back to
the \Condor{negotiator} to request a new match.
