...
configuration.  If you're setting up an HTCondor pool, you should read
this section before you read the other configuration-related sections.
Section~\ref{sec:Configuring-HTCondor-Metaknobs} contains information
about configuration metaknobs, which are now the preferred way to set
many configuration options.
Section~\ref{sec:Configuring-HTCondor-Macros} contains information
about the hundreds of individual configuration options.  In general,
it is best to try to achieve your desired configuration using metaknobs
before resorting to setting individual configuration options, but it is
sometimes necessary to set individual configuration options.
The 
...
%TEMPTEMP -- do we want this subsection?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
TEMPTEMP -- say something here about how to customize your configuration
in a way that will be minimally impacted by HTCondor upgrades
...
Unix platforms,
parse file \File{\$(HOME)/.condor/user\_config} if it exists,
...
%TEMPTEMP -- this is confusing because this isn't a config *file*
\item specific environment variables whose names are
prefixed with \MacroNI{\_CONDOR\_}
\end{enumerate}
