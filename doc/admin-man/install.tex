...
Our packaging provides a Yum repository, as well as 
installation and configuration in one easy step.
It is currently available for Red Hat systems only.
As of Condor version 7.5.1, 
Condor is installed into FHS locations.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\label{sec:install-debs} DEBs}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\index{installation!using DEBs}
\index{Debian installation with DEBs}

DEBs are available in \VersionNotice.
Our packaging provides a Debian repository, as well as 
installation and configuration in one easy step.
They are currently available for Debian 4 (Etch) and Debian 5 (Lenny).
As of Condor version 7.5.1, 
Condor is installed into FHS locations.

Debian repositories are specified at
 \URL{http://www.cs.wisc.edu/condor/debian}.
See this site for repository information.
