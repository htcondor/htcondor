...
\item
This step will only be done once, the first time that 
a Condor stable or development release is installed for the targeted
operating system. 
Download and install the meta-data that describes the desired YUM repository. 
...
\item This step will only be done once, the first time that 
a Condor stable or development release is installed for the targeted
operating system. 
...
\item Install, which also starts Condor.
\begin{verbatim}
  apt-get update
