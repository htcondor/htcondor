...
\begin{verbatim}
  cd /etc/yum.repos.d
  wget http://htcondor.org/yum/repo.d/condor-stable-rhel5.repo
\end{verbatim}
\normalsize
...
\footnotesize
\begin{verbatim}
deb http://htcondor.org/debian/stable/ squeeze contrib
deb http://htcondor.org/debian/development/ squeeze contrib
