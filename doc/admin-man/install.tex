...
Please read the copyright and disclaimer information on
...
To subscribe, go to
\texttt{https://lists.cs.wisc.edu/mailman/listinfo/htcondor-world} and fill out
the online form.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
He will also customize policies of the HTCondor schedd and execute nodes.  This
person will also receive information from HTCondor if something goes wrong with
the pool, as described in the documentation of the \texttt{CONDOR\_ADMIN}
...
\item[7. Where should the parts of the HTCondor system be installed?]\hfil\break
...
\begin{enumerate}
   ...
   \item Files in the directory specified by the \Macro{LOCAL\_CONFIG\_DIR}.
\end{enumerate}
