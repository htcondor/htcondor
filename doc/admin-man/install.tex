...
%%%%%%%%%%%%%%%%%%
% Karen's disclaimer
In fact, it contains two sets of instructions for installing
Condor!
With Condor \VersionNotice
is included an untested, beta version of a newer, cleaner,
better installation script.
It might be much simpler for you to use at your site,
but it has not been completely tested yet.
If you want to try it out, please do so.
Send comments and woes to  
\Email{condor-admin@cs.wisc.edu}. 

Read this entire section before starting installation.
%%%%%%%%%%%%%%%%%%
% Karen's new installation script comment
All discussion prior to installation is valid whether using
the new installation script or the older one.
...
New, but Untested Installation Procedure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Older, Tested Installation Procedure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
