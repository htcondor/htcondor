...
\item[Defining slot types.]
  Instead of an even division of resources per slot,
  the machine may have definitions of slot types,
...
\MacroNI{EXECUTE} or \Macro{SLOT<N>\_EXECUTE}).  If every slot is in a
...
whatever remains,
after subtracting out whatever was explicitly
...
The number of slots of each type is set with configuration variable
