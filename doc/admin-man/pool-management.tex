...
configure Condor so that the path to binaries points to the new binaries.
...
which could be a problem if all machines in a large pool 
...
the same reasoning applies as for standard universe: 
