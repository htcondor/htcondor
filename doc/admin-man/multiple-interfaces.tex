...
\Macro{NETWORK\_INTERFACE} = ip address of \Bold{farm-server.farm.org} \\
\Macro{NEGOTIATOR} = \MacroU{SBIN}/condor\_negotiator \\
\Macro{COLLECTOR} = \MacroU{SBIN}/condor\_collector \\
\Macro{DAEMON\_LIST} = \Macro{MASTER}, \Macro{COLLECTOR}, \Macro{NEGOTIATOR}, \Macro{SCHEDD}, \Macro{STARTD}
