...
\Term{Central Manager}, and an arbitrary number of other machines that
...
\item[\Condor{master}] This daemon is responsible for keeping all the
...
\item[\Condor{startd}] This daemon represents a given resource
...
\item[\Condor{starter}] This program is the entity that actually
...
\item[\Condor{schedd}] This daemon represents resources requests to
...
\item[\Condor{shadow}] This program runs on the machine where a given
...
\item[\Condor{collector}] This daemon is responsible for collecting
...
\item[\Condor{negotiator}] This daemon is responsible for all the
...
\item[\Condor{kbdd}] This daemon is only needed on Digital Unix and
...
\item[\Condor{ckpt\_server}] This is the checkpoint server.  It
