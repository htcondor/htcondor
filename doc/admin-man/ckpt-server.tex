...
file must be customized in regards to site specific information.
...
\Note When the \Condor{ckpt\_server} starts up, it will immediately
inspect any checkpoint files in the \Macro{CKPT\_SERVER\_DIR} and
determine if any of them are stale. Stale checkpoint files will be
removed.
...
\Macro{STARTD\_ATTRS} is defined previously in your configuration.  If
