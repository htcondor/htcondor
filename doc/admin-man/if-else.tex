...
\end{verbatim}
  ...
  \item the \verb@version@ keyword, representing the version number of
    of the daemon or currently reading this conditional, 
    followed by a limited comparison to an HTCondor version number.
    That version number can be of the form \verb@x.y.z@ or \verb@x.y@.
    The comparison operators are
    \verb@==@ for equality, where current version 8.2.3 is equal to 8.2,
    \verb@>=@ to see if the current version number is greater than or
    equal to, where current version 8.2.3 is greater than 8.2.2, 
    and current version 8.2.3 is greater than or equal to 8.2.
    \verb@<=@ to see if the current version number is less than or
    equal to, where current version 8.2.0 is less than 8.2.2, 
