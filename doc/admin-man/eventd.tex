...
\Macro{SHUTDOWN} events.
If \Macro{\_RUNTIME} is appended to the \Macro{SHUTDOWN} event
...
If \Macro{\_STANDARD} is appended to the \Macro{SHUTDOWN} event
...
\verb@TestEvent2@ is a \Macro{SHUTDOWN} type event, which specifies
