...
\MacroNI{SLOT\_TYPE\_1}), which specifies the virtual 
...
\MacroNI{SLOT\_TYPE\_1} = cpus=2, ram=128, swap=25\%, disk=1/2

\MacroNI{SLOT\_TYPE\_2} = cpus=1/2, memory=128, virt=25\%, disk=50\%

\MacroNI{SLOT\_TYPE\_3} = c=1/2, m=50\%, v=1/4, disk=1/2

\MacroNI{SLOT\_TYPE\_4} = c=25\%, m=64, v=1/4, d=25\%

\MacroNI{SLOT\_TYPE\_5} = 25\%

\MacroNI{SLOT\_TYPE\_6} = 1/4
...
\begin{verbatim}
SUSPEND = ( (VirtualMachineID == 1) && (PolicyForSlot1) ) || \
            ( (VirtualMachineID == 2) && (PolicyForSlot2) )
\end{verbatim}
...
The \Expr{STARTD\_ATTRS} (and legacy \Expr{STARTD\_EXPRS}) settings
...
SLOT1_STARTD_EXRS = favorite_movie
