...
\Macro{VIRTUAL\_MACHINE\_TYPE\_1}, which specifies the virtual 
...
\Macro{VIRTUAL\_MACHINE\_TYPE\_1} = cpus=2, ram=128, swap=25%, disk=1/2

\Macro{VIRTUAL\_MACHINE\_TYPE\_2} = cpus=1/2, memory=128, virt=25%, disk=50%

\Macro{VIRTUAL\_MACHINE\_TYPE\_3} = c=1/2, m=50%, v=1/4, disk=1/2

\Macro{VIRTUAL\_MACHINE\_TYPE\_4} = c=25%, m=64, v=1/4, d=25%

\Macro{VIRTUAL\_MACHINE\_TYPE\_5} = 25%

\Macro{VIRTUAL\_MACHINE\_TYPE\_6} = 1/4
...
The ``<N>'' is to be replaced with an actual number, for example, 
\Macro{NUM\_VIRTUAL\_MACHINES\_TYPE\_1}. 
