...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:SMP-exps}
Configuring STARTD\_EXPRS on a per-VM basis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

The \Expr{STARTD\_EXPRS} and \Expr{STARTD\_ATTRS} settings can be configured on 
a per-VM basis.
The startd builds the list of things to advertise by combining
the the lists in this order: \Expr{STARTD\_EXPRS}, \Expr{VMx\_STARTD\_EXPRS},
\Expr{STARTD\_ATTRS}, \Expr{VMx\_STARTD\_ATTRS} 
...
Attributes themselves in the \Expr{STARTD\_EXPRS} and \Expr{STARTD\_ATTRS} list 
