...
good reference is \URL{http://docs.redhat.com/docs/en-US/Red\_Hat\_Enterprise\_Linux/6/html/Resource\_Management\_Guide/index.html}
...
parameter \Macro{BASE\_CGROUP}.  This parameter has no default, if it is not set, cgroup
...
Condor itself will not mount the virtual cgroup filesystems.  This can either be
