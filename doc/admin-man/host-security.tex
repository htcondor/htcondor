...
method \Macro{GSS}, an abbreviation of "Generic Security Services". The
...
of SSL used is SSL-Eay, which is written in Australia, and therefore not
subject to the U.S. encryption technology export guidelines. The maintenance
of SSL-Eay was adopted by the OpenSSL group, which oversees its continuing
...
older SSL-Eay technology. The export restrictions in effect at the time of
...
Email \Url{mailto:condor-admin@cs.wisc.edu} for information.
