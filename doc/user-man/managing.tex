...
\Bold{Event Description:} Job performing stage-in of input files.

\noindent\Bold{Event Number:} 032 \\
\Bold{Event Name:} Job Stage Out \\
\Bold{Event Description:} Job Performing stage-out of output files.

\noindent\Bold{Event Number:} 033 \\
\Bold{Event Name:} Attribute update \\
\Bold{Event Description:} Changing or setting job attribute.

\noindent\Bold{Event Number:} 034 \\
\Bold{Event Name:} Pre Skip Event \\
\Bold{Event Description:} PRE script return value is PRE\_SKIP value.
