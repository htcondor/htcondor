...
\normalsize
%%%%%%%%%%%%%%%%%%%
%%%%%%% NOTE: If you're considering reenabling this, 
%%%%%%% You'll need to make a new one as IRIX is no longer
%%%%%%% supported.  You could probably just delete the IRIX6
%%%%%%% line and redo the totals.
