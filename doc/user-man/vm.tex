...
being used, the \SubmitCmd{vmware\_dir} setting given in the submit
...
%Obtain \Prog{VMware Server} from 
%\URL{http://www.vmware.com/download/server/}

%VMware Server installation instructions are detailed in:
%\URL{http://pubs.vmware.com/server1/}

Following the platform-specific
guest OS installation instructions found at
\URL{http://pubs.vmware.com/guestnotes},
