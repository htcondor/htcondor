...
For certain grid-types of the grid universe, how the job exited is
unavailable. In this case, a normal exit code of 0 is assumed.
...
status of the job, where 0 = Unexpanded (means that the job has never run),
1 = Idle, 2 = Running, 3 = Removed, 4 =
