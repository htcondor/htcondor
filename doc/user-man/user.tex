...
condor\_q -l command.  This environment variable may be particularly
useful in a USER\_JOB\_WRAPPER.

\item \Env{\_CONDOR\_MACHINE\_AD}
\index{\_CONDOR\_MACHINE\_AD}
...
condor\_status -l command.

\item \Env{\_CONDOR\_JOB\_IWD}
\index{\_CONDOR\_JOB\_IWD}
...
\index{\_CONDOR\_WRAPPER\_ERROR\_FILE}
