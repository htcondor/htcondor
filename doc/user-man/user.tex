...
The MPI universe is for running jobs compiled with MPICH.  See
Section~\ref{sec:MPI} for more information.
...
sockets \index{UNIX!sockets} but not through pipes, \index{UNIX!pipes}
semaphores,  \index{UNIX!semaphores} or shared memory
