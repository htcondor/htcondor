...
and will never be preempted.  They do not obey the
machine's \MacroNI{requirements} expression.
...
classified ad.
This setting is available in all universes, and was added in version 6.9.3.
...
\Note: As of Condor version 6.9.3, this environment variable is deprecated.
