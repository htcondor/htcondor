...
submission file would have to write extra policy expressions in the
\AdAttr{requirements} expression that would force Condor to choose the
same type of platform to restart a checkpointed job.
However, since it in needed in the common case, we at Condor added a default
to the \AdAttr{requirements} expression that automatically enforces
this policy with the checkpointed job provided the user does not use
...
If you do not specify \AdAttr{CkptArch} in your \AdAttr{requirements}
expression, then we will add this expression to your \AdAttr{requirements}
...
%
% This section should be uncommented when the Vanilla universe
% moves to the new starter.
%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{user-man/interp.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
