...
and subsequently submitted into the standard universe 
...
permission.  This allows Condor to run the \condor{shadow} 
\index{Condor daemon!condor\_shadow}
\index{remote system call!condor\_shadow}
process and
...
Please realize that using the UNIX program \Prog{ps}
