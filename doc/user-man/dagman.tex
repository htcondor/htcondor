...
%TEMP -- VARS A.B ... will no longer work
...
\end{description}
%TEMP -- RETRY B+X doesn't work; ALL_NODES changes will break
% VARS B+X
...
%TEMP -- make an example of something like VARS B+X -- this will
% work, because VARS is a special case.
...
%TEMP -- list commands it applies to
%TEMP -- case insensitive
%TEMP -- does not apply to final nodes
%TEMP -- doesn't work with multiple DAGs on command line
%TEMP -- explain how it works with splices
%TEMP -- how it works with include
%TEMP -- give examples
%TEMP -- last command overrides previous commands
