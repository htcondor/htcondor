...
\index{Directed Acyclic Graph Manager (DAGMan)!see DAGMan}

\Note DAGMan is not included in the 6.2 release of Condor.
A contrib module allows the use of the
Condor version 6.3 DAGMan with Condor 6.2.
This contrib module is available for download with the 6.3 release.
See \Url{http://www.cs.wisc.edu/condor/downloads/} for the download.
This manual section documents the contrib module.
