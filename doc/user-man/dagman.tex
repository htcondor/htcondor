...
Log files for node jobs should not be placed on NFS, unless
\MacroNI{CREATE\_LOCKS\_ON\_LOCAL\_DISK} and \MacroNI{ENABLE\_USERLOG\_LOCKING}
is true. Without these settings, NFS file locking is not reliable,
