...
\begin{figure}[hbt]
\centering
\includegraphics{user-man/dagman-node.pdf}
...
\begin{figure}[hbt]
\centering
\includegraphics{user-man/dagman-diamond.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:DAG-OptimizationOfSubmissionTime}Optimization of Submission Time}
...
\subsubsection{\label{sec:DAG-ComposingWorkflows}Composing workflows from multiple
DAG files}
...
\begin{figure}
\centering
\includegraphics{user-man/splice-simple.pdf}
...
\begin{figure}
\centering
\includegraphics{user-man/splice-X.pdf}
...
\begin{figure}
\centering
\includegraphics{user-man/splice-s1.pdf}
...
\begin{figure}
\centering
\includegraphics{user-man/splice-complex.pdf}
...
\begin{figure}[hbt]
\centering
\includegraphics{user-man/dagman-connect.pdf}
