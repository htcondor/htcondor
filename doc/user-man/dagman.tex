...
There are two known disadvantages of the lazy log file evaluation scheme:

\begin{itemize}

\item If a submit description file does not contain the necessary
log file specification, the DAG will not fail at submission time.
It will fail when the node is submitted.
