...
It may specify nine types of items:
\begin{enumerate}
\item
...
\Arg{PRIORITY} \Arg{JobName} \Arg{PriorityValue}
...
The priority value is an integer (which can be negative).  A smaller
numerical priority is better (will be run before a higher numerical
