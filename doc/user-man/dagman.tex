...
%TEMPTEMP -- need to add diagrams here

%TEMPTEMP -- make a simple example

Restrictions:
%TEMPTEMP -- check these and make sure they are right
\begin{itemize}
\item Pin\_ins and pin\_outs must be numbered consecutively starting
at 1.
%TEMPTEMP -- should we call these parent and child splices???
