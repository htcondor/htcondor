...
the argument must be escaped with another single quote
for \Condor{submit} parsing.
...
Consider an example of the New Syntax 
use of \SubmitCmdNI{arguments} in the submit description file
for NodeA.
\footnotesize
\begin{verbatim}
...
Consider an example of the Old Syntax 
use of \SubmitCmdNI{arguments} in the submit description file
for NodeB.
\footnotesize
\begin{verbatim}
