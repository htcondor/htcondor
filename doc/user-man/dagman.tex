...
% gittrac 2122 3adc8835a4ac04003c2837a3f305d2ad9404acb7
% gittrac 2122 cf2612edf66f1852de66d43515854382574b63e0
% gittrac 2122 c3fd6b54697b5df43dc9d4f0c71f21d803457b4e
% gittrac 2122 4bdd101c370e1744cd5462b4bf7b537f62826e72
% gittrac 2122 36e685e49a0a1fcbc66048429353e2f3c27cc841
% gittrac 2122 4ea0c1c7a81e171a68af8fbef7bd742728a52c30
% gittrac 2122 f92a448b312063610cf8f68452e504b6eab4cfd8
% gittrac 2122 3f6d658ed567b81768c09a3e118a7e8be652018e
% gittrac 2122 c35feb10554210bb2c4dd19b2781ca204b9b09aa
The behavior of DAGMan can be changed by a \Arg{PRE\_SKIP} command. To use a
\Arg{PRE\_SKIP} command, one first create a \Arg{PRE} script.  In some
conditions, it may make sense for the \Arg{PRE} script to check conditions, and
skip the node.  The \Arg{PRE} script can indicate this to DAGman by exiting
with a non-zero exit code in a non-error failure state.  Then one specifies

\Opt{PRE\_SKIP} \Arg{Jobname} \Arg{non-zero-exit-code}

in the DAG input file.  If the script terminates with exit code
\Arg{non-zero-exit-code}, this is interpreted by DAGMan as an indication that
the node should skipped completely.  Both the job associated with the node and
the \Arg{POST} script will then be skipped, but the node will be marked as
successfully completing. In the absence of a \Arg{PRE\_SKIP} command, the
following actions are taken: if the PRE script succeeds, the Condor or Stork
job is submitted.  If the job or any one of the jobs within the single cluster
...
a successful program return the exit value 0.
