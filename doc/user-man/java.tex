...
%%%%%
\subsection{Finding Appropriate Machines}
%%%%%
...
%%%%%
\subsection{Example Java Program and Submit Files}
%%%%%
...
This is a simple one that works (if you're submitting from
...
If you are not running on a shared file system, you
will have to use file transfer, like this:
...
For more information about using file transfer, see
section~\ref{sec:file-transfer}.

%%%%%
\subsection{Submit File Commands}
%%%%%
...
be met by the simple file-transfer mechanism (see
section~\ref{sec:file-transfer}), then
