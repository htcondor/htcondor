...
the \SubmitCmdNI{executable} command specifies the JAR file
that contains the program's entry point.
This file is also listed with the \SubmitCmdNI{jar\_files} command:
\begin{verbatim}
...
HTCondor's \SubmitCmdNI{java} universe does not support this discovery,
