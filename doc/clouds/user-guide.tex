...
Before starting the annex, \Condor{annex} will check to make sure that the
...
You can find out if that instance has successfully joined the pool in the
following way:
...
\\
slot1@ip-172-31-48-84.ec2.internal LINUX      X86\_64 Unclaimed Benchmarking  0. \\
slot2@ip-172-31-48-84.ec2.internal LINUX      X86\_64 Unclaimed Idle          0. \\
\\
...
it's a very wide column and may wrap (as it will for NamelessTestB on an
80-column terminal), not that it has been truncated.
