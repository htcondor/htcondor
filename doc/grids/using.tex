...
\SubmitCmd{gt2} and \SubmitCmd{gt3} grid types
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\label{sec:Using-gt3}The gt3 Grid Type}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\index{universe!grid, grid type gt3}
\index{grid computing!submitting jobs to gt3}
...
For grid jobs destined for \SubmitCmd{gt3},
...
these values is subsitituted for \SubmitCmd{scheduler-string}:
\begin{verbatim}
Fork
Condor
PBS
...
For the \SubmitCmd{gt2} and \SubmitCmd{gt3} types,
...
For 
\SubmitCmd{gt2} and \SubmitCmd{gt3} types,
