...
within the \SubmitCmd{grid\_type} command in a submit description file.
Older submit description files specifying the \SubmitCmd{globus}
universe will become \SubmitCmd{grid} universe jobs using the
Globus \SubmitCmd{gt2} protocol.
