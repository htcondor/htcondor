%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\label{sec:JobRouter}Job Router}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\index{Job Router}
...
This is a specific example of how you could configure JobRouter to send
...
Using \Macro{JOB\_ROUTER\_ENTRIES\_CMD}, we tell JobRouter to call a
...
trying to use it with JobRouter.  You may supply additional arguments
...
script is what you want, configure JobRouter to use it:
