...
\SubmitCmd{universe}, 
\SubmitCmd{remote\_schedd}, 
\SubmitCmd{remote\_pool}, 
\SubmitCmd{globus\_rsl}, 
\SubmitCmd{globus\_xml}, and
\SubmitCmd{globus\_scheduler}
can be specified as \SubmitCmd{remote\_} commands
...
machine's pool.
The \SubmitCmd{remote\_pool} command in the submit description file
...
(9618), then the port it is listening on needs to be specified, like so:
\footnotesize
\begin{verbatim}
