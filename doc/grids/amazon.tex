...
configured with sufficient privileges, you may specify \Expr{FROM INSTANCE}
for either \SubmitCmdNI{ec2\_access\_key\_id} or
\SubmitCmdNI{ec2\_secret\_access\_key}, and HTCondor will use the
