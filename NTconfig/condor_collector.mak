...
!MESSAGE No configuration specified. Defaulting to condor_collector - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_collector - Win32 Release" && "$(CFG)" != "condor_collector - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_collector.pdb" /machine:I386 /out:"$(OUTDIR)\condor_collector.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_collector.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_collector.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\collector.obj" \
	"$(INTDIR)\collector_engine.obj" \
	"$(INTDIR)\hashkey.obj" \
...
"$(INTDIR)\collector.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_collector.V6\collector_engine.C

"$(INTDIR)\collector_engine.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_collector.V6\hashkey.C

"$(INTDIR)\hashkey.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\view_server.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
