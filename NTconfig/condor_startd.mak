...
!IF "$(CFG)" != "condor_startd - Win32 Release" && "$(CFG)" != "condor_startd - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=condor_c++_util\condor_common.obj kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib pdh.lib ws2_32.lib mswsock.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_startd.pdb" /machine:I386 /out:"$(OUTDIR)\condor_startd.exe" /SWAPRUN:NET 
LINK32_OBJS= \
	"$(INTDIR)\command.obj" \
...
LINK32=link.exe
LINK32_FLAGS=../src/condor_c++_util/condor_common.obj ../src/condor_util_lib/condor_common.obj kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib pdh.lib ws2_32.lib mswsock.lib netapi32.lib /nologo /subsystem:console /pdb:none /debug /machine:I386 /out:"$(OUTDIR)\condor_startd.exe" /SWAPRUN:NET 
LINK32_OBJS= \
	"$(INTDIR)\command.obj" \
	"$(INTDIR)\LoadQueue.obj" \
	"$(INTDIR)\main.obj" \
...
"$(INTDIR)\command.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_startd.V6\LoadQueue.C

"$(INTDIR)\LoadQueue.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\Match.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_startd.V6\Reqexp.C

"$(INTDIR)\Reqexp.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_startd.V6\ResAttributes.C

"$(INTDIR)\ResAttributes.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_startd.V6\ResMgr.C

"$(INTDIR)\ResMgr.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_startd.V6\Resource.C

"$(INTDIR)\Resource.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_startd.V6\ResState.C

"$(INTDIR)\ResState.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\util.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
