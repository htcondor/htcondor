...
ALL : "condor_procd_client - Win32 Debug" "condor_util_lib - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_procapi - Win32 Debug" "condor_io - Win32 Debug" "condor_daemon_core - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_classad - Win32 Debug" "$(OUTDIR)\condor_credd.exe"
...
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\soap_creddC.obj"
	-@erase "$(INTDIR)\soap_creddServer.obj"
	-@erase "$(INTDIR)\soap_creddStub.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(INTDIR)\win_credd.obj"
...
LINK32_OBJS= \
	"$(INTDIR)\soap_creddC.obj" \
	"$(INTDIR)\soap_creddServer.obj" \
	"$(INTDIR)\soap_creddStub.obj" \
	"$(INTDIR)\win_credd.obj" \
...
ALL : "condor_procd_client - Win32 Release" "condor_util_lib - Win32 Release" "condor_sysapi - Win32 Release" "condor_procapi - Win32 Release" "condor_io - Win32 Release" "condor_daemon_core - Win32 Release" "condor_cpp_util - Win32 Release" "condor_classad - Win32 Release" "$(OUTDIR)\condor_credd.exe"
...
"$(INTDIR)\soap_creddC.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_creddServer.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_creddStub.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\win_credd.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
