# Microsoft Developer Studio Generated NMAKE File, Based on condor_version.dsp
!IF "$(CFG)" == ""
CFG=condor_version - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_version - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_version - Win32 Debug" && "$(CFG)" != "condor_version - Win32 Release"
...
ALL : "$(OUTDIR)\condor_version.exe"

!ELSE 

ALL : "condor_io - Win32 Debug" "condor_util_lib - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_classad - Win32 Debug" "$(OUTDIR)\condor_version.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_classad - Win32 DebugCLEAN" "condor_cpp_util - Win32 DebugCLEAN" "condor_sysapi - Win32 DebugCLEAN" "condor_util_lib - Win32 DebugCLEAN" "condor_io - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	...
	-@erase "$(OUTDIR)\condor_version.exe"
	-@erase "$(OUTDIR)\condor_version.ilk"
	-@erase "$(OUTDIR)\condor_version.pdb"
...
"$(OUTDIR)\condor_version.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "condor_io - Win32 Release" "condor_util_lib - Win32 Release" "condor_sysapi - Win32 Release" "condor_cpp_util - Win32 Release" "condor_classad - Win32 Release" "$(OUTDIR)\condor_version.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_classad - Win32 ReleaseCLEAN" "condor_cpp_util - Win32 ReleaseCLEAN" "condor_sysapi - Win32 ReleaseCLEAN" "condor_util_lib - Win32 ReleaseCLEAN" "condor_io - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\dc_stub.obj"
	...
	-@erase "$(INTDIR)\version.obj"
	-@erase "$(OUTDIR)\condor_version.exe"
	-@erase "$(OUTDIR)\condor_version.map"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) $(CONDOR_GLOBUS_LIB) $(CONDOR_GLOBUS_LIBPATH) $(CONDOR_OPENSSL_LIB) $(CONDOR_OPENSSL_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_version.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_version.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\version.obj" \
	"$(OUTDIR)\condor_classad.lib" \
...
!IF EXISTS("condor_version.dep")
!INCLUDE "condor_version.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_version.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\version.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
