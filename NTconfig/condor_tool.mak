...
!IF "$(CFG)" == ""
CFG=condor_tool - Win32 Debug
!MESSAGE No configuration specified. Defaulting to condor_tool - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_tool - Win32 Release" && "$(CFG)" != "condor_tool - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_tool.mak" CFG="condor_tool - Win32 Debug"
!MESSAGE 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor.pdb" /machine:I386 /out:"$(OUTDIR)\condor.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\command_strings.obj" \
	"$(INTDIR)\tool.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
"$(INTDIR)\command_strings.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_tools\tool.C

"$(INTDIR)\tool.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
