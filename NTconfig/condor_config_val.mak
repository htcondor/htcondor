...
!MESSAGE No configuration specified. Defaulting to condor_config_val - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_config_val - Win32 Release" && "$(CFG)" != "condor_config_val - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_config_val.pdb" /machine:I386 /out:"$(OUTDIR)\condor_config_val.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_config_val.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_config_val.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\config_val.obj" \
	"..\src\condor_classad\condor_classad.lib" \
	"..\src\condor_c++_util\condor_cpp_util.lib" \
...
"$(INTDIR)\config_val.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
