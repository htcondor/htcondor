...
!MESSAGE No configuration specified. Defaulting to condor_config_val - Win32\
 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_config_val - Win32 Release" && "$(CFG)" !=\
 "condor_config_val - Win32 Debug"
...
ALL : "condor_sysapi - Win32 Release" "condor_util_lib - Win32 Release"\
 ...
 "condor_classad - Win32 Release" "$(OUTDIR)\condor_config_val.exe"
...
LINK32_FLAGS=ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\condor_config_val.pdb" /machine:I386\
 /out:"$(OUTDIR)\condor_config_val.exe" 
LINK32_OBJS= \
...
ALL : "condor_sysapi - Win32 Debug" "condor_util_lib - Win32 Debug"\
 ...
 "condor_classad - Win32 Debug" "$(OUTDIR)\condor_config_val.exe"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /incremental:yes /pdb:"$(OUTDIR)\condor_config_val.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\condor_config_val.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\config_val.obj" \
	"..\src\condor_c++_util\condor_cpp_util.lib" \
	"..\src\condor_classad\condor_classad.lib" \
...
"$(INTDIR)\config_val.obj" : $(SOURCE) $(DEP_CPP_CONFI) "$(INTDIR)"\
