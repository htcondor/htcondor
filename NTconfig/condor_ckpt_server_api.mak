...
ALL : "$(OUTDIR)\condor_ckpt_server_api.lib"\
 "$(OUTDIR)\condor_ckpt_server_api.bsc"
...
CLEAN :
	...
	-@erase "$(INTDIR)\network2.sbr"
	-@erase "$(INTDIR)\server_interface.obj"
	-@erase "$(INTDIR)\server_interface.sbr"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(OUTDIR)\condor_ckpt_server_api.bsc"
	-@erase "$(OUTDIR)\condor_ckpt_server_api.lib"
...
CPP_PROJ=/nologo /MTd /W3 /GX /Z7 /Od /I "..\src\h" /I "..\src\condor_includes"\
 ...
 /FR"$(INTDIR)\\" /Fp"..\src\condor_util_lib/condor_common.pch"\
 /Yu"condor_common.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=..\src\condor_ckpt_server/
CPP_SBRS=..\src\condor_ckpt_server/
...
BSC32_SBRS= \
	"$(INTDIR)\network2.sbr" \
	"$(INTDIR)\server_interface.sbr"

"$(OUTDIR)\condor_ckpt_server_api.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
"$(INTDIR)\network2.obj"	"$(INTDIR)\network2.sbr" : $(SOURCE) $(DEP_CPP_NETWO)\
 "$(INTDIR)" "..\src\condor_util_lib\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\server_interface.obj"	"$(INTDIR)\server_interface.sbr" : $(SOURCE)\
 $(DEP_CPP_SERVE) "$(INTDIR)" "..\src\condor_util_lib\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
