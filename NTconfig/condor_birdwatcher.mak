...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\jfrey\condor.67\src\condor_birdwatcher" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\jfrey\condor.67\src\condor_birdwatcher" /d "_DEBUG" $(SOURCE)
