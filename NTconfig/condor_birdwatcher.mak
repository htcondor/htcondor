...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\Workspaces\v710-hibernate\src\condor_birdwatcher" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\Workspaces\v710-hibernate\src\condor_birdwatcher" /d "_DEBUG" $(SOURCE)
