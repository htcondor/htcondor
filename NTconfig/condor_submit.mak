...
ALL : "condor_qmgmt - Win32 Release" "condor_io - Win32 Release"\
 ...
 "condor_util_lib - Win32 Release" "$(OUTDIR)\condor_submit.exe"
...
ALL : "$(OUTDIR)\condor_submit.exe" "$(OUTDIR)\condor_submit.bsc"

!ELSE 

ALL : "condor_qmgmt - Win32 Debug" "condor_io - Win32 Debug"\
 "condor_classad - Win32 Debug" "condor_cpp_util - Win32 Debug"\
 "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor_submit.exe"\
 "$(OUTDIR)\condor_submit.bsc"
...
!ENDIF 
	-@erase "$(INTDIR)\submit.obj"
	-@erase "$(INTDIR)\submit.sbr"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(OUTDIR)\condor_submit.bsc"
	-@erase "$(OUTDIR)\condor_submit.exe"
...
"$(OUTDIR)\condor_submit.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)\condor_submit.pdb" /debug /machine:I386\
...
"$(INTDIR)\submit.obj"	"$(INTDIR)\submit.sbr" : $(SOURCE) $(DEP_CPP_SUBMI)\
