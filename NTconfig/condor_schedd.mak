...
!IF "$(CFG)" != "condor_schedd - Win32 Release" && "$(CFG)" != "condor_schedd - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_schedd.pdb" /machine:I386 /out:"$(OUTDIR)\condor_schedd.exe" /SWAPRUN:NET 
LINK32_OBJS= \
	"$(INTDIR)\qmgmt.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_schedd.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_schedd.exe" /pdbtype:sept /SWAPRUN:NET 
LINK32_OBJS= \
	"$(INTDIR)\qmgmt.obj" \
	"$(INTDIR)\qmgmt_common.obj" \
	"$(INTDIR)\qmgmt_receivers.obj" \
...
"$(INTDIR)\qmgmt.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\qmgmt_receivers.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_schedd.V6\schedd.C

"$(INTDIR)\schedd.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_schedd.V6\schedd_main.C

"$(INTDIR)\schedd_main.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
