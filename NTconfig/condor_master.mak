...
!IF "$(CFG)" != "condor_master - Win32 Release" && "$(CFG)" != "condor_master - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_master.pdb" /machine:I386 /out:"$(OUTDIR)\condor_master.exe" /SWAPRUN:NET 
LINK32_OBJS= \
	"$(INTDIR)\daemon.obj" \
	"$(INTDIR)\master.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /pdb:none /debug /machine:I386 /out:"$(OUTDIR)\condor_master.exe" /SWAPRUN:NET 
LINK32_OBJS= \
	"$(INTDIR)\daemon.obj" \
	"$(INTDIR)\master.obj" \
	"$(INTDIR)\service.WIN32.obj" \
...
"$(INTDIR)\daemon.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_master.V6\master.C

"$(INTDIR)\master.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_master.V6\service.WIN32.C

"$(INTDIR)\service.WIN32.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
