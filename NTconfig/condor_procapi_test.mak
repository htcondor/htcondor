...
!MESSAGE No configuration specified. Defaulting to condor_procapi_test - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_procapi_test - Win32 Release" && "$(CFG)" != "condor_procapi_test - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_procapi_test.mak" CFG="condor_procapi_test - Win32 Debug"
!MESSAGE 
...
LINK32=link.exe
LINK32_FLAGS=ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_procapi_test.pdb" /machine:I386 /out:"$(OUTDIR)\condor_procapi_test.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ntsysinfo.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_procapi_test.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_procapi_test.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ntsysinfo.obj" \
	"$(INTDIR)\testprocapi.obj" \
	"$(OUTDIR)\condor_procapi.lib"
...
"$(INTDIR)\ntsysinfo.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_procapi\testprocapi.C

"$(INTDIR)\testprocapi.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
