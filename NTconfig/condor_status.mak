...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib Crypt32.lib /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_status.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_status.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\prettyPrint.obj" \
	"$(INTDIR)\setflags.obj" \
