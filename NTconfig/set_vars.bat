...
set CONDOR_DEFINE=/GR /DHAVE_BACKFILL /DHAVE_BOINC /DHAVE_JOB_HOOKS /DHAVE_HIBERNATE /DBUILDID=%BID%
set CONDOR_INCLUDE=/I "..\src\h" /I "..\src\condor_includes" /I "..\src\condor_c++_util" /I "..\src\condor_daemon_client" /I "..\src\condor_daemon_core.V6" /I "..\src\condor_schedd.V6" %CONDOR_DEFINE%
