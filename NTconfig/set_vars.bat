...
set PATH=%cd%;%SystemRoot%;%SystemRoot%\system32;e:\Perl\bin;"e:\Program Files\Microsoft Visual Studio\VC98\bin";"e:\Program Files\Microsoft Platform SDK";"e:\Program Files\Microsoft Platform SDK for Windows XP SP2";
