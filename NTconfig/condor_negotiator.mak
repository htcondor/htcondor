...
!MESSAGE No configuration specified. Defaulting to condor_negotiator - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_negotiator - Win32 Release" && "$(CFG)" != "condor_negotiator - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_negotiator.pdb" /machine:I386 /out:"$(OUTDIR)\condor_negotiator.exe" 
LINK32_OBJS= \
	"$(INTDIR)\main.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ..\src\condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_negotiator.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_negotiator.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\main.obj" \
	"$(INTDIR)\matchmaker.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
"$(INTDIR)\matchmaker.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
