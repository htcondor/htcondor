...
!IF "$(CFG)" != "condor_shadow - Win32 Release" && "$(CFG)" != "condor_shadow - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib pdh.lib ws2_32.lib condor_c++_util\condor_common.obj /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_shadow.pdb" /machine:I386 /out:"$(OUTDIR)\condor_shadow.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib pdh.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ../src/condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_shadow.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_shadow.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\baseshadow.obj" \
	"$(INTDIR)\main.obj" \
	"$(INTDIR)\mpiresource.obj" \
...
"$(INTDIR)\baseshadow.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\mpiresource.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_shadow.V6.1\mpishadow.C

"$(INTDIR)\mpishadow.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_shadow.V6.1\NTreceivers.C

"$(INTDIR)\NTreceivers.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_shadow.V6.1\pseudo_ops.C

"$(INTDIR)\pseudo_ops.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_shadow.V6.1\remoteresource.C

"$(INTDIR)\remoteresource.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=..\src\condor_shadow.V6.1\shadow.C

"$(INTDIR)\shadow.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
