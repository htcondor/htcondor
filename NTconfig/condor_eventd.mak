...
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib imagehlp.lib Crypt32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_eventd.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_eventd.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\eventd.obj" \
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib imagehlp.lib Crypt32.lib /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_eventd.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_eventd.exe" 
LINK32_OBJS= \
	"$(INTDIR)\eventd.obj" \
	"$(INTDIR)\eventd_instantiate.obj" \
	"$(INTDIR)\eventd_main.obj" \
