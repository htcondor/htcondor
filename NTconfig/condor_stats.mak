...
!IF "$(CFG)" != "condor_stats - Win32 Release" && "$(CFG)" !=\
 "condor_stats - Win32 Debug"
...
ALL : "condor_sysapi - Win32 Release" "condor_classad - Win32 Release"\
 ...
 "condor_cpp_util - Win32 Release" "$(OUTDIR)\condor_stats.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_cpp_util - Win32 ReleaseCLEAN" "condor_io - Win32 ReleaseCLEAN"\
...
LINK32_FLAGS=ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\condor_stats.pdb" /machine:I386\
 /out:"$(OUTDIR)\condor_stats.exe" 
LINK32_OBJS= \
	"$(INTDIR)\stats.obj" \
...
ALL : "condor_sysapi - Win32 Debug" "condor_classad - Win32 Debug"\
 ...
 "condor_cpp_util - Win32 Debug" "$(OUTDIR)\condor_stats.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_cpp_util - Win32 DebugCLEAN" "condor_io - Win32 DebugCLEAN"\
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /incremental:yes /pdb:"$(OUTDIR)\condor_stats.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\condor_stats.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\stats.obj" \
	"..\src\condor_c++_util\condor_cpp_util.lib" \
	"..\src\condor_classad\condor_classad.lib" \
