...
!MESSAGE No configuration specified. Defaulting to condor_rm - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "condor_rm - Win32 Release" && "$(CFG)" !=\
 "condor_rm - Win32 Debug"
...
OUTDIR=.\../src/condor_rm.V6
INTDIR=.\../src/condor_rm.V6
# Begin Custom Macros
OutDir=.\../src/condor_rm.V6
# End Custom Macros
...
ALL : "condor_classad - Win32 Release" "condor_io - Win32 Release"\
 "condor_qmgmt - Win32 Release" "condor_cpp_util - Win32 Release"\
 "condor_util_lib - Win32 Release" "$(OUTDIR)\condor_rm.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_util_lib - Win32 ReleaseCLEAN"\
 "condor_cpp_util - Win32 ReleaseCLEAN" "condor_qmgmt - Win32 ReleaseCLEAN"\
 "condor_io - Win32 ReleaseCLEAN" "condor_classad - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\rm.obj"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)\condor_rm.pdb" /machine:I386 /out:"$(OUTDIR)\condor_rm.exe" 
LINK32_OBJS= \
	"$(INTDIR)\rm.obj" \
...
ALL : "$(OUTDIR)\condor_rm.exe" "$(OUTDIR)\condor_rm.bsc"

!ELSE 

ALL : "condor_classad - Win32 Debug" "condor_io - Win32 Debug"\
 "condor_qmgmt - Win32 Debug" "condor_cpp_util - Win32 Debug"\
 "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor_rm.exe"\
 "$(OUTDIR)\condor_rm.bsc"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_util_lib - Win32 DebugCLEAN"\
 "condor_cpp_util - Win32 DebugCLEAN" "condor_qmgmt - Win32 DebugCLEAN"\
 "condor_io - Win32 DebugCLEAN" "condor_classad - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\rm.obj"
...
"$(OUTDIR)\condor_rm.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /incremental:yes /pdb:"$(OUTDIR)\condor_rm.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\condor_rm.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\rm.obj" \
	"..\src\condor_c++_util\condor_cpp_util.lib" \
	"..\src\condor_classad\condor_classad.lib" \
...
"$(INTDIR)\rm.obj" : $(SOURCE) $(DEP_CPP_RM_C0) "$(INTDIR)"\
...
"$(INTDIR)\rm.obj"	"$(INTDIR)\rm.sbr" : $(SOURCE) $(DEP_CPP_RM_C0) "$(INTDIR)"\
 "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
