...
!IF "$(CFG)" != "condor_rm - Win32 Release" && "$(CFG)" != "condor_rm - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\condor_rm.pdb" /machine:I386 /out:"$(OUTDIR)\condor_rm.exe" 
LINK32_OBJS= \
	"$(INTDIR)\rm.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib ../src/condor_c++_util/condor_common.obj ../src/condor_util_lib/condor_common.obj /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_rm.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_rm.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\rm.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
	"..\src\condor_c++_util\condor_cpp_util.lib" \
...
"$(INTDIR)\rm.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_c++_util\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
